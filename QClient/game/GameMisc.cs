...
public class GameMisc
{
	public static void SP_path_corner(edict_t self)
	{
		...
		self.touch = GameMisc.path_corner_touch;
	...
	public static void SP_point_combat(edict_t self)
	{
		...
		self.solid = Defines.SOLID_TRIGGER;
		self.touch = GameMisc.point_combat_touch;
	...
	public static void SP_viewthing(edict_t ent)
	{
		...
		ent.think = GameMisc.TH_viewthing;
	...
	public static void SP_light(edict_t self)
	{
		...
		if (self.style >= 32)
		{
			self.use = GameMisc.light_use;

			if ((self.spawnflags & GameMisc.START_OFF) != 0)
	...
	public static void SP_func_wall(edict_t self)
	{
		...
		self.use = GameMisc.func_wall_use;
	...
	public static void SP_func_object(edict_t self)
	{
		...
		if (self.spawnflags == 0)
		{
			self.solid = Defines.SOLID_BSP;
			self.movetype = Defines.MOVETYPE_PUSH;
			self.think = GameMisc.func_object_release;
		...
		else
		{
			self.solid = Defines.SOLID_NOT;
			self.movetype = Defines.MOVETYPE_PUSH;
			self.use = GameMisc.func_object_use;
			self.svflags |= Defines.SVF_NOCLIENT;
		}
	...
	public static void SP_func_explosive(edict_t self)
	{
		...
		if ((self.spawnflags & 1) != 0)
		{
			self.svflags |= Defines.SVF_NOCLIENT;
			self.solid = Defines.SOLID_NOT;
			self.use = GameMisc.func_explosive_spawn;
		}
		else
		{
			self.solid = Defines.SOLID_BSP;
			...
			if (self.targetname != null)
				self.use = GameMisc.func_explosive_use;
		}
		...
		if (self.use != GameMisc.func_explosive_use)
		{
			if (self.health == 0)
				self.health = 100;

			self.die = GameMisc.func_explosive_explode;
	...
	public static void SP_misc_explobox(edict_t self)
	{
		...
		self.die = GameMisc.barrel_delay;
		self.takedamage = Defines.DAMAGE_YES;
		self.monsterinfo.aiflags = Defines.AI_NOSTEP;

		self.touch = GameMisc.barrel_touch;
	...
	public static void SP_misc_blackhole(edict_t ent)
	{
		...
		ent.use = GameMisc.misc_blackhole_use;
		ent.think = GameMisc.misc_blackhole_think;
	...
	public static void SP_misc_eastertank(edict_t ent)
	{
		...
		ent.s.frame = 254;
		ent.think = GameMisc.misc_eastertank_think;
		ent.nextthink = GameBase.level.time + 2 * Defines.FRAMETIME;
		GameBase.gi.linkentity(ent);
	}
	...
	public static void SP_misc_easterchick(edict_t ent)
	{
		...
		ent.s.frame = 208;
		ent.think = GameMisc.misc_easterchick_think;
		ent.nextthink = GameBase.level.time + 2 * Defines.FRAMETIME;
		GameBase.gi.linkentity(ent);
	}
	...
	public static void SP_misc_easterchick2(edict_t ent)
	{
		...
		ent.s.modelindex = GameBase.gi.modelindex("models/monsters/bitch/tris.md2");
		ent.s.frame = 248;
		ent.think = GameMisc.misc_easterchick2_think;
		ent.nextthink = GameBase.level.time + 2 * Defines.FRAMETIME;
		GameBase.gi.linkentity(ent);
	}
	...
	public static void SP_monster_commander_body(edict_t self)
	{
		...
		self.use = GameMisc.commander_body_use;
		self.takedamage = Defines.DAMAGE_YES;
		...
		self.think = GameMisc.commander_body_drop;
	...
	public static void SP_misc_banner(edict_t ent)
	{
		...
		ent.think = GameMisc.misc_banner_think;
	...
	public static void SP_misc_deadsoldier(edict_t ent)
	{
		...
		ent.die = GameMisc.misc_deadsoldier_die;
	...
	public static void SP_misc_viper(edict_t ent)
	{
		...
		ent.nextthink = GameBase.level.time + Defines.FRAMETIME;
		ent.use = GameMisc.misc_viper_use;
	...
	public static void SP_misc_viper_bomb(edict_t self)
	{
		...
		self.use = GameMisc.misc_viper_bomb_use;
		self.svflags |= Defines.SVF_NOCLIENT;
	...
	public static void SP_misc_strogg_ship(edict_t ent)
	{
		...
		ent.think = GameFunc.func_train_find;
		ent.nextthink = GameBase.level.time + Defines.FRAMETIME;
		ent.use = GameMisc.misc_strogg_ship_use;
		ent.svflags |= Defines.SVF_NOCLIENT;
		ent.moveinfo.accel = ent.moveinfo.decel = ent.moveinfo.speed = ent.speed;
	...
	public static void SP_misc_satellite_dish(edict_t ent)
	{
		...
		ent.use = GameMisc.misc_satellite_dish_use;
		GameBase.gi.linkentity(ent);
	}
	...
	public static void SP_target_string(edict_t self)
	{
		...
		self.use = GameMisc.target_string_use;
	}
	...
	public static void SP_func_clock(edict_t self)
	{
		...
		self.think = GameMisc.func_clock_think;

		if ((self.spawnflags & 4) != 0)
			self.use = GameMisc.func_clock_use;
		else
	...
	public static void SP_misc_teleporter(edict_t ent)
	{
		...
		trig.touch = GameMisc.teleporter_touch;
	...
	public static void ThrowHead(edict_t self, string gibname, int damage, int type)
	{
		...
		self.takedamage = Defines.DAMAGE_YES;
		self.die = GameMisc.gib_die;

		if (type == Defines.GIB_ORGANIC)
		{
			self.movetype = Defines.MOVETYPE_TOSS;
			self.touch = GameMisc.gib_touch;
			vscale = 0.5f;
		}
		else
		{
	...
	public static EntUseAdapter Use_Areaportal = new("use_areaportal", (ent, other, activator) =>
	{
     ...
     * middle of a door.
     */
	public static EntThinkAdapter SP_func_areaportal = new("sp_func_areaportal", ent =>
	{
		ent.use = GameMisc.Use_Areaportal;
     ...
     */
	public static EntTouchAdapter path_corner_touch = new("path_corner_touch", (self, other, plane, surf) =>
	{
		float[] v = { 0, 0, 0 };
		edict_t next;
	 ...
	 */
	public static EntTouchAdapter point_combat_touch = new("point_combat_touch", (self, other, plane, surf) =>
	{
		edict_t activator;
	 ...
	 * level. Don't use
	 */
	public static EntThinkAdapter TH_viewthing = new("th_viewthing", ent =>
	{
	...
	public static EntUseAdapter light_use = new("light_use", (self, other, activator) =>
	{
		if ((self.spawnflags & GameMisc.START_OFF) != 0)
		{
			GameBase.gi.configstring(Defines.CS_LIGHTS + self.style, "m");
			self.spawnflags &= ~GameMisc.START_OFF;
		}
		else
		{
			GameBase.gi.configstring(Defines.CS_LIGHTS + self.style, "a");
	...
	private static readonly EntUseAdapter func_wall_use = new("func_wall_use", (self, other, activator) =>
	{
	 ...
	 */
	private static readonly EntTouchAdapter func_object_touch = new("func_object_touch", (self, other, plane, surf) =>
	{
	...
	private static readonly EntThinkAdapter func_object_release = new("func_object_release", self =>
	{
		self.movetype = Defines.MOVETYPE_TOSS;
		self.touch = GameMisc.func_object_touch;

		return true;
	});

	private static readonly EntUseAdapter func_object_use = new("func_object_use", (self, other, activator) =>
	{
		self.solid = Defines.SOLID_BSP;
		self.svflags &= ~Defines.SVF_NOCLIENT;
		self.use = null;
		GameUtil.KillBox(self);
		GameMisc.func_object_release.think(self);
	});
	 ...
	 */
	public static EntDieAdapter func_explosive_explode = new("func_explosive_explode", (self, inflictor, attacker, damage, point) =>
	{
		float[] origin = { 0, 0, 0 };
		...
		if (mass >= 100)
		{
			...
			while (count-- != 0)
			{
				...
				GameMisc.ThrowDebris(self, "models/objects/debris1/tris.md2", 1, chunkorigin);
			}
		}
		...
		while (count-- != 0)
		{
			...
			chunkorigin[1] = origin[1] + Lib.crandom() * size[1];
			chunkorigin[2] = origin[2] + Lib.crandom() * size[2];
			GameMisc.ThrowDebris(self, "models/objects/debris2/tris.md2", 2, chunkorigin);
		}
	...
	public static EntUseAdapter func_explosive_use = new("func_explosive_use", (self, other, activator) =>
	{
		GameMisc.func_explosive_explode.die(self, self, other, self.health, Globals.vec3_origin);
	});

	public static EntUseAdapter func_explosive_spawn = new("func_explosive_spawn", (self, other, activator) =>
	{
		self.solid = Defines.SOLID_BSP;
		self.svflags &= ~Defines.SVF_NOCLIENT;
		self.use = null;
	...
	public static EntTouchAdapter barrel_touch = new("barrel_touch", (self, other, plane, surf) =>
	{
		float ratio;
		float[] v = { 0, 0, 0 };
	...
	public static EntThinkAdapter barrel_explode = new("barrel_explode", self =>
	{
		float[] org = { 0, 0, 0 };
		float spd;
		float[] save = { 0, 0, 0 };
	...
	public static EntDieAdapter barrel_delay = new("barrel_delay", (self, inflictor, attacker, damage, point) =>
	{
		self.takedamage = Defines.DAMAGE_NO;
		self.nextthink = GameBase.level.time + 2 * Defines.FRAMETIME;
		self.think = GameMisc.barrel_explode;
	...
	private static readonly EntUseAdapter misc_blackhole_use = new("misc_blavkhole_use", (ent, other, activator) =>
	{
		/*
	...
	private static readonly EntThinkAdapter misc_blackhole_think = new("misc_blackhole_think", self =>
	{
		if (++self.s.frame < 19)
	...
	private static readonly EntThinkAdapter misc_eastertank_think = new("misc_eastertank_think", self =>
	{
		if (++self.s.frame < 293)
			self.nextthink = GameBase.level.time + Defines.FRAMETIME;
		else
	...
	private static readonly EntThinkAdapter misc_easterchick_think = new("misc_easterchick_think", self =>
	{
		if (++self.s.frame < 247)
			self.nextthink = GameBase.level.time + Defines.FRAMETIME;
		else
	 ...
	 */
	private static readonly EntThinkAdapter misc_easterchick2_think = new("misc_easterchick2_think", self =>
	{
		if (++self.s.frame < 287)
			self.nextthink = GameBase.level.time + Defines.FRAMETIME;
		else
	...
	public static EntThinkAdapter commander_body_think = new("commander_body_think", self =>
	{
		if (++self.s.frame < 24)
			self.nextthink = GameBase.level.time + Defines.FRAMETIME;
		else
	...
	public static EntUseAdapter commander_body_use = new("commander_body_use", (self, other, activator) =>
	{
		self.think = GameMisc.commander_body_think;
		self.nextthink = GameBase.level.time + Defines.FRAMETIME;
		GameBase.gi.sound(self, Defines.CHAN_BODY, GameBase.gi.soundindex("tank/pain.wav"), 1, Defines.ATTN_NORM, 0);
	});

	public static EntThinkAdapter commander_body_drop = new("commander_body_group", self =>
	{
		self.movetype = Defines.MOVETYPE_TOSS;
		self.s.origin[2] += 2;
	 ...
	 */
	private static readonly EntThinkAdapter misc_banner_think = new("misc_banner_think", ent =>
	{
	 ...
	 */
	private static readonly EntDieAdapter misc_deadsoldier_die = new("misc_deadsoldier_die", (self, inflictor, attacker, damage, point) =>
	{
		int n;
	...
	private static readonly EntUseAdapter misc_viper_use = new("misc_viper_use", (self, other, activator) =>
	{
		self.svflags &= ~Defines.SVF_NOCLIENT;
	 ...
	 */
	private static readonly EntTouchAdapter misc_viper_bomb_touch = new("misc_viper_bomb_touch", (self, other, plane, surf) =>
	{
	...
	private static readonly EntThinkAdapter misc_viper_bomb_prethink = new("misc_viper_bomb_prethink", self =>
	{
		float[] v = { 0, 0, 0 };
		float diff;
	...
	private static readonly EntUseAdapter misc_viper_bomb_use = new("misc_viper_bomb_use", (self, other, activator) =>
	{
		edict_t viper = null;
		...
		self.use = null;
		self.movetype = Defines.MOVETYPE_TOSS;
		self.prethink = GameMisc.misc_viper_bomb_prethink;
		self.touch = GameMisc.misc_viper_bomb_touch;
	...
	private static readonly EntUseAdapter misc_strogg_ship_use = new("misc_strogg_ship_use", (self, other, activator) =>
	{
		self.svflags &= ~Defines.SVF_NOCLIENT;
		self.use = GameFunc.train_use;
		GameFunc.train_use.use(self, other, activator);
	 ...
	 */
	private static readonly EntThinkAdapter misc_satellite_dish_think = new("misc_satellite_dish_think", self =>
	{
		self.s.frame++;
	...
	private static readonly EntUseAdapter misc_satellite_dish_use = new("misc_satellite_dish_use", (self, other, activator) =>
	{
		self.s.frame = 0;
		self.think = GameMisc.misc_satellite_dish_think;
		self.nextthink = GameBase.level.time + Defines.FRAMETIME;
	});
	...
	private static readonly EntUseAdapter target_string_use = new("target_string_use", (self, other, activator) =>
	{
		edict_t e;
		int n, l;
		char c;
	...
	public static EntThinkAdapter func_clock_think = new("func_clock_think", self =>
	{
		if (null == self.enemy)
		{
			EdictIterator es = null;
	...
	public static EntUseAdapter func_clock_use = new("func_clock_use", (self, other, activator) =>
	{
		if (0 == (self.spawnflags & 8))
			self.use = null;
	...
	private static readonly EntTouchAdapter teleporter_touch = new("teleporter_touch", (self, other, plane, surf) =>
	{
		edict_t dest;
		int i;
	...
	public static EntThinkAdapter SP_misc_teleporter_dest = new("SP_misc_teleporter_dest", ent =>
	{
		GameBase.gi.setmodel(ent, "models/objects/dmspot/tris.md2");
		ent.s.skinnum = 0;
		ent.solid = Defines.SOLID_BBOX;
	...
	public static EntThinkAdapter gib_think = new("gib_think", self =>
	{
		self.s.frame++;
		self.nextthink = GameBase.level.time + Defines.FRAMETIME;
	...
	public static EntTouchAdapter gib_touch = new("gib_touch", (self, other, plane, surf) =>
	{
		...
		if (plane != null)
		{
			...
			{
				self.s.frame++;
				self.think = GameMisc.gib_think;
				self.nextthink = GameBase.level.time + Defines.FRAMETIME;
			}
		}
	});

	public static EntDieAdapter gib_die = new("gib_die", (self, inflictor, attacker, damage, point) => { GameUtil.G_FreeEdict(self); });

	/**
     * Debris
     */
	public static EntDieAdapter debris_die = new("debris_die", (self, inflictor, attacker, damage, point) => { GameUtil.G_FreeEdict(self); });
}