 ...
 */
	 ...
	 */
		static S()
		{
			...
			try
			{
				System.Runtime.CompilerServices.RuntimeHelpers.RunClassConstructor(typeof(DummyDriver).TypeHandle);
			...
			try
			{
				...
				System.Runtime.CompilerServices.RuntimeHelpers.RunClassConstructor(typeof(OpenTkSoundImpl).TypeHandle);
			}
			catch (Exception)
			{
	 ...
	 */
		public static void register(Sound driver)
		{
			if (driver == null)
			{
				throw new Exception("Sound implementation can't be null");
			}
