 ...
 */
	public partial class Basic
	{
		...
		{
			0f, 0.19633f, 0.392541f, 0.588517f, 0.784137f, 0.979285f, 1.17384f, 1.3677f, 1.56072f, 1.75281f, 1.94384f, 2.1337f, 2.32228f, 2.50945f,
			2.69512f, 2.87916f, 3.06147f, 3.24193f, 3.42044f, 3.59689f, 3.77117f, 3.94319f, 4.11282f, 4.27998f, 4.44456f, 4.60647f, 4.76559f, 4.92185f,
			5.07515f, 5.22538f, 5.37247f, 5.51632f, 5.65685f, 5.79398f, 5.92761f, 6.05767f, 6.18408f, 6.30677f, 6.42566f, 6.54068f, 6.65176f, 6.75883f,
			6.86183f, 6.9607f, 7.05537f, 7.14579f, 7.23191f, 7.31368f, 7.39104f, 7.46394f, 7.53235f, 7.59623f, 7.65552f, 7.71021f, 7.76025f, 7.80562f,
			7.84628f, 7.88222f, 7.91341f, 7.93984f, 7.96148f, 7.97832f, 7.99036f, 7.99759f, 8f, 7.99759f, 7.99036f, 7.97832f, 7.96148f, 7.93984f, 7.91341f,
			7.88222f, 7.84628f, 7.80562f, 7.76025f, 7.71021f, 7.65552f, 7.59623f, 7.53235f, 7.46394f, 7.39104f, 7.31368f, 7.23191f, 7.14579f, 7.05537f,
			6.9607f, 6.86183f, 6.75883f, 6.65176f, 6.54068f, 6.42566f, 6.30677f, 6.18408f, 6.05767f, 5.92761f, 5.79398f, 5.65685f, 5.51632f, 5.37247f,
			5.22538f, 5.07515f, 4.92185f, 4.76559f, 4.60647f, 4.44456f, 4.27998f, 4.11282f, 3.94319f, 3.77117f, 3.59689f, 3.42044f, 3.24193f, 3.06147f,
			2.87916f, 2.69512f, 2.50945f, 2.32228f, 2.1337f, 1.94384f, 1.75281f, 1.56072f, 1.3677f, 1.17384f, 0.979285f, 0.784137f, 0.588517f, 0.392541f,
			0.19633f, 9.79717e-16f, -0.19633f, -0.392541f, -0.588517f, -0.784137f, -0.979285f, -1.17384f, -1.3677f, -1.56072f, -1.75281f, -1.94384f,
			-2.1337f, -2.32228f, -2.50945f, -2.69512f, -2.87916f, -3.06147f, -3.24193f, -3.42044f, -3.59689f, -3.77117f, -3.94319f, -4.11282f, -4.27998f,
			-4.44456f, -4.60647f, -4.76559f, -4.92185f, -5.07515f, -5.22538f, -5.37247f, -5.51632f, -5.65685f, -5.79398f, -5.92761f, -6.05767f, -6.18408f,
			-6.30677f, -6.42566f, -6.54068f, -6.65176f, -6.75883f, -6.86183f, -6.9607f, -7.05537f, -7.14579f, -7.23191f, -7.31368f, -7.39104f, -7.46394f,
			-7.53235f, -7.59623f, -7.65552f, -7.71021f, -7.76025f, -7.80562f, -7.84628f, -7.88222f, -7.91341f, -7.93984f, -7.96148f, -7.97832f, -7.99036f,
			-7.99759f, -8f, -7.99759f, -7.99036f, -7.97832f, -7.96148f, -7.93984f, -7.91341f, -7.88222f, -7.84628f, -7.80562f, -7.76025f, -7.71021f,
			-7.65552f, -7.59623f, -7.53235f, -7.46394f, -7.39104f, -7.31368f, -7.23191f, -7.14579f, -7.05537f, -6.9607f, -6.86183f, -6.75883f, -6.65176f,
			-6.54068f, -6.42566f, -6.30677f, -6.18408f, -6.05767f, -5.92761f, -5.79398f, -5.65685f, -5.51632f, -5.37247f, -5.22538f, -5.07515f, -4.92185f,
			-4.76559f, -4.60647f, -4.44456f, -4.27998f, -4.11282f, -3.94319f, -3.77117f, -3.59689f, -3.42044f, -3.24193f, -3.06147f, -2.87916f, -2.69512f,
			-2.50945f, -2.32228f, -2.1337f, -1.94384f, -1.75281f, -1.56072f, -1.3677f, -1.17384f, -0.979285f, -0.784137f, -0.588517f, -0.392541f, -0.19633f
		};
		...
		private void SubdividePolygon(int numverts, float[][] verts)
		{
			...
			for (i = 0; i < 3; i++)
			{
				...
				m = Basic.SUBDIVIDE_SIZE * (float) Math.Floor(m / Basic.SUBDIVIDE_SIZE + 0.5f);
		...
		protected void EmitWaterPolys(msurface_t fa)
		{
			...
			for (bp = fa.polys; bp != null; bp = bp.next)
			{
				...
				for (i = 0; i < p.numverts; i++)
				{
					...
					s = os + Basic.SIN[(int) ((ot * 0.125f + this.r_newrefdef.time) * Basic.TURBSCALE) & 255];
					s += scroll;
					s *= (1.0f / 64);

					t = ot + Basic.SIN[(int) ((os * 0.125f + rdt) * Basic.TURBSCALE) & 255];
					t *= (1.0f / 64);

					Base.gl.glTexCoord2f(s, t);
					Base.gl.glVertex3f(p.x(i), p.y(i), p.z(i));
				}
		...
		{
			new float[] {1, 1, 0}, new float[] {1, -1, 0}, new float[] {0, -1, 1}, new float[] {0, 1, 1}, new float[] {1, 0, 1}, new float[] {-1, 0, 1}
		};
		...
		{
			new[] {3, -1, 2}, new[] {-3, 1, 2}, new[] {1, 3, 2}, new[] {-1, -3, 2}, new[] {-2, -1, 3}, // 0 degrees yaw, look straight up
			new[] {2, -1, -3} // look straight down
		};

		private readonly int[][] vec_to_st = {new[] {-2, 3, 1}, new[] {2, 3, -1}, new[] {1, 3, 2}, new[] {-1, 3, -2}, new[] {-2, -1, 3}, new[] {-2, 1, -3}};
		...
		private readonly float[] dists = new float[Basic.MAX_CLIP_VERTS];

		private readonly int[] sides = new int[Basic.MAX_CLIP_VERTS];
		...
		private void ClipSkyPolygon(int nump, float[][] vecs, int stage)
		{
			...
			if (nump > Basic.MAX_CLIP_VERTS - 2)
			...
			for (i = 0; i < nump; i++)
			{
				...
				if (d > Basic.ON_EPSILON)
				{
					front = true;
					this.sides[i] = Basic.SIDE_FRONT;
				}
				else if (d < -Basic.ON_EPSILON)
				{
					back = true;
					this.sides[i] = Basic.SIDE_BACK;
				}
				else
					this.sides[i] = Basic.SIDE_ON;
			...
			for (i = 0; i < nump; i++)
			{
				...
				if (this.sides[i] == Basic.SIDE_ON || this.sides[i + 1] == Basic.SIDE_ON || this.sides[i + 1] == this.sides[i])
					continue;
		...
		private readonly float[][] verts = new float[Basic.MAX_CLIP_VERTS][];
		...
		protected void R_DrawSkyBox()
		{
			...
			Base.gl.glTranslatef(this.r_origin[0], this.r_origin[1], this.r_origin[2]);
			Base.gl.glRotatef(this.r_newrefdef.time * this.skyrotate, this.skyaxis[0], this.skyaxis[1], this.skyaxis[2]);
		...
		protected void WarpConstructor()
		{
			...
			for (var i = 0; i < this.newv.Length; i++)
			{
				...
				{
					this.newv[i][j] = new float[Basic.MAX_CLIP_VERTS][];
