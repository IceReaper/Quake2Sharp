 ...
 */
	public class CL_fx
	{
		 ...
		 * ===============
		 */
		public static void DiminishingTrail(float[] start, float[] end, CentityT old, int flags)
		{
			cparticle_t p;
			float orgscale;
			float velscale;
		 ...
		 * ===============
		 */
		public static void RocketTrail(float[] start, float[] end, CentityT old)
		{
			float len;
			int j;
			cparticle_t p;
		...
		public static void FlyEffect(CentityT ent, float[] origin)
		{
			int n;
			int count;
			int starttime;
