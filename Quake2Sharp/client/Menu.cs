 ...
 */
	public sealed class Menu
	{
		...
		{
			if (!(f >= 0))
				throw new Exception("negative time and cursor bug");
		...
		private static readonly Action Menu_Main = () =>
		{
			Menu.Menu_Main_f();
		};
		...
		private static void Multiplayer_MenuInit()
		{
			...
			Menu.s_join_network_server_action.callback = (object o) =>
			{
			...
			Menu.s_start_network_server_action.callback = (object o) =>
			{
			...
			Menu.s_player_setup_action.callback = (object o) =>
			{
		...
		private static readonly Action Menu_Multiplayer = () =>
		{
			Menu.Menu_Multiplayer_f();
		};
		...
		{
			new[] {"+attack", "attack"}, new[] {"weapnext", "next weapon"}, new[] {"+forward", "walk forward"}, new[] {"+back", "backpedal"},
			new[] {"+left", "turn left"}, new[] {"+right", "turn right"}, new[] {"+speed", "run"}, new[] {"+moveleft", "step left"},
			new[] {"+moveright", "step right"}, new[] {"+strafe", "sidestep"}, new[] {"+lookup", "look up"}, new[] {"+lookdown", "look down"},
			new[] {"centerview", "center view"}, new[] {"+mlook", "mouse look"}, new[] {"+klook", "keyboard look"}, new[] {"+moveup", "up / jump"},
			new[] {"+movedown", "down / crouch"}, new[] {"inven", "inventory"}, new[] {"invuse", "use item"}, new[] {"invdrop", "drop item"},
			new[] {"invprev", "prev item"}, new[] {"invnext", "next item"}, new[] {"cmd help", "help computer"}, new string[] {null, null}
		};
		...
		private static void Keys_MenuInit()
		{
			...
			Menu.s_keys_menu.cursordraw = (object o) =>
			{
			...
			Menu.s_keys_attack_action.ownerdraw = (object o) =>
			{
			...
			Menu.s_keys_change_weapon_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_walk_forward_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_backpedal_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_turn_left_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_turn_right_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_run_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_step_left_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_step_right_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_sidestep_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_look_up_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_look_down_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_center_view_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_mouse_look_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_keyboard_look_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_move_up_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_move_down_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_inventory_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_inv_use_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_inv_drop_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_inv_prev_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_inv_next_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
			...
			Menu.s_keys_help_computer_action.ownerdraw = (object o) =>
			{
				Menu.DrawKeyBindingFunc(o);
			};
		...
		private static Action Keys_MenuDraw = () =>
		{
		...
		private static Func<int, string> Keys_MenuKey = (int key) =>
		{
		...
		private static readonly Action Menu_Keys = () =>
		{
			Menu.Menu_Keys_f();
		};
		...
		private static void Options_MenuInit()
		{
			...
			Menu.s_options_sfxvolume_slider.callback = (object o) =>
			{
			...
			Menu.s_options_cdvolume_box.callback = (object o) =>
			{
			...
			Menu.s_options_quality_list.callback = (object o) =>
			{
			...
			Menu.s_options_sensitivity_slider.callback = (object o) =>
			{
			...
			Menu.s_options_alwaysrun_box.callback = (object o) =>
			{
			...
			Menu.s_options_invertmouse_box.callback = (object o) =>
			{
			...
			Menu.s_options_lookspring_box.callback = (object o) =>
			{
			...
			Menu.s_options_lookstrafe_box.callback = (object o) =>
			{
			...
			Menu.s_options_freelook_box.callback = (object o) =>
			{
				Menu.FreeLookFunc(o);
			};
			...
			Menu.s_options_crosshair_box.callback = (object o) =>
			{
			...
			Menu.s_options_joystick_box.callback = (object o) =>
			{
				Menu.JoystickFunc(o);
			};
			...
			Menu.s_options_customize_options_action.callback = (object o) =>
			{
			...
			Menu.s_options_defaults_action.callback = (object o) =>
			{
			...
			Menu.s_options_console_action.callback = (object o) =>
			{
				Menu.ConsoleFunc(o);
			};
		...
		private static readonly Action Menu_Options = () =>
		{
			Menu.Menu_Options_f();
		};
		...
		private static readonly Action Menu_Video = () =>
		{
			Menu.Menu_Video_f();
		};
		...
		{
			"+QUAKE II BY ID SOFTWARE", "", "+PROGRAMMING", "John Carmack", "John Cash", "Brian Hook", "", "+ART", "Adrian Carmack", "Kevin Cloud",
			"Paul Steed", "", "+LEVEL DESIGN", "Tim Willits", "American McGee", "Christian Antkow", "Paul Jaquays", "Brandon James", "", "+BIZ",
			"Todd Hollenshead", "Barrett (Bear) Alexander", "Donna Jackson", "", "", "+SPECIAL THANKS", "Ben Donges for beta testing", "", "", "", "", "",
			"", "+ADDITIONAL SUPPORT", "", "+LINUX PORT AND CTF", "Dave \"Zoid\" Kirsch", "", "+CINEMATIC SEQUENCES", "Ending Cinematic by Blur Studio - ",
			"Venice, CA", "", "Environment models for Introduction", "Cinematic by Karl Dolgener", "", "Assistance with environment design",
			"by Cliff Iwai", "", "+SOUND EFFECTS AND MUSIC", "Sound Design by Soundelux Media Labs.", "Music Composed and Produced by",
			"Soundelux Media Labs.  Special thanks", "to Bill Brown, Tom Ozanich, Brian", "Celano, Jeff Eisner, and The Soundelux", "Players.", "",
			"\"Level Music\" by Sonic Mayhem", "www.sonicmayhem.com", "", "\"Quake II Theme Song\"", "(C) 1997 Rob Zombie. All Rights", "Reserved.", "",
			"Track 10 (\"Climb\") by Jer Sypult", "", "Voice of computers by", "Carly Staehlin-Taylor", "", "+THANKS TO ACTIVISION", "+IN PARTICULAR:", "",
			"John Tam", "Steve Rosenthal", "Marty Stratton", "Henk Hartong", "", "Quake II(tm) (C)1997 Id Software, Inc.",
			"All Rights Reserved.  Distributed by", "Activision, Inc. under license.", "Quake II(tm), the Id Software name,",
			"the \"Q II\"(tm) logo and id(tm)", "logo are trademarks of Id Software,", "Inc. Activision(R) is a registered",
			"trademark of Activision, Inc. All", "other trademarks and trade names are", "properties of their respective owners.", null
		};
		...
		{
			"+QUAKE II MISSION PACK: THE RECKONING", "+BY", "+XATRIX ENTERTAINMENT, INC.", "", "+DESIGN AND DIRECTION", "Drew Markham", "", "+PRODUCED BY",
			"Greg Goodrich", "", "+PROGRAMMING", "Rafael Paiz", "", "+LEVEL DESIGN / ADDITIONAL GAME DESIGN", "Alex Mayberry", "", "+LEVEL DESIGN",
			"Mal Blackwell", "Dan Koppel", "", "+ART DIRECTION", "Michael \"Maxx\" Kaufman", "", "+COMPUTER GRAPHICS SUPERVISOR AND",
			"+CHARACTER ANIMATION DIRECTION", "Barry Dempsey", "", "+SENIOR ANIMATOR AND MODELER", "Jason Hoover", "", "+CHARACTER ANIMATION AND",
			"+MOTION CAPTURE SPECIALIST", "Amit Doron", "", "+ART", "Claire Praderie-Markham", "Viktor Antonov", "Corky Lehmkuhl", "",
			"+INTRODUCTION ANIMATION", "Dominique Drozdz", "", "+ADDITIONAL LEVEL DESIGN", "Aaron Barber", "Rhett Baldwin", "",
			"+3D CHARACTER ANIMATION TOOLS", "Gerry Tyra, SA Technology", "", "+ADDITIONAL EDITOR TOOL PROGRAMMING", "Robert Duffy", "",
			"+ADDITIONAL PROGRAMMING", "Ryan Feltrin", "", "+PRODUCTION COORDINATOR", "Victoria Sylvester", "", "+SOUND DESIGN", "Gary Bradfield", "",
			"+MUSIC BY", "Sonic Mayhem", "", "", "", "+SPECIAL THANKS", "+TO", "+OUR FRIENDS AT ID SOFTWARE", "", "John Carmack", "John Cash", "Brian Hook",
			"Adrian Carmack", "Kevin Cloud", "Paul Steed", "Tim Willits", "Christian Antkow", "Paul Jaquays", "Brandon James", "Todd Hollenshead",
			"Barrett (Bear) Alexander", "Dave \"Zoid\" Kirsch", "Donna Jackson", "", "", "", "+THANKS TO ACTIVISION", "+IN PARTICULAR:", "",
			"Marty Stratton", "Henk \"The Original Ripper\" Hartong", "Kevin Kraff", "Jamey Gottlieb", "Chris Hepburn", "", "+AND THE GAME TESTERS", "",
			"Tim Vanlaw", "Doug Jacobs", "Steven Rosenthal", "David Baker", "Chris Campbell", "Aaron Casillas", "Steve Elwell", "Derek Johnstone",
			"Igor Krinitskiy", "Samantha Lee", "Michael Spann", "Chris Toft", "Juan Valdes", "", "+THANKS TO INTERGRAPH COMPUTER SYTEMS", "+IN PARTICULAR:",
			"", "Michael T. Nicolaou", "", "", "Quake II Mission Pack: The Reckoning", "(tm) (C)1998 Id Software, Inc. All",
			"Rights Reserved. Developed by Xatrix", "Entertainment, Inc. for Id Software,", "Inc. Distributed by Activision Inc.",
			"under license. Quake(R) is a", "registered trademark of Id Software,", "Inc. Quake II Mission Pack: The",
			"Reckoning(tm), Quake II(tm), the Id", "Software name, the \"Q II\"(tm) logo", "and id(tm) logo are trademarks of Id",
			"Software, Inc. Activision(R) is a", "registered trademark of Activision,", "Inc. Xatrix(R) is a registered",
			"trademark of Xatrix Entertainment,", "Inc. All other trademarks and trade", "names are properties of their", "respective owners.", null
		};

		private static readonly string[] roguecredits =
		{
			"+QUAKE II MISSION PACK 2: GROUND ZERO", "+BY", "+ROGUE ENTERTAINMENT, INC.", "", "+PRODUCED BY", "Jim Molinets", "", "+PROGRAMMING",
			"Peter Mack", "Patrick Magruder", "", "+LEVEL DESIGN", "Jim Molinets", "Cameron Lamprecht", "Berenger Fish", "Robert Selitto", "Steve Tietze",
			"Steve Thoms", "", "+ART DIRECTION", "Rich Fleider", "", "+ART", "Rich Fleider", "Steve Maines", "Won Choi", "", "+ANIMATION SEQUENCES",
			"Creat Studios", "Steve Maines", "", "+ADDITIONAL LEVEL DESIGN", "Rich Fleider", "Steve Maines", "Peter Mack", "", "+SOUND", "James Grunke", "",
			"+GROUND ZERO THEME", "+AND", "+MUSIC BY", "Sonic Mayhem", "", "+VWEP MODELS", "Brent \"Hentai\" Dill", "", "", "", "+SPECIAL THANKS", "+TO",
			"+OUR FRIENDS AT ID SOFTWARE", "", "John Carmack", "John Cash", "Brian Hook", "Adrian Carmack", "Kevin Cloud", "Paul Steed", "Tim Willits",
			"Christian Antkow", "Paul Jaquays", "Brandon James", "Todd Hollenshead", "Barrett (Bear) Alexander", "Katherine Anna Kang", "Donna Jackson",
			"Dave \"Zoid\" Kirsch", "", "", "", "+THANKS TO ACTIVISION", "+IN PARTICULAR:", "", "Marty Stratton", "Henk Hartong", "Mitch Lasky",
			"Steve Rosenthal", "Steve Elwell", "", "+AND THE GAME TESTERS", "", "The Ranger Clan", "Dave \"Zoid\" Kirsch", "Nihilistic Software",
			"Robert Duffy", "", "And Countless Others", "", "", "", "Quake II Mission Pack 2: Ground Zero", "(tm) (C)1998 Id Software, Inc. All",
			"Rights Reserved. Developed by Rogue", "Entertainment, Inc. for Id Software,", "Inc. Distributed by Activision Inc.",
			"under license. Quake(R) is a", "registered trademark of Id Software,", "Inc. Quake II Mission Pack 2: Ground",
			"Zero(tm), Quake II(tm), the Id", "Software name, the \"Q II\"(tm) logo", "and id(tm) logo are trademarks of Id",
			"Software, Inc. Activision(R) is a", "registered trademark of Activision,", "Inc. Rogue(R) is a registered",
			"trademark of Rogue Entertainment,", "Inc. All other trademarks and trade", "names are properties of their", "respective owners.", null
		};
		...
		private static readonly Action Menu_Credits = () =>
		{
			Menu.Menu_Credits_f();
		};
		...
		private static void Game_MenuInit()
		{
			...
			Menu.s_easy_game_action.callback = (object o) =>
			{
				Menu.EasyGameFunc(o);
			};
			...
			Menu.s_medium_game_action.callback = (object o) =>
			{
			...
			Menu.s_hard_game_action.callback = (object o) =>
			{
				Menu.HardGameFunc(o);
			};
			...
			Menu.s_load_game_action.callback = (object o) =>
			{
				Menu.LoadGameFunc(o);
			};
			...
			Menu.s_save_game_action.callback = (object o) =>
			{
				Menu.SaveGameFunc(o);
			};
			...
			Menu.s_credits_action.callback = (object o) =>
			{
				Menu.CreditsFunc(o);
			};
		...
		private static readonly Action Menu_Game = () =>
		{
			Menu.Menu_Game_f();
		};
		...
		private static void Create_Savestrings()
		{
			...
			for (i = 0; i < Menu.MAX_SAVEGAMES; i++)
			{
				...
				try
				{
					f = new BinaryReader(File.OpenRead(name));
		...
		private static void LoadGame_MenuInit()
		{
			...
			for (i = 0; i < Menu.MAX_SAVEGAMES; i++)
			{
				...
				Menu.s_loadgame_actions[i].callback = (object o) =>
				{
		...
		private static readonly Action Menu_LoadGame = () =>
		{
			Menu.Menu_LoadGame_f();
		};
		...
		private static void SaveGame_MenuInit()
		{
			...
			for (i = 0; i < Menu.MAX_SAVEGAMES - 1; i++)
			{
				...
				Menu.s_savegame_actions[i].callback = (object o) =>
				{
		...
		private static readonly Action Menu_SaveGame = () =>
		{
			Menu.Menu_SaveGame_f();
		};
		...
		private static void JoinServer_MenuInit()
		{
			...
			Menu.s_joinserver_address_book_action.callback = (object o) =>
			{
			...
			Menu.s_joinserver_search_action.callback = (object o) =>
			{
			...
			for (i = 0; i < Defines.MAX_LOCAL_SERVERS; i++)
			{
				...
				Menu.s_joinserver_server_actions[i].callback = (object o) =>
				{
		...
		private static readonly Action Menu_JoinServer = () =>
		{
			Menu.Menu_JoinServer_f();
		};
		...
		private static void RulesChangeFunc(object self)
		{
				...
				// coop // PGM
			{
				...
				if (Lib.atoi(Menu.s_maxclients_field.buffer.ToString()) > 4)
					Menu.s_maxclients_field.buffer = new StringBuilder("4");
		...
		private static void StartServer_MenuInit()
		{
			...
			Menu.s_rules_box.callback = (object o) =>
			{
			...
			Menu.s_timelimit_field.buffer = new StringBuilder(Cvar.VariableString("timelimit"));
			...
			Menu.s_fraglimit_field.buffer = new StringBuilder(Cvar.VariableString("fraglimit"));
			...
			if (Cvar.VariableValue("maxclients") == 1)
				Menu.s_maxclients_field.buffer = new StringBuilder("8");
			else
				Menu.s_maxclients_field.buffer = new StringBuilder(Cvar.VariableString("maxclients"));
			...
			Menu.s_hostname_field.buffer = new StringBuilder(Cvar.VariableString("hostname"));
			...
			Menu.s_startserver_dmoptions_action.callback = (object o) =>
			{
			...
			Menu.s_startserver_start_action.callback = (object o) =>
			{
		...
		private static readonly Action Menu_StartServer = () =>
		{
			Menu.Menu_StartServer_f();
		};

		private static readonly Action startServer_MenuDraw = () =>
		{
			Menu.StartServer_MenuDraw();
		};

		private static readonly Func<int, string> startServer_MenuKey = (int key) =>
		{
		...
		private static void DMFlagCallback(object self)
		{
			...
			else if (f == Menu.s_weapons_stay_box)
			{
		...
		private static void DMOptions_MenuInit()
		{
			...
			Menu.s_falls_box.callback = (object o) =>
			{
			...
			Menu.s_weapons_stay_box.callback = (object o) =>
			{
				Menu.DMFlagCallback(o);
			};
			...
			Menu.s_instant_powerups_box.callback = (object o) =>
			{
				Menu.DMFlagCallback(o);
			};
			...
			Menu.s_powerups_box.callback = (object o) =>
			{
				Menu.DMFlagCallback(o);
			};
			...
			Menu.s_health_box.callback = (object o) =>
			{
				Menu.DMFlagCallback(o);
			};
			...
			Menu.s_armor_box.callback = (object o) =>
			{
				Menu.DMFlagCallback(o);
			};
			...
			Menu.s_spawn_farthest_box.callback = (object o) =>
			{
				Menu.DMFlagCallback(o);
			};
			...
			Menu.s_samelevel_box.callback = (object o) =>
			{
				Menu.DMFlagCallback(o);
			};
			...
			Menu.s_force_respawn_box.callback = (object o) =>
			{
				Menu.DMFlagCallback(o);
			};
			...
			Menu.s_teamplay_box.callback = (object o) =>
			{
				Menu.DMFlagCallback(o);
			};
			...
			Menu.s_allow_exit_box.callback = (object o) =>
			{
				Menu.DMFlagCallback(o);
			};
			...
			Menu.s_infinite_ammo_box.callback = (object o) =>
			{
				Menu.DMFlagCallback(o);
			};
			...
			Menu.s_fixed_fov_box.callback = (object o) =>
			{
				Menu.DMFlagCallback(o);
			};
			...
			Menu.s_quad_drop_box.callback = (object o) =>
			{
				Menu.DMFlagCallback(o);
			};
			...
			Menu.s_friendlyfire_box.callback = (object o) =>
			{
				Menu.DMFlagCallback(o);
			};
			...
			if (FS.Developer_searchpath(2) == 2)
			{
				...
				Menu.s_no_mines_box.callback = (object o) =>
				{
					Menu.DMFlagCallback(o);
				};
				...
				Menu.s_no_nukes_box.callback = (object o) =>
				{
					Menu.DMFlagCallback(o);
				};
				...
				Menu.s_stack_double_box.callback = (object o) =>
				{
					Menu.DMFlagCallback(o);
				};
				...
				Menu.s_no_spheres_box.callback = (object o) =>
				{
					Menu.DMFlagCallback(o);
				};
		...
		private static readonly Action Menu_DMOptions = () =>
		{
			Menu.Menu_DMOptions_f();
		};
		...
		private static void DownloadOptions_MenuInit()
		{
			...
			Menu.s_allow_download_box.callback = (object o) =>
			{
			...
			Menu.s_allow_download_maps_box.callback = (object o) =>
			{
				Menu.DownloadCallback(o);
			};
			...
			Menu.s_allow_download_players_box.callback = (object o) =>
			{
				Menu.DownloadCallback(o);
			};
			...
			Menu.s_allow_download_models_box.callback = (object o) =>
			{
				Menu.DownloadCallback(o);
			};
			...
			Menu.s_allow_download_sounds_box.callback = (object o) =>
			{
				Menu.DownloadCallback(o);
			};
		...
		private static readonly Action Menu_DownloadOptions = () =>
		{
		...
		private static void AddressBook_MenuInit()
		{
			...
			for (var i = 0; i < Defines.NUM_ADDRESSBOOK_ENTRIES; i++)
			{
				...
				Menu.s_addressbook_fields[i].buffer = new StringBuilder(adr.@string);

				Menu.Menu_AddItem(Menu.s_addressbook_menu, Menu.s_addressbook_fields[i]);
			}
		}

		private static Func<int, string> AddressBook_MenuKey = (int key) =>
		{
		...
		private static Action AddressBook_MenuDraw = () =>
		{
		...
		private static readonly Action Menu_AddressBook = () =>
		{
			Menu.Menu_AddressBook_f();
		};
		...
		private class playermodelinfo_s
		{
			public int nskins;
		...
		private static readonly playermodelinfo_s[] s_pmi = new playermodelinfo_s[Defines.MAX_PLAYERMODELS];
		...
		private static bool PlayerConfig_MenuInit()
		{
			...
			Menu.s_player_name_field.buffer = new StringBuilder(Globals.name.@string);
			...
			Menu.s_player_model_box.callback = (object o) =>
			{
			...
			Menu.s_player_handedness_box.callback = (object o) =>
			{
			...
			Menu.s_player_rate_box.callback = (object o) =>
			{
				Menu.RateCallback(o);
			};
			...
			Menu.s_player_download_action.callback = (object o) =>
			{
		...
		private static readonly Action Menu_PlayerConfig = () =>
		{
			Menu.Menu_PlayerConfig_f();
		};
		...
		private static readonly Action Menu_Quit = () =>
		{
			Menu.Menu_Quit_f();
		};
			...
			if ((char.ToUpper(key) == 'V' && Globals.keydown[Key.K_CTRL]) || (((key == Key.K_INS) || (key == Key.K_KP_INS)) && Globals.keydown[Key.K_SHIFT]))
			{
				...
				if ((cbd = Sys.GetClipboardData()) != null)
				{
					...
					if (lines.Length > 0 && lines[0].Length != 0)
					{
						...
						f.buffer = new StringBuilder(lines[0]);
