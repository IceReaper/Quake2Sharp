...
namespace Quake2Sharp.client
{
	...
	public class VID
	{
		...
		*/
		...
		{
			new("Mode 0: 320x240", 320, 240, 0), new("Mode 1: 400x300", 400, 300, 1), new("Mode 2: 512x384", 512, 384, 2),
			new("Mode 3: 640x480", 640, 480, 3), new("Mode 4: 800x600", 800, 600, 4), new("Mode 5: 960x720", 960, 720, 5),
			new("Mode 6: 1024x768", 1024, 768, 6), new("Mode 7: 1152x864", 1152, 864, 7), new("Mode 8: 1280x1024", 1280, 1024, 8),
			new("Mode 9: 1600x1200", 1600, 1200, 9), new("Mode 10: 2048x1536", 2048, 1536, 10), new("Mode 11: user", 640, 480, 11)
		};
		...
		*/
		...
		{
			"[320 240  ]", "[400 300  ]", "[512 384  ]", "[640 480  ]", "[800 600  ]", "[960 720  ]", "[1024 768 ]", "[1152 864 ]", "[1280 1024]",
			"[1600 1200]", "[2048 1536]", "user mode",
		};
		...
		private static void initModeList()
		{
			...
			for (var i = 0; i < modes.Length; i++)
			{
				...
				sb.Append('x');
				sb.Append(m.Height);
				VID.fs_modes[i] = new vidmode_t(sb.ToString(), m.Width, m.Height, i);
			}
		}
		...
		*/
		public static void MenuInit()
		{
			...
			VID.s_ref_list.callback = (object self) =>
			{
			...
			VID.s_screensize_slider.callback = (object self) =>
			{
			...
			VID.s_brightness_slider.callback = (object self) =>
			{
			...
			VID.s_fs_box.callback = (object o) =>
			{
			...
			VID.s_defaults_action.callback = (object self) =>
			{
			...
			VID.s_apply_action.callback = (object self) =>
			{
