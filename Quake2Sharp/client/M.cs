 ...
 */
     ...
     */
		...
		public static EntThinkAdapter M_droptofloor = new(
			"m_drop_to_floor",
			(edict_t ent) =>
			{
				float[] end = {0, 0, 0};
		...
		/** Stops the Flies. */
		public static EntThinkAdapter M_FliesOff = new(
			"m_fliesoff",
			(edict_t self) =>
			{
		...
		public static EntThinkAdapter M_FliesOn = new(
			"m_flies_on",
			(edict_t self) =>
			{
		...
		public static EntThinkAdapter M_FlyCheck = new(
			"m_fly_check",
			(edict_t self) =>
			{
				if (self.waterlevel != 0)
