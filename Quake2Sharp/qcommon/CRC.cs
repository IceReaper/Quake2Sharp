...
namespace Quake2Sharp.qcommon
{
	public class CRC
	{
		public static readonly short CRC_INIT_VALUE = unchecked((short) 0xffff);
		public static readonly short CRC_XOR_VALUE = (short) 0x0000;
		...
		{
			var crc = CRC.CRC_INIT_VALUE;

			var ndx = 0;

			while (count-- > 0)
				crc = (short) ((crc << 8) ^ CRC.crctable[0xff & ((crc >> 8) ^ start[ndx++])]);
		...
		public static void main(string[] args)
		{
			byte[] data =
			{
				(byte) 0x71, (byte) 0xa9, (byte) 0x05, (byte) 0xce, (byte) 0x8d, (byte) 0x75, (byte) 0x28, (byte) 0xc8, (byte) 0xba, (byte) 0x97,
				(byte) 0x45, (byte) 0xe9, (byte) 0x8a, (byte) 0xe0, (byte) 0x37, (byte) 0xbd, (byte) 0x6c, (byte) 0x6d, (byte) 0x67, (byte) 0x4a,
				(byte) 0x21
			};

			System.Console.WriteLine("crc:" + (CRC.CRC_Block(data, 21) & 0xffff));
			System.Console.WriteLine("----");

			for (var n = 0; n < 5; n++)
				System.Console.WriteLine("seq:" + (Com.BlockSequenceCRCByte(data, 0, 21, n * 10) & 0xff));
		}
