 ...
 */
     ...
     */
		public static void Netchan_Init()
		{
			...
			Netchan.showpackets = Cvar.Get("showpackets", "0", 0);
			Netchan.showdrop = Cvar.Get("showdrop", "0", 0);
			Netchan.qport = Cvar.Get("qport", "" + port, Defines.CVAR_NOSET);
		}
