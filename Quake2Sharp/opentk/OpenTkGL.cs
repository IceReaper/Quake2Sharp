namespace Quake2Sharp.opentk
{
	...
	public class OpenTkGL : QGL
	{
		...
		{
			GL.ColorPointer(size, (ColorPointerType) QGLConst.GL_UNSIGNED_BYTE, stride, pointer);
		}

		public void glColorPointer(int size, int stride, float[] pointer)
		{
			GL.ColorPointer(size, (ColorPointerType) QGLConst.GL_FLOAT, stride, pointer);
		}
		...
		{
			GL.DrawElements((PrimitiveType) mode, indices.Length, (DrawElementsType) QGLConst.GL_UNSIGNED_INT, indices);
		}
		...
		{
			GL.TexCoordPointer(size, (TexCoordPointerType) QGLConst.GL_FLOAT, stride, pointer);
		}
		...
		{
			GL.VertexPointer(size, (VertexPointerType) QGLConst.GL_FLOAT, stride, pointer);
		}
