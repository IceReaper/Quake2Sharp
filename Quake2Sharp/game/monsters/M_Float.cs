...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Float
	{
		...
		private static readonly EntInteractAdapter floater_sight = new(
			"floater_sight",
		...
		private static readonly EntThinkAdapter floater_idle = new(
			"floater_idle",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter floater_fire_blaster = new(
		...
		private static readonly mframe_t[] floater_frames_stand1 = new mframe_t[]
		{
		...
		private static readonly mframe_t[] floater_frames_stand2 = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
		...
		private static readonly EntThinkAdapter floater_stand = new(
			"floater_stand",
			(edict_t self) =>
			{
				if (Lib.random() <= 0.5)
		...
		private static readonly mframe_t[] floater_frames_activate = new mframe_t[]
		{
		...
		private static readonly EntThinkAdapter floater_run = new(
			"floater_run",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] floater_frames_attack1 = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), // Blaster attack)
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Float.floater_fire_blaster),

			// BOOM (0, -25.8, 32.5) -- LOOP Starts
			new(GameAI.ai_charge, 0, M_Float.floater_fire_blaster), new(GameAI.ai_charge, 0, M_Float.floater_fire_blaster),
			new(GameAI.ai_charge, 0, M_Float.floater_fire_blaster), new(GameAI.ai_charge, 0, M_Float.floater_fire_blaster),
			new(GameAI.ai_charge, 0, M_Float.floater_fire_blaster), new(GameAI.ai_charge, 0, M_Float.floater_fire_blaster), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null)

			// -- LOOP Ends
		};

		private static readonly mmove_t floater_move_attack1 = new(
			M_Float.FRAME_attak101,
			M_Float.FRAME_attak114,
			M_Float.floater_frames_attack1,
			M_Float.floater_run
		);

		private static readonly float[] aim = {Defines.MELEE_DISTANCE, 0, 0};

		private static readonly EntThinkAdapter floater_wham = new(
			"floater_wham",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] floater_frames_attack2 = new mframe_t[]
		{
			...
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Float.floater_wham),
		...
		private static readonly mmove_t floater_move_attack2 = new(
			M_Float.FRAME_attak201,
			M_Float.FRAME_attak225,
			M_Float.floater_frames_attack2,
			M_Float.floater_run
		);

		private static readonly EntThinkAdapter floater_zap = new(
			"floater_zap",
			(edict_t self) =>
			{
				float[] forward = {0, 0, 0}, right = {0, 0, 0};
		...
		private static readonly mframe_t[] floater_frames_attack3 = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
		...
		private static readonly mmove_t floater_move_attack3 = new(
			M_Float.FRAME_attak301,
			M_Float.FRAME_attak334,
			M_Float.floater_frames_attack3,
			M_Float.floater_run
		);

		private static readonly mframe_t[] floater_frames_death = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly EntThinkAdapter floater_dead = new(
			"floater_dead",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] floater_frames_pain1 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t floater_move_pain1 = new(
			M_Float.FRAME_pain101,
			M_Float.FRAME_pain107,
			M_Float.floater_frames_pain1,
			M_Float.floater_run
		);

		private static readonly mframe_t[] floater_frames_pain2 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t floater_move_pain2 = new(
			M_Float.FRAME_pain201,
			M_Float.FRAME_pain208,
			M_Float.floater_frames_pain2,
			M_Float.floater_run
		);

		private static readonly mframe_t[] floater_frames_pain3 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		...
		private static readonly mframe_t[] floater_frames_walk = new mframe_t[]
		{
		...
		private static readonly mframe_t[] floater_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null),
			new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null),
			new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null),
			new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null),
			new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 13, null),
		...
		private static readonly EntThinkAdapter floater_walk = new(
			"floater_walk",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter floater_attack = new(
			"floater_attack",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter floater_melee = new(
			"floater_melee",
			(edict_t self) =>
			{
				if (Lib.random() < 0.5)
		...
		private static readonly EntPainAdapter floater_pain = new(
			"floater_pain",
		...
		private static readonly EntDieAdapter floater_die = new(
			"floater_die",
