...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Brain
	{
		...
		private static readonly EntInteractAdapter brain_sight = new(
			"brain_sight",
		...
		private static readonly EntThinkAdapter brain_search = new(
			"brain_search",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] brain_frames_stand = new mframe_t[]
		{
		...
		private static readonly EntThinkAdapter brain_stand = new(
			"brain_stand",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] brain_frames_idle = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
		...
		private static readonly EntThinkAdapter brain_idle = new(
			"brain_idle",
			(edict_t self) =>
			{
		...
		//	   WALK
		//
		private static readonly mframe_t[] brain_frames_walk1 = new mframe_t[]
		{
			new(GameAI.ai_walk, 7, null), new(GameAI.ai_walk, 2, null), new(GameAI.ai_walk, 3, null), new(GameAI.ai_walk, 3, null),
			new(GameAI.ai_walk, 1, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 9, null),
			new(GameAI.ai_walk, -4, null), new(GameAI.ai_walk, -1, null), new(GameAI.ai_walk, 2, null)
		};
		 ...
		 *  # endif
		 */
		private static readonly EntThinkAdapter brain_walk = new(
			"brain_walk",
			(edict_t self) =>
			{
				//			if (random() <= 0.5)
		...
		private static readonly EntThinkAdapter brain_duck_down = new(
			"brain_duck_down",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter brain_duck_hold = new(
			"brain_duck_hold",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter brain_duck_up = new(
			"brain_duck_up",
			(edict_t self) =>
			{
				self.monsterinfo.aiflags &= ~Defines.AI_DUCKED;
		...
		private static readonly EntDodgeAdapter brain_dodge = new(
			"brain_dodge",
		...
		private static readonly mframe_t[] brain_frames_death2 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 9, null),
			new(GameAI.ai_move, 0, null)
		};

		private static readonly EntThinkAdapter brain_dead = new(
			"brain_dead",
			(edict_t self) =>
			{
		...
		private static readonly mmove_t brain_move_death2 = new(
			M_Brain.FRAME_death201,
			M_Brain.FRAME_death205,
			M_Brain.brain_frames_death2,
			M_Brain.brain_dead
		);

		private static readonly mframe_t[] brain_frames_death1 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -2, null), new(GameAI.ai_move, 9, null),
		...
		private static readonly mmove_t brain_move_death1 = new(
			M_Brain.FRAME_death101,
			M_Brain.FRAME_death118,
			M_Brain.brain_frames_death1,
			M_Brain.brain_dead
		);
		...
		private static readonly EntThinkAdapter brain_swing_right = new(
			"brain_swing_right",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter brain_hit_right = new(
			"brain_hit_right",
			(edict_t self) =>
			{
				float[] aim = {0, 0, 0};
		...
		private static readonly EntThinkAdapter brain_swing_left = new(
			"brain_swing_left",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter brain_hit_left = new(
			"brain_hit_left",
			(edict_t self) =>
			{
				float[] aim = {0, 0, 0};
		...
		private static readonly EntThinkAdapter brain_chest_open = new(
			"brain_chest_open",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter brain_tentacle_attack = new(
		...
		private static readonly mframe_t[] brain_frames_attack1 = new mframe_t[]
		{
			new(GameAI.ai_charge, 8, null), new(GameAI.ai_charge, 3, null), new(GameAI.ai_charge, 5, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, -3, M_Brain.brain_swing_right), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, -5, null),
			new(GameAI.ai_charge, -7, M_Brain.brain_hit_right), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 6, M_Brain.brain_swing_left),
			new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 2, M_Brain.brain_hit_left), new(GameAI.ai_charge, -3, null),
			new(GameAI.ai_charge, 6, null), new(GameAI.ai_charge, -1, null), new(GameAI.ai_charge, -3, null), new(GameAI.ai_charge, 2, null),
			new(GameAI.ai_charge, -11, null)
		};

		private static readonly EntThinkAdapter brain_chest_closed = new(
			"brain_chest_closed",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] brain_frames_attack2 = new mframe_t[]
		{
			new(GameAI.ai_charge, 5, null), new(GameAI.ai_charge, -4, null), new(GameAI.ai_charge, -4, null), new(GameAI.ai_charge, -3, null),
			new(GameAI.ai_charge, 0, M_Brain.brain_chest_open), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 13, M_Brain.brain_tentacle_attack),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 2, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, -9, M_Brain.brain_chest_closed), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 4, null),
			new(GameAI.ai_charge, 3, null), new(GameAI.ai_charge, 2, null), new(GameAI.ai_charge, -3, null), new(GameAI.ai_charge, -6, null)
		};

		private static readonly EntThinkAdapter brain_melee = new(
			"brain_melee",
			(edict_t self) =>
			{
				if (Lib.random() <= 0.5)
		...
		private static readonly mframe_t[] brain_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 9, null), new(GameAI.ai_run, 2, null), new(GameAI.ai_run, 3, null), new(GameAI.ai_run, 3, null), new(GameAI.ai_run, 1, null),
			new(GameAI.ai_run, 0, null), new(GameAI.ai_run, 0, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, -4, null),
			new(GameAI.ai_run, -1, null), new(GameAI.ai_run, 2, null)
		};
		...
		private static readonly EntThinkAdapter brain_run = new(
			"brain_run",
			(edict_t self) =>
			{
				self.monsterinfo.power_armor_type = Defines.POWER_ARMOR_SCREEN;
		...
		private static readonly mframe_t[] brain_frames_defense = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null)
		...
		private static readonly mframe_t[] brain_frames_pain3 = new mframe_t[]
		{
			new(GameAI.ai_move, -2, null), new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 3, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -4, null)
		};
		...
		private static readonly mframe_t[] brain_frames_pain2 = new mframe_t[]
		{
			new(GameAI.ai_move, -2, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, -2, null)
		};
		...
		private static readonly mframe_t[] brain_frames_pain1 = new mframe_t[]
		{
			new(GameAI.ai_move, -6, null), new(GameAI.ai_move, -2, null), new(GameAI.ai_move, -6, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 2, null),
			new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 7, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 3, null),
		...
		private static readonly mframe_t[] brain_frames_duck = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -2, M_Brain.brain_duck_down), new(GameAI.ai_move, 17, M_Brain.brain_duck_hold),
			new(GameAI.ai_move, -3, null), new(GameAI.ai_move, -1, M_Brain.brain_duck_up), new(GameAI.ai_move, -5, null), new(GameAI.ai_move, -6, null),
		...
		private static readonly EntPainAdapter brain_pain = new(
			"brain_pain",
		...
		private static readonly EntDieAdapter brain_die = new(
			"brain_die",
		...
		private static readonly mmove_t brain_move_attack1 = new(
			M_Brain.FRAME_attak101,
			M_Brain.FRAME_attak118,
			M_Brain.brain_frames_attack1,
			M_Brain.brain_run
		);

		private static readonly mmove_t brain_move_attack2 = new(
			M_Brain.FRAME_attak201,
			M_Brain.FRAME_attak217,
			M_Brain.brain_frames_attack2,
			M_Brain.brain_run
		);
