...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Insane
	{
		...
		private static readonly EntThinkAdapter insane_fist = new(
			"insane_fist",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter insane_shake = new(
			"insane_shake",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter insane_moan = new(
			"insane_moan",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter insane_scream = new(
			"insane_scream",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter insane_cross = new(
			"insane_cross",
			(edict_t self) =>
			{
				if (Lib.random() < 0.8)
		...
		private static readonly EntThinkAdapter insane_walk = new(
			"insane_walk",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter insane_run = new(
			"insane_run",
			(edict_t self) =>
			{
				if ((self.spawnflags & 16) != 0) // Hold Ground?
		...
		private static readonly EntPainAdapter insane_pain = new(
			"insane_pain",
		...
		private static readonly EntThinkAdapter insane_onground = new(
			"insane_onground",
			(edict_t self) =>
			{
				self.monsterinfo.currentmove = M_Insane.insane_move_down;
		...
		private static readonly EntThinkAdapter insane_checkdown = new(
			"insane_checkdown",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter insane_checkup = new(
			"insane_checkup",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter insane_stand = new(
			"insane_stand",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter insane_dead = new(
			"insane_dead",
			(edict_t self) =>
			{
				if ((self.spawnflags & 8) != 0)
		...
		private static readonly EntDieAdapter insane_die = new(
			"insane_die",
			(edict_t self, edict_t inflictor, edict_t attacker, int damage, float[] point) =>
			{
				...
				GameBase.gi.sound(
					self,
					Defines.CHAN_VOICE,
					GameBase.gi.soundindex("player/male/death" + ((Lib.rand() % 4) + 1) + ".wav"),
					1,
					Defines.ATTN_IDLE,
					0
				);
		...
		private static readonly mframe_t[] insane_frames_stand_normal = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, M_Insane.insane_checkdown)
		};

		private static readonly mmove_t insane_move_stand_normal = new(
			M_Insane.FRAME_stand60,
			M_Insane.FRAME_stand65,
			M_Insane.insane_frames_stand_normal,
			M_Insane.insane_stand
		);

		private static readonly mframe_t[] insane_frames_stand_insane = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, M_Insane.insane_shake), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
		...
		private static readonly mmove_t insane_move_stand_insane = new(
			M_Insane.FRAME_stand65,
			M_Insane.FRAME_stand94,
			M_Insane.insane_frames_stand_insane,
			M_Insane.insane_stand
		);

		private static readonly mframe_t[] insane_frames_uptodown = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, M_Insane.insane_moan),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 2.7f, null), new(GameAI.ai_move, 4.1f, null), new(GameAI.ai_move, 6f, null), new(GameAI.ai_move, 7.6f, null),
			new(GameAI.ai_move, 3.6f, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, M_Insane.insane_fist),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, M_Insane.insane_fist), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t insane_move_uptodown = new(
			M_Insane.FRAME_stand1,
			M_Insane.FRAME_stand40,
			M_Insane.insane_frames_uptodown,
			M_Insane.insane_onground
		);

		private static readonly mframe_t[] insane_frames_downtoup = new mframe_t[]
		{
		...
		private static readonly mmove_t insane_move_downtoup = new(
			M_Insane.FRAME_stand41,
			M_Insane.FRAME_stand59,
			M_Insane.insane_frames_downtoup,
			M_Insane.insane_stand
		);

		private static readonly mframe_t[] insane_frames_jumpdown = new mframe_t[]
		{
			new(GameAI.ai_move, 0.2f, null), new(GameAI.ai_move, 11.5f, null), new(GameAI.ai_move, 5.1f, null), new(GameAI.ai_move, 7.1f, null),
			new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t insane_move_jumpdown = new(
			M_Insane.FRAME_stand96,
			M_Insane.FRAME_stand100,
			M_Insane.insane_frames_jumpdown,
			M_Insane.insane_onground
		);

		private static readonly mframe_t[] insane_frames_down = new mframe_t[]
		{
			...
			// 110)
			new(GameAI.ai_move, -1.7f, null), new(GameAI.ai_move, -1.6f, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, M_Insane.insane_fist), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			...
			// 130
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, M_Insane.insane_moan), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			...
			// 150
			new(GameAI.ai_move, 0.5f, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -0.2f, M_Insane.insane_scream), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0.2f, null), new(GameAI.ai_move, 0.4f, null), new(GameAI.ai_move, 0.6f, null), new(GameAI.ai_move, 0.8f, null),
			new(GameAI.ai_move, 0.7f, null), new(GameAI.ai_move, 0, M_Insane.insane_checkup) // 160
		};

		private static readonly mmove_t insane_move_down = new(
			M_Insane.FRAME_stand100,
			M_Insane.FRAME_stand160,
			M_Insane.insane_frames_down,
			M_Insane.insane_onground
		);

		private static readonly mframe_t[] insane_frames_walk_normal = new mframe_t[]
		{
			new(GameAI.ai_walk, 0, M_Insane.insane_scream), new(GameAI.ai_walk, 2.5f, null), new(GameAI.ai_walk, 3.5f, null),
			new(GameAI.ai_walk, 1.7f, null), new(GameAI.ai_walk, 2.3f, null), new(GameAI.ai_walk, 2.4f, null), new(GameAI.ai_walk, 2.2f, null),
			new(GameAI.ai_walk, 4.2f, null), new(GameAI.ai_walk, 5.6f, null), new(GameAI.ai_walk, 3.3f, null), new(GameAI.ai_walk, 2.4f, null),
			new(GameAI.ai_walk, 0.9f, null), new(GameAI.ai_walk, 0, null)
		};

		private static readonly mmove_t insane_move_walk_normal = new(
			M_Insane.FRAME_walk27,
			M_Insane.FRAME_walk39,
			M_Insane.insane_frames_walk_normal,
			M_Insane.insane_walk
		);

		private static readonly mmove_t insane_move_run_normal = new(
			M_Insane.FRAME_walk27,
			M_Insane.FRAME_walk39,
			M_Insane.insane_frames_walk_normal,
			M_Insane.insane_run
		...
		private static readonly mframe_t[] insane_frames_walk_insane = new mframe_t[]
		{
		...
		private static readonly mmove_t insane_move_walk_insane = new(
			M_Insane.FRAME_walk1,
			M_Insane.FRAME_walk26,
			M_Insane.insane_frames_walk_insane,
			M_Insane.insane_walk
		);

		private static readonly mmove_t insane_move_run_insane = new(
			M_Insane.FRAME_walk1,
			M_Insane.FRAME_walk26,
			M_Insane.insane_frames_walk_insane,
			M_Insane.insane_run
		...
		private static readonly mframe_t[] insane_frames_stand_pain = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mmove_t insane_move_stand_pain = new(
			M_Insane.FRAME_st_pain2,
			M_Insane.FRAME_st_pain12,
			M_Insane.insane_frames_stand_pain,
			M_Insane.insane_run
		);

		private static readonly mframe_t[] insane_frames_stand_death = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mmove_t insane_move_stand_death = new(
			M_Insane.FRAME_st_death2,
			M_Insane.FRAME_st_death18,
			M_Insane.insane_frames_stand_death,
			M_Insane.insane_dead
		);

		private static readonly mframe_t[] insane_frames_crawl = new mframe_t[]
		{
			new(GameAI.ai_walk, 0, M_Insane.insane_scream), new(GameAI.ai_walk, 1.5f, null), new(GameAI.ai_walk, 2.1f, null),
			new(GameAI.ai_walk, 3.6f, null), new(GameAI.ai_walk, 2f, null), new(GameAI.ai_walk, 0.9f, null), new(GameAI.ai_walk, 3f, null),
			new(GameAI.ai_walk, 3.4f, null), new(GameAI.ai_walk, 2.4f, null)
		};
		...
		private static readonly mframe_t[] insane_frames_crawl_pain = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null)
		...
		private static readonly mmove_t insane_move_crawl_pain = new(
			M_Insane.FRAME_cr_pain2,
			M_Insane.FRAME_cr_pain10,
			M_Insane.insane_frames_crawl_pain,
			M_Insane.insane_run
		);

		private static readonly mframe_t[] insane_frames_crawl_death = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t insane_move_crawl_death = new(
			M_Insane.FRAME_cr_death10,
			M_Insane.FRAME_cr_death16,
			M_Insane.insane_frames_crawl_death,
			M_Insane.insane_dead
		);

		private static readonly mframe_t[] insane_frames_cross = new mframe_t[]
		{
			new(GameAI.ai_move, 0, M_Insane.insane_moan), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t insane_move_cross = new(
			M_Insane.FRAME_cross1,
			M_Insane.FRAME_cross15,
			M_Insane.insane_frames_cross,
			M_Insane.insane_cross
		);

		private static readonly mframe_t[] insane_frames_struggle_cross = new mframe_t[]
		{
			new(GameAI.ai_move, 0, M_Insane.insane_scream), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t insane_move_struggle_cross = new(
			M_Insane.FRAME_cross16,
			M_Insane.FRAME_cross30,
			M_Insane.insane_frames_struggle_cross,
			M_Insane.insane_cross
		);
