...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Medic
	{
		...
		private static readonly EntThinkAdapter medic_idle = new(
			"medic_idle",
			(edict_t self) =>
			{
				edict_t ent;
		...
		private static readonly EntThinkAdapter medic_search = new(
			"medic_search",
			(edict_t self) =>
			{
				edict_t ent;
		...
		private static readonly EntInteractAdapter medic_sight = new(
			"medic_sight",
		...
		private static readonly mframe_t[] medic_frames_stand = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, M_Medic.medic_idle), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
		...
		private static readonly EntThinkAdapter medic_stand = new(
			"medic_stand",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] medic_frames_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 6.2f, null), new(GameAI.ai_walk, 18.1f, null), new(GameAI.ai_walk, 1, null), new(GameAI.ai_walk, 9, null),
			new(GameAI.ai_walk, 10, null), new(GameAI.ai_walk, 9, null), new(GameAI.ai_walk, 11, null), new(GameAI.ai_walk, 11.6f, null),
			new(GameAI.ai_walk, 2, null), new(GameAI.ai_walk, 9.9f, null), new(GameAI.ai_walk, 14, null), new(GameAI.ai_walk, 9.3f, null)
		};
		...
		private static readonly EntThinkAdapter medic_walk = new(
			"medic_walk",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] medic_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 18, null), new(GameAI.ai_run, 22.5f, null), new(GameAI.ai_run, 25.4f, null), new(GameAI.ai_run, 23.4f, null),
			new(GameAI.ai_run, 24, null), new(GameAI.ai_run, 35.6f, null)
		};

		private static readonly mmove_t medic_move_run = new(M_Medic.FRAME_run1, M_Medic.FRAME_run6, M_Medic.medic_frames_run, null);

		private static readonly EntThinkAdapter medic_run = new(
			"medic_run",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] medic_frames_pain1 = new mframe_t[]
		{
		...
		private static readonly mframe_t[] medic_frames_pain2 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly EntPainAdapter medic_pain = new(
			"medic_pain",
		...
		private static readonly EntThinkAdapter medic_fire_blaster = new(
			"medic_fire_blaster",
			(edict_t self) =>
			{
				float[] start = {0, 0, 0};
		...
		private static readonly EntThinkAdapter medic_dead = new(
			"medic_dead",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] medic_frames_death = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly EntDieAdapter medic_die = new(
			"medic_die",
		...
		private static readonly EntThinkAdapter medic_duck_down = new(
			"medic_duck_down",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter medic_duck_hold = new(
			"medic_duck_hold",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter medic_duck_up = new(
			"medic_duck_up",
			(edict_t self) =>
			{
				self.monsterinfo.aiflags &= ~Defines.AI_DUCKED;
		...
		private static readonly mframe_t[] medic_frames_duck = new mframe_t[]
		{
			new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -1, M_Medic.medic_duck_down),
			new(GameAI.ai_move, -1, M_Medic.medic_duck_hold), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -1, null),
			new(GameAI.ai_move, -1, M_Medic.medic_duck_up), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -1, null),
			new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -1, null),
			new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -1, null)
		};
		...
		private static readonly EntDodgeAdapter medic_dodge = new(
			"medic_dodge",
		...
		private static readonly mframe_t[] medic_frames_attackHyperBlaster = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Medic.medic_fire_blaster), new(GameAI.ai_charge, 0, M_Medic.medic_fire_blaster),
			new(GameAI.ai_charge, 0, M_Medic.medic_fire_blaster), new(GameAI.ai_charge, 0, M_Medic.medic_fire_blaster),
			new(GameAI.ai_charge, 0, M_Medic.medic_fire_blaster), new(GameAI.ai_charge, 0, M_Medic.medic_fire_blaster),
			new(GameAI.ai_charge, 0, M_Medic.medic_fire_blaster), new(GameAI.ai_charge, 0, M_Medic.medic_fire_blaster),
			new(GameAI.ai_charge, 0, M_Medic.medic_fire_blaster), new(GameAI.ai_charge, 0, M_Medic.medic_fire_blaster),
		...
		private static readonly mmove_t medic_move_attackHyperBlaster = new(
			M_Medic.FRAME_attack15,
			M_Medic.FRAME_attack30,
			M_Medic.medic_frames_attackHyperBlaster,
			M_Medic.medic_run
		);

		private static readonly EntThinkAdapter medic_continue = new(
			"medic_continue",
			(edict_t self) =>
			{
		...
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 5, null), new(GameAI.ai_charge, 5, null), new(GameAI.ai_charge, 3, null),
			new(GameAI.ai_charge, 2, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Medic.medic_fire_blaster), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Medic.medic_fire_blaster), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Medic.medic_continue) // Change to
			// medic_continue...
			// Else, go to
			// frame 32
		};

		private static readonly mmove_t medic_move_attackBlaster = new(
			M_Medic.FRAME_attack1,
			M_Medic.FRAME_attack14,
			M_Medic.medic_frames_attackBlaster,
			M_Medic.medic_run
		);

		private static readonly EntThinkAdapter medic_hook_launch = new(
			"medic_hook_launch",
			(edict_t self) =>
			{
		...
		{
			new[] {45.0f, -9.2f, 15.5f}, new[] {48.4f, -9.7f, 15.2f}, new[] {47.8f, -9.8f, 15.8f}, new[] {47.3f, -9.3f, 14.3f},
			new[] {45.4f, -10.1f, 13.1f}, new[] {41.9f, -12.7f, 12.0f}, new[] {37.8f, -15.8f, 11.2f}, new[] {34.3f, -18.4f, 10.7f},
			new[] {32.7f, -19.7f, 10.4f}, new[] {32.7f, -19.7f, 10.4f}
		};

		private static readonly EntThinkAdapter medic_cable_attack = new(
			"medic_cable_attack",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter medic_hook_retract = new(
			"medic_hook_retract",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] medic_frames_attackCable = new mframe_t[]
		{
			new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 5, null), new(GameAI.ai_move, 4.4f, null),
			new(GameAI.ai_charge, 4.7f, null), new(GameAI.ai_charge, 5, null), new(GameAI.ai_charge, 6, null), new(GameAI.ai_charge, 4, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_move, 0, M_Medic.medic_hook_launch), new(GameAI.ai_move, 0, M_Medic.medic_cable_attack),
			new(GameAI.ai_move, 0, M_Medic.medic_cable_attack), new(GameAI.ai_move, 0, M_Medic.medic_cable_attack),
			new(GameAI.ai_move, 0, M_Medic.medic_cable_attack), new(GameAI.ai_move, 0, M_Medic.medic_cable_attack),
			new(GameAI.ai_move, 0, M_Medic.medic_cable_attack), new(GameAI.ai_move, 0, M_Medic.medic_cable_attack),
			new(GameAI.ai_move, 0, M_Medic.medic_cable_attack), new(GameAI.ai_move, 0, M_Medic.medic_cable_attack),
			new(GameAI.ai_move, -15, M_Medic.medic_hook_retract), new(GameAI.ai_move, -1.5f, null), new(GameAI.ai_move, -1.2f, null),
			new(GameAI.ai_move, -3, null), new(GameAI.ai_move, -2, null), new(GameAI.ai_move, 0.3f, null), new(GameAI.ai_move, 0.7f, null),
			new(GameAI.ai_move, 1.2f, null), new(GameAI.ai_move, 1.3f, null)
		};

		private static readonly mmove_t medic_move_attackCable = new(
			M_Medic.FRAME_attack33,
			M_Medic.FRAME_attack60,
			M_Medic.medic_frames_attackCable,
			M_Medic.medic_run
		);

		private static readonly EntThinkAdapter medic_attack = new(
			"medic_attack",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter medic_checkattack = new(
			"medic_checkattack",
			(edict_t self) =>
			{
				if ((self.monsterinfo.aiflags & Defines.AI_MEDIC) != 0)
