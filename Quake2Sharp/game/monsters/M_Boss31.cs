...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Boss31
	{
		...
		private static readonly EntThinkAdapter jorg_search = new(
			"jorg_search",
			(edict_t self) =>
			{
				float r;
		...
		private static readonly EntThinkAdapter jorg_idle = new(
			"jorg_idle",
			(edict_t self) =>
			{
		...
		private static EntThinkAdapter jorg_death_hit = new(
			"jorg_death_hit",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter jorg_step_left = new(
			"jorg_step_left",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter jorg_step_right = new(
			"jorg_step_right",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter jorg_stand = new(
			"jorg_stand",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter jorg_reattack1 = new(
			"jorg_reattack1",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter jorg_attack1 = new(
			"jorg_attack1",
			(edict_t self) =>
			{
				self.monsterinfo.currentmove = M_Boss31.jorg_move_attack1;
		...
		private static readonly EntPainAdapter jorg_pain = new(
			"jorg_pain",
		...
		private static readonly EntThinkAdapter jorgBFG = new(
			"jorgBFG",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter jorg_firebullet_right = new(
		...
		private static readonly EntThinkAdapter jorg_firebullet_left = new(
		...
		private static readonly EntThinkAdapter jorg_firebullet = new(
			"jorg_firebullet",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter jorg_attack = new(
			"jorg_attack",
			(edict_t self) =>
			{
				float[] vec = {0, 0, 0};
		...
		/** Was disabled. RST. */
		private static readonly EntThinkAdapter jorg_dead = new(
			"jorg_dead",
			(edict_t self) =>
			{
				/*
		...
		private static readonly EntDieAdapter jorg_die = new(
			"jorg_die",
		...
		private static readonly EntThinkAdapter Jorg_CheckAttack = new(
			"Jorg_CheckAttack",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] jorg_frames_stand = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, M_Boss31.jorg_idle), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			...
			// 30
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 19, null),
			new(GameAI.ai_stand, 11, M_Boss31.jorg_step_left), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 6, null),
			new(GameAI.ai_stand, 9, M_Boss31.jorg_step_right), new(GameAI.ai_stand, 0, null),

			// 40
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, -2, null), new(GameAI.ai_stand, -17, M_Boss31.jorg_step_left),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, -12, null),
		...
		private static readonly mframe_t[] jorg_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 17, M_Boss31.jorg_step_left), new(GameAI.ai_run, 0, null), new(GameAI.ai_run, 0, null), new(GameAI.ai_run, 0, null),
			new(GameAI.ai_run, 12, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 33, M_Boss31.jorg_step_right),
			new(GameAI.ai_run, 0, null), new(GameAI.ai_run, 0, null), new(GameAI.ai_run, 0, null), new(GameAI.ai_run, 9, null), new(GameAI.ai_run, 9, null),
		...
		private static readonly mframe_t[] jorg_frames_start_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 6, null), new(GameAI.ai_walk, 7, null), new(GameAI.ai_walk, 9, null),
		...
		private static readonly mframe_t[] jorg_frames_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 17, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null),
			new(GameAI.ai_walk, 12, null), new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 10, null), new(GameAI.ai_walk, 33, null),
			new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 9, null),
			new(GameAI.ai_walk, 9, null), new(GameAI.ai_walk, 9, null)
		};
		...
		private static readonly mframe_t[] jorg_frames_end_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 11, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null),
			new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, -8, null)
		};
		...
		private static readonly EntThinkAdapter jorg_walk = new(
			"jorg_walk",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter jorg_run = new(
			"jorg_run",
			(edict_t self) =>
			{
				if ((self.monsterinfo.aiflags & Defines.AI_STAND_GROUND) != 0)
		...
		private static readonly mframe_t[] jorg_frames_pain3 = new mframe_t[]
		{
			new(GameAI.ai_move, -28, null), new(GameAI.ai_move, -6, null), new(GameAI.ai_move, -3, M_Boss31.jorg_step_left), new(GameAI.ai_move, -9, null),
			new(GameAI.ai_move, 0, M_Boss31.jorg_step_right), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, -7, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, -11, null), new(GameAI.ai_move, -4, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 10, null), new(GameAI.ai_move, 11, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 10, null), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 10, null),
			new(GameAI.ai_move, 7, M_Boss31.jorg_step_left), new(GameAI.ai_move, 17, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mframe_t[] jorg_frames_pain2 = new mframe_t[]
		{
		...
		private static readonly mframe_t[] jorg_frames_pain1 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};
		...
		private static readonly mframe_t[] jorg_frames_death1 = new mframe_t[]
		{
			...
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, M_Boss32.MakronToss), new(GameAI.ai_move, 0, M_Supertank.BossExplode) // 50
		};
		...
		private static readonly mframe_t[] jorg_frames_attack2 = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Boss31.jorgBFG), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t jorg_move_attack2 = new(
			M_Boss31.FRAME_attak201,
			M_Boss31.FRAME_attak213,
			M_Boss31.jorg_frames_attack2,
			M_Boss31.jorg_run
		);

		private static readonly mframe_t[] jorg_frames_start_attack1 = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t jorg_move_start_attack1 = new(
			M_Boss31.FRAME_attak101,
			M_Boss31.FRAME_attak108,
			M_Boss31.jorg_frames_start_attack1,
			M_Boss31.jorg_attack1
		);

		private static readonly mframe_t[] jorg_frames_attack1 = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, M_Boss31.jorg_firebullet), new(GameAI.ai_charge, 0, M_Boss31.jorg_firebullet),
			new(GameAI.ai_charge, 0, M_Boss31.jorg_firebullet), new(GameAI.ai_charge, 0, M_Boss31.jorg_firebullet),
			new(GameAI.ai_charge, 0, M_Boss31.jorg_firebullet), new(GameAI.ai_charge, 0, M_Boss31.jorg_firebullet)
		};

		private static readonly mmove_t jorg_move_attack1 = new(
			M_Boss31.FRAME_attak109,
			M_Boss31.FRAME_attak114,
			M_Boss31.jorg_frames_attack1,
			M_Boss31.jorg_reattack1
		);

		private static readonly mframe_t[] jorg_frames_end_attack1 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t jorg_move_end_attack1 = new(
			M_Boss31.FRAME_attak115,
			M_Boss31.FRAME_attak118,
			M_Boss31.jorg_frames_end_attack1,
			M_Boss31.jorg_run
		);
