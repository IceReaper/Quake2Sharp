...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Boss2
	{
		...
		private static readonly EntThinkAdapter boss2_stand = new(
			"boss2_stand",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter boss2_run = new(
			"boss2_run",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter boss2_walk = new(
			"boss2_walk",
			(edict_t self) =>
			{
				self.monsterinfo.currentmove = M_Boss2.boss2_move_stand;
		...
		private static readonly EntThinkAdapter boss2_attack = new(
			"boss2_attack",
			(edict_t self) =>
			{
				float[] vec = {0, 0, 0};
		...
		private static readonly EntThinkAdapter boss2_attack_mg = new(
			"boss2_attack_mg",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter boss2_reattack_mg = new(
			"boss2_reattack_mg",
			(edict_t self) =>
			{
		...
		private static readonly EntPainAdapter boss2_pain = new(
			"boss2_pain",
		...
		private static readonly EntThinkAdapter boss2_dead = new(
			"boss2_dead",
			(edict_t self) =>
			{
		...
		private static readonly EntDieAdapter boss2_die = new(
			"boss2_die",
		...
		private static readonly EntThinkAdapter Boss2_CheckAttack = new(
			"Boss2_CheckAttack",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter boss2_search = new(
			"boss2_search",
			(edict_t self) =>
			{
				if (Lib.random() < 0.5)
		...
		private static readonly EntThinkAdapter Boss2Rocket = new(
			"Boss2Rocket",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter boss2_firebullet_right = new(
		...
		private static readonly EntThinkAdapter boss2_firebullet_left = new(
		...
		private static readonly EntThinkAdapter Boss2MachineGun = new(
			"Boss2MachineGun",
			(edict_t self) =>
			{
				/*
		...
		private static readonly mframe_t[] boss2_frames_stand = new mframe_t[]
		{
		...
		private static readonly mframe_t[] boss2_frames_fidget = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
		...
		private static readonly mframe_t[] boss2_frames_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null),
			new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null),
			new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null),
			new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null),
			new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null)
		...
		private static readonly mframe_t[] boss2_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null),
			new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null),
			new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null),
			new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null)
		};
		...
		private static readonly mframe_t[] boss2_frames_attack_pre_mg = new mframe_t[]
		{
		...
		//	   Loop this
		private static readonly mframe_t[] boss2_frames_attack_mg = new mframe_t[]
		{
			new(GameAI.ai_charge, 1, M_Boss2.Boss2MachineGun), new(GameAI.ai_charge, 1, M_Boss2.Boss2MachineGun),
			new(GameAI.ai_charge, 1, M_Boss2.Boss2MachineGun), new(GameAI.ai_charge, 1, M_Boss2.Boss2MachineGun),
			new(GameAI.ai_charge, 1, M_Boss2.Boss2MachineGun), new(GameAI.ai_charge, 1, M_Boss2.boss2_reattack_mg)
		};
		...
		private static readonly mframe_t[] boss2_frames_attack_post_mg = new mframe_t[]
		{
			new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null)
		};

		private static readonly mmove_t boss2_move_attack_post_mg = new(
			M_Boss2.FRAME_attack16,
			M_Boss2.FRAME_attack19,
			M_Boss2.boss2_frames_attack_post_mg,
			M_Boss2.boss2_run
		);

		private static readonly mframe_t[] boss2_frames_attack_rocket = new mframe_t[]
		{
			new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null),
			new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null),
			new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null),
			new(GameAI.ai_move, -20, M_Boss2.Boss2Rocket), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null),
			new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null),
			new(GameAI.ai_charge, 1, null)
		};

		private static readonly mmove_t boss2_move_attack_rocket = new(
			M_Boss2.FRAME_attack20,
			M_Boss2.FRAME_attack40,
			M_Boss2.boss2_frames_attack_rocket,
			M_Boss2.boss2_run
		);

		private static readonly mframe_t[] boss2_frames_pain_heavy = new mframe_t[]
		{
		...
		private static readonly mmove_t boss2_move_pain_heavy = new(
			M_Boss2.FRAME_pain2,
			M_Boss2.FRAME_pain19,
			M_Boss2.boss2_frames_pain_heavy,
			M_Boss2.boss2_run
		);

		private static readonly mframe_t[] boss2_frames_pain_light = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t boss2_move_pain_light = new(
			M_Boss2.FRAME_pain20,
			M_Boss2.FRAME_pain23,
			M_Boss2.boss2_frames_pain_light,
			M_Boss2.boss2_run
		);

		private static readonly mframe_t[] boss2_frames_death = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
