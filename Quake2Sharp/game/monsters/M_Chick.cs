...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Chick
	{
		...
		private static readonly EntThinkAdapter ChickMoan = new(
			"ChickMoan",
			(edict_t self) =>
			{
				if (Lib.random() < 0.5)
		...
		private static readonly mframe_t[] chick_frames_fidget = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, M_Chick.ChickMoan), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null)
		};

		private static readonly EntThinkAdapter chick_stand = new(
			"chick_stand",
			(edict_t self) =>
			{
		...
		private static readonly mmove_t chick_move_fidget = new(
			M_Chick.FRAME_stand201,
			M_Chick.FRAME_stand230,
			M_Chick.chick_frames_fidget,
			M_Chick.chick_stand
		);

		private static readonly EntThinkAdapter chick_fidget = new(
			"chick_fidget",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] chick_frames_stand = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			...
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, M_Chick.chick_fidget),
		};
		...
		private static readonly EntThinkAdapter chick_run = new(
			"chick_run",
			(edict_t self) =>
			{
				if ((self.monsterinfo.aiflags & Defines.AI_STAND_GROUND) != 0)
		...
		private static readonly mframe_t[] chick_frames_start_run = new mframe_t[]
		{
			new(GameAI.ai_run, 1, null), new(GameAI.ai_run, 0, null), new(GameAI.ai_run, 0, null), new(GameAI.ai_run, -1, null),
			new(GameAI.ai_run, -1, null), new(GameAI.ai_run, 0, null), new(GameAI.ai_run, 1, null), new(GameAI.ai_run, 3, null),
			new(GameAI.ai_run, 6, null), new(GameAI.ai_run, 3, null)
		};

		private static readonly mmove_t chick_move_start_run = new(
			M_Chick.FRAME_walk01,
			M_Chick.FRAME_walk10,
			M_Chick.chick_frames_start_run,
			M_Chick.chick_run
		);

		private static readonly mframe_t[] chick_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 6, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 5, null),
			new(GameAI.ai_run, 7, null), new(GameAI.ai_run, 4, null), new(GameAI.ai_run, 11, null), new(GameAI.ai_run, 5, null),
			new(GameAI.ai_run, 9, null), new(GameAI.ai_run, 7, null)
		};
		...
		private static readonly mframe_t[] chick_frames_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 6, null), new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 13, null), new(GameAI.ai_walk, 5, null),
			new(GameAI.ai_walk, 7, null), new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 11, null), new(GameAI.ai_walk, 5, null),
			new(GameAI.ai_walk, 9, null), new(GameAI.ai_walk, 7, null)
		};
		...
		private static readonly EntThinkAdapter chick_walk = new(
			"chick_walk",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] chick_frames_pain1 = new mframe_t[]
		{
		...
		private static readonly mframe_t[] chick_frames_pain2 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null)
		};
		...
		private static readonly mframe_t[] chick_frames_pain3 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -6, null), new(GameAI.ai_move, 3, null),
			new(GameAI.ai_move, 11, null), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 4, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -3, null),
			new(GameAI.ai_move, -4, null), new(GameAI.ai_move, 5, null), new(GameAI.ai_move, 7, null), new(GameAI.ai_move, -2, null),
			new(GameAI.ai_move, 3, null), new(GameAI.ai_move, -5, null), new(GameAI.ai_move, -2, null), new(GameAI.ai_move, -8, null),
		...
		private static readonly EntPainAdapter chick_pain = new(
			"chick_pain",
			(edict_t self, edict_t other, float kick, int damage) =>
			{
				float r;
		...
		private static readonly EntThinkAdapter chick_dead = new(
			"chick_dead",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] chick_frames_death2 = new mframe_t[]
		{
			new(GameAI.ai_move, -6, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -5, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -2, null), new(GameAI.ai_move, 1, null),
			new(GameAI.ai_move, 10, null), new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 1, null),
			new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 3, null),
			new(GameAI.ai_move, 1, null), new(GameAI.ai_move, -3, null), new(GameAI.ai_move, -5, null), new(GameAI.ai_move, 4, null),
			new(GameAI.ai_move, 15, null), new(GameAI.ai_move, 14, null), new(GameAI.ai_move, 1, null)
		};

		private static readonly mmove_t chick_move_death2 = new(
			M_Chick.FRAME_death201,
			M_Chick.FRAME_death223,
			M_Chick.chick_frames_death2,
			M_Chick.chick_dead
		);

		private static readonly mframe_t[] chick_frames_death1 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -7, null), new(GameAI.ai_move, 4, null),
			new(GameAI.ai_move, 11, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t chick_move_death1 = new(
			M_Chick.FRAME_death101,
			M_Chick.FRAME_death112,
			M_Chick.chick_frames_death1,
			M_Chick.chick_dead
		);

		private static readonly EntDieAdapter chick_die = new(
			"chick_die",
		...
		private static readonly EntThinkAdapter chick_duck_down = new(
			"chick_duck_down",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter chick_duck_hold = new(
			"chick_duck_hold",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter chick_duck_up = new(
			"chick_duck_up",
			(edict_t self) =>
			{
				self.monsterinfo.aiflags &= ~Defines.AI_DUCKED;
		...
		private static readonly mframe_t[] chick_frames_duck = new mframe_t[]
		{
			new(GameAI.ai_move, 0, M_Chick.chick_duck_down), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 4, M_Chick.chick_duck_hold),
			new(GameAI.ai_move, -4, null), new(GameAI.ai_move, -5, M_Chick.chick_duck_up), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 1, null)
		};
		...
		private static readonly EntDodgeAdapter chick_dodge = new(
			"chick_dodge",
			(edict_t self, edict_t attacker, float eta) =>
			{
				if (Lib.random() > 0.25)
					return;
		...
		private static readonly EntThinkAdapter ChickSlash = new(
			"ChickSlash",
			(edict_t self) =>
			{
				float[] aim = {0, 0, 0};
		...
		private static readonly EntThinkAdapter ChickRocket = new(
			"ChickRocket",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter Chick_PreAttack1 = new(
			"Chick_PreAttack1",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter ChickReload = new(
			"ChickReload",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter chick_attack1 = new(
			"chick_attack1",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter chick_rerocket = new(
			"chick_rerocket",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] chick_frames_start_attack1 = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, M_Chick.Chick_PreAttack1), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 4, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, -3, null), new(GameAI.ai_charge, 3, null),
			new(GameAI.ai_charge, 5, null), new(GameAI.ai_charge, 7, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Chick.chick_attack1)
		};

		private static readonly mmove_t chick_move_start_attack1 = new(
			M_Chick.FRAME_attak101,
			M_Chick.FRAME_attak113,
			M_Chick.chick_frames_start_attack1,
			null
		);

		private static readonly mframe_t[] chick_frames_attack1 = new mframe_t[]
		{
			new(GameAI.ai_charge, 19, M_Chick.ChickRocket), new(GameAI.ai_charge, -6, null), new(GameAI.ai_charge, -5, null),
			new(GameAI.ai_charge, -2, null), new(GameAI.ai_charge, -7, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 1, null),
			new(GameAI.ai_charge, 10, M_Chick.ChickReload), new(GameAI.ai_charge, 4, null), new(GameAI.ai_charge, 5, null), new(GameAI.ai_charge, 6, null),
			new(GameAI.ai_charge, 6, null), new(GameAI.ai_charge, 4, null), new(GameAI.ai_charge, 3, M_Chick.chick_rerocket)
		};
		...
		private static readonly mframe_t[] chick_frames_end_attack1 = new mframe_t[]
		{
			new(GameAI.ai_charge, -3, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, -6, null), new(GameAI.ai_charge, -4, null),
			new(GameAI.ai_charge, -2, null)
		};

		private static readonly mmove_t chick_move_end_attack1 = new(
			M_Chick.FRAME_attak128,
			M_Chick.FRAME_attak132,
			M_Chick.chick_frames_end_attack1,
			M_Chick.chick_run
		);

		private static readonly EntThinkAdapter chick_reslash = new(
			"chick_reslash",
			(edict_t self) =>
			{
				if (self.enemy.health > 0)
		...
		private static readonly mframe_t[] chick_frames_slash = new mframe_t[]
		{
			new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 7, M_Chick.ChickSlash), new(GameAI.ai_charge, -7, null), new(GameAI.ai_charge, 1, null),
			new(GameAI.ai_charge, -1, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 1, null),
		...
		private static readonly mframe_t[] chick_frames_end_slash = new mframe_t[]
		{
			new(GameAI.ai_charge, -6, null), new(GameAI.ai_charge, -1, null), new(GameAI.ai_charge, -6, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t chick_move_end_slash = new(
			M_Chick.FRAME_attak213,
			M_Chick.FRAME_attak216,
			M_Chick.chick_frames_end_slash,
			M_Chick.chick_run
		);

		private static readonly EntThinkAdapter chick_slash = new(
			"chick_slash",
			(edict_t self) =>
			{
				self.monsterinfo.currentmove = M_Chick.chick_move_slash;
		...
		private static readonly mframe_t[] chick_frames_start_slash = new mframe_t[]
		{
			new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 8, null), new(GameAI.ai_charge, 3, null)
		};

		private static readonly mmove_t chick_move_start_slash = new(
			M_Chick.FRAME_attak201,
			M_Chick.FRAME_attak203,
			M_Chick.chick_frames_start_slash,
			M_Chick.chick_slash
		);

		private static readonly EntThinkAdapter chick_melee = new(
			"chick_melee",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter chick_attack = new(
			"chick_attack",
			(edict_t self) =>
			{
		...
		private static readonly EntInteractAdapter chick_sight = new(
			"chick_sight",
