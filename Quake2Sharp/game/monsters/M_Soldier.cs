...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Soldier
	{
		...
		private static readonly EntThinkAdapter soldier_dead = new(
			"soldier_dead",
			(edict_t self) =>
			{
		...
		private static readonly EntDieAdapter soldier_die = new(
			"soldier_die",
		...
		private static readonly EntThinkAdapter soldier_attack1_refire1 = new(
		...
		private static readonly EntThinkAdapter soldier_attack1_refire2 = new(
		...
		private static readonly EntThinkAdapter soldier_attack2_refire1 = new(
		...
		private static readonly EntThinkAdapter soldier_attack2_refire2 = new(
		...
		private static readonly EntThinkAdapter soldier_attack3_refire = new(
		...
		private static readonly EntThinkAdapter soldier_attack6_refire = new(
		...
		// ATTACK6 (run & shoot)
		private static readonly EntThinkAdapter soldier_fire8 = new(
			"soldier_fire8",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter soldier_fire1 = new(
			"soldier_fire1",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter soldier_fire2 = new(
			"soldier_fire2",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter soldier_duck_down = new(
			"soldier_duck_down",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter soldier_fire3 = new(
			"soldier_fire3",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter soldier_fire4 = new(
			"soldier_fire4",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter soldier_fire6 = new(
			"soldier_fire6",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter soldier_fire7 = new(
			"soldier_fire7",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter soldier_idle = new(
			"soldier_idle",
			(edict_t self) =>
			{
				if (Lib.random() > 0.8)
		...
		private static readonly EntThinkAdapter soldier_stand = new(
			"soldier_stand",
			(edict_t self) =>
			{
		...
		// WALK
		//
		private static readonly EntThinkAdapter soldier_walk1_random = new(
		...
		private static readonly EntThinkAdapter soldier_walk = new(
			"soldier_walk",
			(edict_t self) =>
			{
				if (Lib.random() < 0.5)
		...
		private static readonly EntThinkAdapter soldier_run = new(
			"soldier_run",
			(edict_t self) =>
			{
		...
		private static readonly EntPainAdapter soldier_pain = new(
			"soldier_pain",
		...
		private static readonly EntThinkAdapter soldier_duck_up = new(
			"soldier_duck_up",
			(edict_t self) =>
			{
				self.monsterinfo.aiflags &= ~Defines.AI_DUCKED;
		...
		private static readonly EntInteractAdapter soldier_sight = new(
			"soldier_sight",
		...
		private static readonly EntThinkAdapter SP_monster_soldier_x = new(
		 ...
		 * Trigger_Spawn Sight
		 */
		public static EntThinkAdapter SP_monster_soldier_light = new(
		...
		public static EntThinkAdapter SP_monster_soldier = new(
			"SP_monster_soldier",
			(edict_t self) =>
			{
     ...
     * Trigger_Spawn Sight
     */
		public static EntThinkAdapter SP_monster_soldier_ss = new(
		...
		private static readonly EntThinkAdapter soldier_cock = new(
			"soldier_cock",
			(edict_t self) =>
			{
		...
		// STAND
		private static readonly mframe_t[] soldier_frames_stand1 = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, M_Soldier.soldier_idle), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
		...
		private static readonly mmove_t soldier_move_stand1 = new(
			M_Soldier.FRAME_stand101,
			M_Soldier.FRAME_stand130,
			M_Soldier.soldier_frames_stand1,
			M_Soldier.soldier_stand
		);

		private static readonly mframe_t[] soldier_frames_stand3 = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, M_Soldier.soldier_cock), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null)
		};

		private static readonly mmove_t soldier_move_stand3 = new(
			M_Soldier.FRAME_stand301,
			M_Soldier.FRAME_stand339,
			M_Soldier.soldier_frames_stand3,
			M_Soldier.soldier_stand
		);

		private static readonly mframe_t[] soldier_frames_walk1 = new mframe_t[]
		{
			new(GameAI.ai_walk, 3, null), new(GameAI.ai_walk, 6, null), new(GameAI.ai_walk, 2, null), new(GameAI.ai_walk, 2, null),
			new(GameAI.ai_walk, 2, null), new(GameAI.ai_walk, 1, null), new(GameAI.ai_walk, 6, null), new(GameAI.ai_walk, 5, null),
			new(GameAI.ai_walk, 3, null), new(GameAI.ai_walk, -1, M_Soldier.soldier_walk1_random), new(GameAI.ai_walk, 0, null),
			new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null),
			new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null),
			new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null),
			new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null),
			new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null),
			new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null)
		};
		...
		private static readonly mframe_t[] soldier_frames_walk2 = new mframe_t[]
		{
			new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 9, null), new(GameAI.ai_walk, 8, null),
			new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 1, null), new(GameAI.ai_walk, 3, null), new(GameAI.ai_walk, 7, null),
			new(GameAI.ai_walk, 6, null), new(GameAI.ai_walk, 7, null)
		};
		...
		private static readonly mframe_t[] soldier_frames_start_run = new mframe_t[] {new(GameAI.ai_run, 7, null), new(GameAI.ai_run, 5, null)};

		private static readonly mmove_t soldier_move_start_run = new(
			M_Soldier.FRAME_run01,
			M_Soldier.FRAME_run02,
			M_Soldier.soldier_frames_start_run,
			M_Soldier.soldier_run
		);

		private static readonly mframe_t[] soldier_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 11, null), new(GameAI.ai_run, 11, null), new(GameAI.ai_run, 16, null),
			new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 15, null)
		};
		...
		private static readonly EntThinkAdapter soldier_duck_hold = new(
			"soldier_duck_hold",
			(edict_t self) =>
			{
				if (GameBase.level.time >= self.monsterinfo.pausetime)
		...
		private static readonly mframe_t[] soldier_frames_pain1 = new mframe_t[]
		{
			new(GameAI.ai_move, -3, null), new(GameAI.ai_move, 4, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 1, null),
			new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t soldier_move_pain1 = new(
			M_Soldier.FRAME_pain101,
			M_Soldier.FRAME_pain105,
			M_Soldier.soldier_frames_pain1,
			M_Soldier.soldier_run
		);

		private static readonly mframe_t[] soldier_frames_pain2 = new mframe_t[]
		{
			new(GameAI.ai_move, -13, null), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 4, null),
			new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 2, null)
		};

		private static readonly mmove_t soldier_move_pain2 = new(
			M_Soldier.FRAME_pain201,
			M_Soldier.FRAME_pain207,
			M_Soldier.soldier_frames_pain2,
			M_Soldier.soldier_run
		);

		private static readonly mframe_t[] soldier_frames_pain3 = new mframe_t[]
		{
			new(GameAI.ai_move, -8, null), new(GameAI.ai_move, 10, null), new(GameAI.ai_move, -4, null), new(GameAI.ai_move, -1, null),
			new(GameAI.ai_move, -3, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 1, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 4, null),
			new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 2, null)
		};

		private static readonly mmove_t soldier_move_pain3 = new(
			M_Soldier.FRAME_pain301,
			M_Soldier.FRAME_pain318,
			M_Soldier.soldier_frames_pain3,
			M_Soldier.soldier_run
		);

		private static readonly mframe_t[] soldier_frames_pain4 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -10, null),
			new(GameAI.ai_move, -6, null), new(GameAI.ai_move, 8, null), new(GameAI.ai_move, 4, null), new(GameAI.ai_move, 1, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 5, null), new(GameAI.ai_move, 2, null),
			new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 2, null),
			new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t soldier_move_pain4 = new(
			M_Soldier.FRAME_pain401,
			M_Soldier.FRAME_pain417,
			M_Soldier.soldier_frames_pain4,
			M_Soldier.soldier_run
		);
		...
		{
			Defines.MZ2_SOLDIER_BLASTER_1, Defines.MZ2_SOLDIER_BLASTER_2, Defines.MZ2_SOLDIER_BLASTER_3, Defines.MZ2_SOLDIER_BLASTER_4,
			Defines.MZ2_SOLDIER_BLASTER_5, Defines.MZ2_SOLDIER_BLASTER_6, Defines.MZ2_SOLDIER_BLASTER_7, Defines.MZ2_SOLDIER_BLASTER_8
		};

		private static readonly int[] shotgun_flash =
		{
			Defines.MZ2_SOLDIER_SHOTGUN_1, Defines.MZ2_SOLDIER_SHOTGUN_2, Defines.MZ2_SOLDIER_SHOTGUN_3, Defines.MZ2_SOLDIER_SHOTGUN_4,
			Defines.MZ2_SOLDIER_SHOTGUN_5, Defines.MZ2_SOLDIER_SHOTGUN_6, Defines.MZ2_SOLDIER_SHOTGUN_7, Defines.MZ2_SOLDIER_SHOTGUN_8
		};

		private static readonly int[] machinegun_flash =
		{
			Defines.MZ2_SOLDIER_MACHINEGUN_1, Defines.MZ2_SOLDIER_MACHINEGUN_2, Defines.MZ2_SOLDIER_MACHINEGUN_3, Defines.MZ2_SOLDIER_MACHINEGUN_4,
			Defines.MZ2_SOLDIER_MACHINEGUN_5, Defines.MZ2_SOLDIER_MACHINEGUN_6, Defines.MZ2_SOLDIER_MACHINEGUN_7, Defines.MZ2_SOLDIER_MACHINEGUN_8
		};

		private static readonly mframe_t[] soldier_frames_attack1 = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Soldier.soldier_fire1),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Soldier.soldier_attack1_refire1),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Soldier.soldier_cock), new(GameAI.ai_charge, 0, M_Soldier.soldier_attack1_refire2),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t soldier_move_attack1 = new(
			M_Soldier.FRAME_attak101,
			M_Soldier.FRAME_attak112,
			M_Soldier.soldier_frames_attack1,
			M_Soldier.soldier_run
		);

		private static readonly mframe_t[] soldier_frames_attack2 = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Soldier.soldier_fire2), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Soldier.soldier_attack2_refire1), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Soldier.soldier_cock),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Soldier.soldier_attack2_refire2), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t soldier_move_attack2 = new(
			M_Soldier.FRAME_attak201,
			M_Soldier.FRAME_attak218,
			M_Soldier.soldier_frames_attack2,
			M_Soldier.soldier_run
		);

		private static readonly mframe_t[] soldier_frames_attack3 = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Soldier.soldier_fire3),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Soldier.soldier_attack3_refire),
			new(GameAI.ai_charge, 0, M_Soldier.soldier_duck_up), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t soldier_move_attack3 = new(
			M_Soldier.FRAME_attak301,
			M_Soldier.FRAME_attak309,
			M_Soldier.soldier_frames_attack3,
			M_Soldier.soldier_run
		);

		private static readonly mframe_t[] soldier_frames_attack4 = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Soldier.soldier_fire4),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t soldier_move_attack4 = new(
			M_Soldier.FRAME_attak401,
			M_Soldier.FRAME_attak406,
			M_Soldier.soldier_frames_attack4,
			M_Soldier.soldier_run
		);

		private static readonly mframe_t[] soldier_frames_attack6 = new mframe_t[]
		{
			new(GameAI.ai_charge, 10, null), new(GameAI.ai_charge, 4, null), new(GameAI.ai_charge, 12, null),
			new(GameAI.ai_charge, 11, M_Soldier.soldier_fire8), new(GameAI.ai_charge, 13, null), new(GameAI.ai_charge, 18, null),
			new(GameAI.ai_charge, 15, null), new(GameAI.ai_charge, 14, null), new(GameAI.ai_charge, 11, null), new(GameAI.ai_charge, 8, null),
			new(GameAI.ai_charge, 11, null), new(GameAI.ai_charge, 12, null), new(GameAI.ai_charge, 12, null),
			new(GameAI.ai_charge, 17, M_Soldier.soldier_attack6_refire)
		};

		private static readonly mmove_t soldier_move_attack6 = new(
			M_Soldier.FRAME_runs01,
			M_Soldier.FRAME_runs14,
			M_Soldier.soldier_frames_attack6,
			M_Soldier.soldier_run
		);

		private static readonly mframe_t[] soldier_frames_duck = new mframe_t[]
		{
			new(GameAI.ai_move, 5, M_Soldier.soldier_duck_down), new(GameAI.ai_move, -1, M_Soldier.soldier_duck_hold), new(GameAI.ai_move, 1, null),
			new(GameAI.ai_move, 0, M_Soldier.soldier_duck_up), new(GameAI.ai_move, 5, null)
		};

		private static readonly mmove_t soldier_move_duck = new(
			M_Soldier.FRAME_duck01,
			M_Soldier.FRAME_duck05,
			M_Soldier.soldier_frames_duck,
			M_Soldier.soldier_run
		);

		private static readonly mframe_t[] soldier_frames_death1 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -10, null), new(GameAI.ai_move, -10, null), new(GameAI.ai_move, -10, null),
			new(GameAI.ai_move, -5, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, M_Soldier.soldier_fire6), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, M_Soldier.soldier_fire7), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t soldier_move_death1 = new(
			M_Soldier.FRAME_death101,
			M_Soldier.FRAME_death136,
			M_Soldier.soldier_frames_death1,
			M_Soldier.soldier_dead
		);

		private static readonly mframe_t[] soldier_frames_death2 = new mframe_t[]
		{
			new(GameAI.ai_move, -5, null), new(GameAI.ai_move, -5, null), new(GameAI.ai_move, -5, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mmove_t soldier_move_death2 = new(
			M_Soldier.FRAME_death201,
			M_Soldier.FRAME_death235,
			M_Soldier.soldier_frames_death2,
			M_Soldier.soldier_dead
		);

		private static readonly mframe_t[] soldier_frames_death3 = new mframe_t[]
		{
			new(GameAI.ai_move, -5, null), new(GameAI.ai_move, -5, null), new(GameAI.ai_move, -5, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mmove_t soldier_move_death3 = new(
			M_Soldier.FRAME_death301,
			M_Soldier.FRAME_death345,
			M_Soldier.soldier_frames_death3,
			M_Soldier.soldier_dead
		);

		private static readonly mframe_t[] soldier_frames_death4 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mmove_t soldier_move_death4 = new(
			M_Soldier.FRAME_death401,
			M_Soldier.FRAME_death453,
			M_Soldier.soldier_frames_death4,
			M_Soldier.soldier_dead
		);

		private static readonly mframe_t[] soldier_frames_death5 = new mframe_t[]
		{
			new(GameAI.ai_move, -5, null), new(GameAI.ai_move, -5, null), new(GameAI.ai_move, -5, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mmove_t soldier_move_death5 = new(
			M_Soldier.FRAME_death501,
			M_Soldier.FRAME_death524,
			M_Soldier.soldier_frames_death5,
			M_Soldier.soldier_dead
		);

		private static readonly mframe_t[] soldier_frames_death6 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mmove_t soldier_move_death6 = new(
			M_Soldier.FRAME_death601,
			M_Soldier.FRAME_death610,
			M_Soldier.soldier_frames_death6,
			M_Soldier.soldier_dead
		);

		// ATTACK3 (duck and shoot)

		private static readonly EntThinkAdapter soldier_attack = new(
			"soldier_attack",
			(edict_t self) =>
			{
				if (self.s.skinnum < 4)
		...
		private static readonly EntDodgeAdapter soldier_dodge = new(
			"soldier_dodge",
