...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Parasite
	{
		...
		private static readonly EntThinkAdapter parasite_launch = new(
			"parasite_launch",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter parasite_reel_in = new(
			"parasite_reel_in",
			(edict_t self) =>
			{
		...
		private static readonly EntInteractAdapter parasite_sight = new(
			"parasite_sight",
		...
		private static readonly EntThinkAdapter parasite_tap = new(
			"parasite_tap",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter parasite_scratch = new(
			"parasite_scratch",
			(edict_t self) =>
			{
		...
		private static EntThinkAdapter parasite_search = new(
			"parasite_search",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter parasite_start_walk = new(
			"parasite_start_walk",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter parasite_walk = new(
			"parasite_walk",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter parasite_stand = new(
			"parasite_stand",
			(edict_t self) =>
			{
		...
		private static EntThinkAdapter parasite_end_fidget = new(
			"parasite_end_fidget",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter parasite_do_fidget = new(
			"parasite_do_fidget",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter parasite_refidget = new(
			"parasite_refidget",
			(edict_t self) =>
			{
				if (Lib.random() <= 0.8)
		...
		private static readonly EntThinkAdapter parasite_idle = new(
			"parasite_idle",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter parasite_start_run = new(
			"parasite_start_run",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter parasite_run = new(
			"parasite_run",
			(edict_t self) =>
			{
				if ((self.monsterinfo.aiflags & Defines.AI_STAND_GROUND) != 0)
		...
		private static readonly mframe_t[] parasite_frames_start_fidget = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null)
		};

		private static readonly mmove_t parasite_move_start_fidget = new(
			M_Parasite.FRAME_stand18,
			M_Parasite.FRAME_stand21,
			M_Parasite.parasite_frames_start_fidget,
			M_Parasite.parasite_do_fidget
		);

		private static readonly mframe_t[] parasite_frames_fidget = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, M_Parasite.parasite_scratch), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, M_Parasite.parasite_scratch), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null)
		};

		private static readonly mmove_t parasite_move_fidget = new(
			M_Parasite.FRAME_stand22,
			M_Parasite.FRAME_stand27,
			M_Parasite.parasite_frames_fidget,
			M_Parasite.parasite_refidget
		);

		private static readonly mframe_t[] parasite_frames_end_fidget = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, M_Parasite.parasite_scratch), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
		...
		private static readonly mmove_t parasite_move_end_fidget = new(
			M_Parasite.FRAME_stand28,
			M_Parasite.FRAME_stand35,
			M_Parasite.parasite_frames_end_fidget,
			M_Parasite.parasite_stand
		);

		private static readonly mframe_t[] parasite_frames_stand = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, M_Parasite.parasite_tap), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, M_Parasite.parasite_tap), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, M_Parasite.parasite_tap), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, M_Parasite.parasite_tap),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, M_Parasite.parasite_tap),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, M_Parasite.parasite_tap)
		};

		private static readonly mmove_t parasite_move_stand = new(
			M_Parasite.FRAME_stand01,
			M_Parasite.FRAME_stand17,
			M_Parasite.parasite_frames_stand,
			M_Parasite.parasite_stand
		);

		private static readonly mframe_t[] parasite_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 30, null), new(GameAI.ai_run, 30, null), new(GameAI.ai_run, 22, null), new(GameAI.ai_run, 19, null),
			new(GameAI.ai_run, 24, null), new(GameAI.ai_run, 28, null), new(GameAI.ai_run, 25, null)
		};
		...
		private static readonly mframe_t[] parasite_frames_start_run = new mframe_t[] {new(GameAI.ai_run, 0, null), new(GameAI.ai_run, 30, null),};

		private static readonly mmove_t parasite_move_start_run = new(
			M_Parasite.FRAME_run01,
			M_Parasite.FRAME_run02,
			M_Parasite.parasite_frames_start_run,
			M_Parasite.parasite_run
		);

		private static readonly mframe_t[] parasite_frames_stop_run = new mframe_t[]
		{
			new(GameAI.ai_run, 20, null), new(GameAI.ai_run, 20, null), new(GameAI.ai_run, 12, null), new(GameAI.ai_run, 10, null),
			new(GameAI.ai_run, 0, null), new(GameAI.ai_run, 0, null)
		};
		...
		private static readonly mframe_t[] parasite_frames_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 30, null), new(GameAI.ai_walk, 30, null), new(GameAI.ai_walk, 22, null), new(GameAI.ai_walk, 19, null),
			new(GameAI.ai_walk, 24, null), new(GameAI.ai_walk, 28, null), new(GameAI.ai_walk, 25, null)
		};

		private static readonly mmove_t parasite_move_walk = new(
			M_Parasite.FRAME_run03,
			M_Parasite.FRAME_run09,
			M_Parasite.parasite_frames_walk,
			M_Parasite.parasite_walk
		);

		private static readonly mframe_t[] parasite_frames_start_walk =
			new mframe_t[] {new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 30, M_Parasite.parasite_walk)};

		private static readonly mmove_t parasite_move_start_walk = new(
			M_Parasite.FRAME_run01,
			M_Parasite.FRAME_run02,
			M_Parasite.parasite_frames_start_walk,
			null
		);

		private static readonly mframe_t[] parasite_frames_stop_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 20, null), new(GameAI.ai_walk, 20, null), new(GameAI.ai_walk, 12, null), new(GameAI.ai_walk, 10, null),
		...
		private static readonly mframe_t[] parasite_frames_pain1 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 6, null), new(GameAI.ai_move, 16, null),
			new(GameAI.ai_move, -6, null), new(GameAI.ai_move, -7, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t parasite_move_pain1 = new(
			M_Parasite.FRAME_pain101,
			M_Parasite.FRAME_pain111,
			M_Parasite.parasite_frames_pain1,
			M_Parasite.parasite_start_run
		);

		private static readonly EntPainAdapter parasite_pain = new(
			"parasite_pain",
		...
		private static readonly EntThinkAdapter parasite_drain_attack = new(
		...
		private static readonly mframe_t[] parasite_frames_drain = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, M_Parasite.parasite_launch), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 15, M_Parasite.parasite_drain_attack),
			...
			new(GameAI.ai_charge, -2, null), new(GameAI.ai_charge, -2, null), new(GameAI.ai_charge, -3, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t parasite_move_drain = new(
			M_Parasite.FRAME_drain01,
			M_Parasite.FRAME_drain18,
			M_Parasite.parasite_frames_drain,
			M_Parasite.parasite_start_run
		);

		private static readonly mframe_t[] parasite_frames_break = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, -3, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 2, null),
			new(GameAI.ai_charge, -3, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 3, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, -18, null), new(GameAI.ai_charge, 3, null), new(GameAI.ai_charge, 9, null),
			new(GameAI.ai_charge, 6, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, -18, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 8, null), new(GameAI.ai_charge, 9, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, -18, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			/* airborne */ new(GameAI.ai_charge, 0, null), /* slides */ new(GameAI.ai_charge, 0, null), /* slides */
			new(GameAI.ai_charge, 0, null), /* slides */ new(GameAI.ai_charge, 0, null), /* slides */ new(GameAI.ai_charge, 4, null),
			new(GameAI.ai_charge, 11, null), new(GameAI.ai_charge, -2, null), new(GameAI.ai_charge, -5, null), new(GameAI.ai_charge, 1, null)
		};

		private static mmove_t parasite_move_break = new(
			M_Parasite.FRAME_break01,
			M_Parasite.FRAME_break32,
			M_Parasite.parasite_frames_break,
			M_Parasite.parasite_start_run
		);
		...
		private static readonly EntThinkAdapter parasite_attack = new(
			"parasite_attack",
			(edict_t self) =>
			{
				//	if (random() <= 0.2)
		...
		private static readonly EntThinkAdapter parasite_dead = new(
			"parasite_dead",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] parasite_frames_death = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t parasite_move_death = new(
			M_Parasite.FRAME_death101,
			M_Parasite.FRAME_death107,
			M_Parasite.parasite_frames_death,
			M_Parasite.parasite_dead
		);

		private static readonly EntDieAdapter parasite_die = new(
			"parasite_die",
		...
		public static EntThinkAdapter SP_monster_parasite = new(
			"SP_monster_parasite",
			(edict_t self) =>
			{
