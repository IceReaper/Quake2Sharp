...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Gladiator
	{
		...
		private static readonly EntThinkAdapter gladiator_idle = new(
			"gladiator_idle",
			(edict_t self) =>
			{
		...
		private static readonly EntInteractAdapter gladiator_sight = new(
			"gladiator_sight",
		...
		private static readonly EntThinkAdapter gladiator_search = new(
			"gladiator_search",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter gladiator_cleaver_swing = new(
		...
		private static readonly mframe_t[] gladiator_frames_stand = new mframe_t[]
		{
		...
		private static readonly mmove_t gladiator_move_stand = new(
			M_Gladiator.FRAME_stand1,
			M_Gladiator.FRAME_stand7,
			M_Gladiator.gladiator_frames_stand,
			null
		);

		private static readonly EntThinkAdapter gladiator_stand = new(
			"gladiator_stand",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] gladiator_frames_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 15, null), new(GameAI.ai_walk, 7, null), new(GameAI.ai_walk, 6, null), new(GameAI.ai_walk, 5, null),
			new(GameAI.ai_walk, 2, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 2, null), new(GameAI.ai_walk, 8, null),
			new(GameAI.ai_walk, 12, null), new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null),
			new(GameAI.ai_walk, 2, null), new(GameAI.ai_walk, 2, null), new(GameAI.ai_walk, 1, null), new(GameAI.ai_walk, 8, null)
		};
		...
		private static readonly EntThinkAdapter gladiator_walk = new(
			"gladiator_walk",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] gladiator_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 23, null), new(GameAI.ai_run, 14, null), new(GameAI.ai_run, 14, null), new(GameAI.ai_run, 21, null),
			new(GameAI.ai_run, 12, null), new(GameAI.ai_run, 13, null)
		};
		...
		private static readonly EntThinkAdapter gladiator_run = new(
			"gladiator_run",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter GaldiatorMelee = new(
			"GaldiatorMelee",
			(edict_t self) =>
			{
				float[] aim = {0, 0, 0};
		...
		private static readonly mframe_t[] gladiator_frames_attack_melee = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Gladiator.gladiator_cleaver_swing), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Gladiator.GaldiatorMelee), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Gladiator.gladiator_cleaver_swing), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Gladiator.GaldiatorMelee), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t gladiator_move_attack_melee = new(
			M_Gladiator.FRAME_melee1,
			M_Gladiator.FRAME_melee17,
			M_Gladiator.gladiator_frames_attack_melee,
			M_Gladiator.gladiator_run
		);

		private static readonly EntThinkAdapter gladiator_melee = new(
			"gladiator_melee",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter GladiatorGun = new(
			"GladiatorGun",
			(edict_t self) =>
			{
				float[] start = {0, 0, 0};
		...
		private static readonly mframe_t[] gladiator_frames_attack_gun = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Gladiator.GladiatorGun), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t gladiator_move_attack_gun = new(
			M_Gladiator.FRAME_attack1,
			M_Gladiator.FRAME_attack9,
			M_Gladiator.gladiator_frames_attack_gun,
			M_Gladiator.gladiator_run
		);

		private static readonly EntThinkAdapter gladiator_attack = new(
			"gladiator_attack",
			(edict_t self) =>
			{
				float range;
		...
		private static readonly mframe_t[] gladiator_frames_pain = new mframe_t[]
		{
		...
		private static readonly mmove_t gladiator_move_pain = new(
			M_Gladiator.FRAME_pain1,
			M_Gladiator.FRAME_pain6,
			M_Gladiator.gladiator_frames_pain,
			M_Gladiator.gladiator_run
		);

		private static readonly mframe_t[] gladiator_frames_pain_air = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t gladiator_move_pain_air = new(
			M_Gladiator.FRAME_painup1,
			M_Gladiator.FRAME_painup7,
			M_Gladiator.gladiator_frames_pain_air,
			M_Gladiator.gladiator_run
		);

		private static readonly EntPainAdapter gladiator_pain = new(
			"gladiator_pain",
		...
		private static readonly EntThinkAdapter gladiator_dead = new(
			"gladiator_dead",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] gladiator_frames_death = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mmove_t gladiator_move_death = new(
			M_Gladiator.FRAME_death1,
			M_Gladiator.FRAME_death22,
			M_Gladiator.gladiator_frames_death,
			M_Gladiator.gladiator_dead
		);

		private static readonly EntDieAdapter gladiator_die = new(
			"gladiator_die",
