...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Berserk
	{
		...
		private static readonly EntInteractAdapter berserk_sight = new(
			"berserk_sight",
		...
		private static readonly EntThinkAdapter berserk_search = new(
			"berserk_search",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter berserk_fidget = new(
			"berserk_fidget",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] berserk_frames_stand = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, M_Berserk.berserk_fidget), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
		...
		private static readonly EntThinkAdapter berserk_stand = new(
			"berserk_stand",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] berserk_frames_stand_fidget = new mframe_t[]
		{
		...
		private static readonly mmove_t berserk_move_stand_fidget = new(
			M_Berserk.FRAME_standb1,
			M_Berserk.FRAME_standb20,
			M_Berserk.berserk_frames_stand_fidget,
			M_Berserk.berserk_stand
		);

		private static readonly mframe_t[] berserk_frames_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 9.1f, null), new(GameAI.ai_walk, 6.3f, null), new(GameAI.ai_walk, 4.9f, null), new(GameAI.ai_walk, 6.7f, null),
			new(GameAI.ai_walk, 6.0f, null), new(GameAI.ai_walk, 8.2f, null), new(GameAI.ai_walk, 7.2f, null), new(GameAI.ai_walk, 6.1f, null),
			new(GameAI.ai_walk, 4.9f, null), new(GameAI.ai_walk, 4.7f, null), new(GameAI.ai_walk, 4.7f, null), new(GameAI.ai_walk, 4.8f, null)
		};
		...
		private static readonly EntThinkAdapter berserk_walk = new(
			"berserk_walk",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] berserk_frames_run1 = new mframe_t[]
		{
			new(GameAI.ai_run, 21, null), new(GameAI.ai_run, 11, null), new(GameAI.ai_run, 21, null), new(GameAI.ai_run, 25, null),
			new(GameAI.ai_run, 18, null), new(GameAI.ai_run, 19, null)
		};
		...
		private static readonly EntThinkAdapter berserk_run = new(
			"berserk_run",
			(edict_t self) =>
			{
				if ((self.monsterinfo.aiflags & Defines.AI_STAND_GROUND) != 0)
		...
		private static readonly EntThinkAdapter berserk_attack_spike = new(
		...
		private static readonly EntThinkAdapter berserk_swing = new(
			"berserk_swing",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] berserk_frames_attack_spike = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Berserk.berserk_swing),
			new(GameAI.ai_charge, 0, M_Berserk.berserk_attack_spike), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t berserk_move_attack_spike = new(
			M_Berserk.FRAME_att_c1,
			M_Berserk.FRAME_att_c8,
			M_Berserk.berserk_frames_attack_spike,
			M_Berserk.berserk_run
		);

		private static readonly EntThinkAdapter berserk_attack_club = new(
			"berserk_attack_club",
			(edict_t self) =>
			{
				float[] aim = {0, 0, 0};
		...
		private static readonly mframe_t[] berserk_frames_attack_club = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Berserk.berserk_swing), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Berserk.berserk_attack_club), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t berserk_move_attack_club = new(
			M_Berserk.FRAME_att_c9,
			M_Berserk.FRAME_att_c20,
			M_Berserk.berserk_frames_attack_club,
			M_Berserk.berserk_run
		);

		private static readonly EntThinkAdapter berserk_strike = new(
			"berserk_strike",
			(edict_t self) =>
			{
				return true;
		...
		private static readonly mframe_t[] berserk_frames_attack_strike = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, M_Berserk.berserk_swing),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, M_Berserk.berserk_strike),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 9.7f, null), new(GameAI.ai_move, 13.6f, null)
		};

		private static mmove_t berserk_move_attack_strike = new(
			M_Berserk.FRAME_att_c21,
			M_Berserk.FRAME_att_c34,
			M_Berserk.berserk_frames_attack_strike,
			M_Berserk.berserk_run
		);

		private static readonly EntThinkAdapter berserk_melee = new(
			"berserk_melee",
			(edict_t self) =>
			{
				if ((Lib.rand() % 2) == 0)
		...
		private static readonly mframe_t[] berserk_frames_pain1 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t berserk_move_pain1 = new(
			M_Berserk.FRAME_painc1,
			M_Berserk.FRAME_painc4,
			M_Berserk.berserk_frames_pain1,
			M_Berserk.berserk_run
		);

		private static readonly mframe_t[] berserk_frames_pain2 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mmove_t berserk_move_pain2 = new(
			M_Berserk.FRAME_painb1,
			M_Berserk.FRAME_painb20,
			M_Berserk.berserk_frames_pain2,
			M_Berserk.berserk_run
		);

		private static readonly EntPainAdapter berserk_pain = new(
			"berserk_pain",
		...
		private static readonly EntThinkAdapter berserk_dead = new(
			"berserk_dead",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] berserk_frames_death1 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mmove_t berserk_move_death1 = new(
			M_Berserk.FRAME_death1,
			M_Berserk.FRAME_death13,
			M_Berserk.berserk_frames_death1,
			M_Berserk.berserk_dead
		);

		private static readonly mframe_t[] berserk_frames_death2 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t berserk_move_death2 = new(
			M_Berserk.FRAME_deathc1,
			M_Berserk.FRAME_deathc8,
			M_Berserk.berserk_frames_death2,
			M_Berserk.berserk_dead
		);

		private static readonly EntDieAdapter berserk_die = new(
			"berserk_die",
