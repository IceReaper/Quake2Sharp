...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Flipper
	{
		...
		private static readonly mframe_t[] flipper_frames_stand = new mframe_t[] {new(GameAI.ai_stand, 0, null)};
		...
		private static readonly EntThinkAdapter flipper_stand = new(
			"flipper_stand",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] flipper_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, M_Flipper.FLIPPER_RUN_SPEED, null), // 6
			new(GameAI.ai_run, M_Flipper.FLIPPER_RUN_SPEED, null), new(GameAI.ai_run, M_Flipper.FLIPPER_RUN_SPEED, null),
			new(GameAI.ai_run, M_Flipper.FLIPPER_RUN_SPEED, null), new(GameAI.ai_run, M_Flipper.FLIPPER_RUN_SPEED, null),
		...
		private static readonly EntThinkAdapter flipper_run_loop = new(
			"flipper_run_loop",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] flipper_frames_run_start = new mframe_t[]
		{
		...
		private static readonly mmove_t flipper_move_run_start = new(
			M_Flipper.FRAME_flpver01,
			M_Flipper.FRAME_flpver06,
			M_Flipper.flipper_frames_run_start,
			M_Flipper.flipper_run_loop
		);

		private static readonly EntThinkAdapter flipper_run = new(
			"flipper_run",
			(edict_t self) =>
			{
		...
		/* Standard Swimming */
		private static readonly mframe_t[] flipper_frames_walk = new mframe_t[]
		{
		...
		private static readonly EntThinkAdapter flipper_walk = new(
			"flipper_walk",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] flipper_frames_start_run = new mframe_t[]
		{
			new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null),
			new(GameAI.ai_run, 8, M_Flipper.flipper_run)
		};

		private static readonly mmove_t flipper_move_start_run = new(
			M_Flipper.FRAME_flphor01,
			M_Flipper.FRAME_flphor05,
			M_Flipper.flipper_frames_start_run,
			null
		);

		private static readonly EntThinkAdapter flipper_start_run = new(
			"flipper_start_run",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] flipper_frames_pain2 = new mframe_t[]
		{
		...
		private static readonly mmove_t flipper_move_pain2 = new(
			M_Flipper.FRAME_flppn101,
			M_Flipper.FRAME_flppn105,
			M_Flipper.flipper_frames_pain2,
			M_Flipper.flipper_run
		);

		private static readonly mframe_t[] flipper_frames_pain1 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t flipper_move_pain1 = new(
			M_Flipper.FRAME_flppn201,
			M_Flipper.FRAME_flppn205,
			M_Flipper.flipper_frames_pain1,
			M_Flipper.flipper_run
		);

		private static readonly EntThinkAdapter flipper_bite = new(
			"flipper_bite",
			(edict_t self) =>
			{
				float[] aim = {0, 0, 0};
		...
		private static readonly EntThinkAdapter flipper_preattack = new(
			"flipper_preattack",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] flipper_frames_attack = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, M_Flipper.flipper_preattack), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Flipper.flipper_bite),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Flipper.flipper_bite), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t flipper_move_attack = new(
			M_Flipper.FRAME_flpbit01,
			M_Flipper.FRAME_flpbit20,
			M_Flipper.flipper_frames_attack,
			M_Flipper.flipper_run
		);

		private static readonly EntThinkAdapter flipper_melee = new(
			"flipper_melee",
			(edict_t self) =>
			{
		...
		private static readonly EntPainAdapter flipper_pain = new(
			"flipper_pain",
		...
		private static readonly EntThinkAdapter flipper_dead = new(
			"flipper_dead",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] flipper_frames_death = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mmove_t flipper_move_death = new(
			M_Flipper.FRAME_flpdth01,
			M_Flipper.FRAME_flpdth56,
			M_Flipper.flipper_frames_death,
			M_Flipper.flipper_dead
		);

		private static readonly EntInteractAdapter flipper_sight = new(
			"flipper_sight",
		...
		private static readonly EntDieAdapter flipper_die = new(
			"flipper_die",
