...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Hover
	{
		...
		private static readonly EntThinkAdapter hover_reattack = new(
			"hover_reattack",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter hover_fire_blaster = new(
			"hover_fire_blaster",
			(edict_t self) =>
			{
				float[] start = {0, 0, 0};
		...
		private static readonly EntThinkAdapter hover_stand = new(
			"hover_stand",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter hover_run = new(
			"hover_run",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter hover_walk = new(
			"hover_walk",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter hover_start_attack = new(
			"hover_start_attack",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter hover_attack = new(
			"hover_attack",
			(edict_t self) =>
			{
				self.monsterinfo.currentmove = M_Hover.hover_move_attack1;
		...
		private static readonly EntPainAdapter hover_pain = new(
			"hover_pain",
		...
		private static readonly EntThinkAdapter hover_deadthink = new(
			"hover_deadthink",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter hover_dead = new(
			"hover_dead",
			(edict_t self) =>
			{
		...
		private static readonly EntDieAdapter hover_die = new(
			"hover_die",
		...
		private static readonly EntInteractAdapter hover_sight = new(
			"hover_sight",
		...
		private static readonly EntThinkAdapter hover_search = new(
			"hover_search",
			(edict_t self) =>
			{
				if (Lib.random() < 0.5)
		...
		private static readonly mframe_t[] hover_frames_stand = new mframe_t[]
		{
		...
		private static readonly mframe_t[] hover_frames_stop1 = new mframe_t[]
		{
		...
		private static readonly mframe_t[] hover_frames_stop2 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};
		...
		private static readonly mframe_t[] hover_frames_takeoff = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -2, null), new(GameAI.ai_move, 5, null), new(GameAI.ai_move, -1, null),
			new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -1, null),
			new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 2, null),
			new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, -6, null),
			new(GameAI.ai_move, -9, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 2, null),
			new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 1, null),
			new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 3, null),
		...
		private static readonly mframe_t[] hover_frames_pain3 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null)
		...
		private static readonly mframe_t[] hover_frames_pain2 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		...
		private static readonly mframe_t[] hover_frames_pain1 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 2, null), new(GameAI.ai_move, -8, null),
			new(GameAI.ai_move, -4, null), new(GameAI.ai_move, -6, null), new(GameAI.ai_move, -4, null), new(GameAI.ai_move, -3, null),
			new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 2, null),
			new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 7, null), new(GameAI.ai_move, 1, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 5, null), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 4, null)
		};
		...
		private static readonly mframe_t[] hover_frames_land = new mframe_t[] {new(GameAI.ai_move, 0, null)};

		private static mmove_t hover_move_land = new(M_Hover.FRAME_land01, M_Hover.FRAME_land01, M_Hover.hover_frames_land, null);

		private static readonly mframe_t[] hover_frames_forward = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mframe_t[] hover_frames_walk = new mframe_t[]
		{
			...
			new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 4, null),
			new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 4, null),
			new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 4, null)
		};
		...
		private static readonly mframe_t[] hover_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null),
			new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null),
			new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null),
			new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null),
			new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null),
			...
			new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null),
			new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null),
			new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 10, null)
		};
		...
		private static readonly mframe_t[] hover_frames_death1 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -10, null), new(GameAI.ai_move, 3, null),
			new(GameAI.ai_move, 5, null), new(GameAI.ai_move, 4, null), new(GameAI.ai_move, 7, null)
		};

		private static readonly mmove_t hover_move_death1 = new(
			M_Hover.FRAME_death101,
			M_Hover.FRAME_death111,
			M_Hover.hover_frames_death1,
			M_Hover.hover_dead
		);

		private static readonly mframe_t[] hover_frames_backward = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mframe_t[] hover_frames_start_attack = new mframe_t[]
		{
			new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null)
		};

		private static readonly mmove_t hover_move_start_attack = new(
			M_Hover.FRAME_attak101,
			M_Hover.FRAME_attak103,
			M_Hover.hover_frames_start_attack,
			M_Hover.hover_attack
		);

		private static readonly mframe_t[] hover_frames_attack1 = new mframe_t[]
		{
			new(GameAI.ai_charge, -10, M_Hover.hover_fire_blaster), new(GameAI.ai_charge, -10, M_Hover.hover_fire_blaster),
		...
		private static readonly mframe_t[] hover_frames_end_attack = new mframe_t[] {new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 1, null)};

		private static readonly mmove_t hover_move_end_attack = new(
			M_Hover.FRAME_attak107,
			M_Hover.FRAME_attak108,
			M_Hover.hover_frames_end_attack,
			M_Hover.hover_run
		);
