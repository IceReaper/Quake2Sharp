...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Actor
	{
		...
		private static readonly EntThinkAdapter actor_stand = new(
			"actor_stand",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] actor_frames_stand = new mframe_t[]
		{
			new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null),
			new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null),
			new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null),
			new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null),
			new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null), new(GameAI.ai_stand, 0f, null),
		...
		{
			new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 6, null), new(GameAI.ai_walk, 10, null), new(GameAI.ai_walk, 3, null),
			new(GameAI.ai_walk, 2, null), new(GameAI.ai_walk, 7, null), new(GameAI.ai_walk, 10, null), new(GameAI.ai_walk, 1, null),
			new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 0, null)
		};
		...
		private static readonly EntThinkAdapter actor_walk = new(
			"actor_walk",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] actor_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 4, null), new(GameAI.ai_run, 15, null), new(GameAI.ai_run, 15, null), new(GameAI.ai_run, 8, null),
			new(GameAI.ai_run, 20, null), new(GameAI.ai_run, 15, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 17, null),
			new(GameAI.ai_run, 12, null), new(GameAI.ai_run, -2, null), new(GameAI.ai_run, -2, null), new(GameAI.ai_run, -1, null)
		};

		private static readonly mmove_t actor_move_run = new(M_Actor.FRAME_run02, M_Actor.FRAME_run07, M_Actor.actor_frames_run, null);

		private static readonly EntThinkAdapter actor_run = new(
			"actor_run",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] actor_frames_pain1 = new mframe_t[]
		{
			new(GameAI.ai_move, -5, null), new(GameAI.ai_move, 4, null), new(GameAI.ai_move, 1, null)
		};
		...
		private static readonly mframe_t[] actor_frames_pain2 = new mframe_t[]
		{
			new(GameAI.ai_move, -4, null), new(GameAI.ai_move, 4, null), new(GameAI.ai_move, 0, null)
		};
		...
		private static readonly mframe_t[] actor_frames_pain3 = new mframe_t[]
		{
			new(GameAI.ai_move, -1, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 0, null)
		};
		...
		private static readonly mframe_t[] actor_frames_flipoff = new mframe_t[]
		{
			new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null),
			new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null),
			new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null),
			new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null)
		};
		...
		private static readonly mframe_t[] actor_frames_taunt = new mframe_t[]
		{
			new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null),
			new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null),
			new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null), new(GameAI.ai_turn, 0, null),
		...
		private static readonly EntPainAdapter actor_pain = new(
			"actor_pain",
		...
		private static readonly EntThinkAdapter actor_dead = new(
			"actor_dead",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] actor_frames_death1 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -13, null), new(GameAI.ai_move, 14, null),
			new(GameAI.ai_move, 3, null), new(GameAI.ai_move, -2, null), new(GameAI.ai_move, 1, null)
		};

		private static readonly mmove_t actor_move_death1 = new(
			M_Actor.FRAME_death101,
			M_Actor.FRAME_death107,
			M_Actor.actor_frames_death1,
			M_Actor.actor_dead
		);

		private static readonly mframe_t[] actor_frames_death2 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 7, null), new(GameAI.ai_move, -6, null), new(GameAI.ai_move, -5, null),
			new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -2, null),
			new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -9, null), new(GameAI.ai_move, -13, null), new(GameAI.ai_move, -13, null),
			new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t actor_move_death2 = new(
			M_Actor.FRAME_death201,
			M_Actor.FRAME_death213,
			M_Actor.actor_frames_death2,
			M_Actor.actor_dead
		);

		private static readonly EntDieAdapter actor_die = new(
			"actor_die",
		...
		private static readonly EntThinkAdapter actor_fire = new(
			"actor_fire",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] actor_frames_attack = new mframe_t[]
		{
		...
		private static readonly EntThinkAdapter actor_attack = new(
			"actor_attack",
			(edict_t self) =>
			{
				int n;
		...
		private static readonly EntUseAdapter actor_use = new(
			"actor_use",
		...
		private static readonly EntTouchAdapter target_actor_touch = new(
			"target_actor_touch",
