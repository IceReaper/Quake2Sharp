...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Mutant
	{
		...
		//	SOUNDS
		//
		private static readonly EntThinkAdapter mutant_step = new(
			"mutant_step",
			(edict_t self) =>
			{
				int n;
		...
		private static readonly EntInteractAdapter mutant_sight = new(
			"mutant_sight",
		...
		private static readonly EntThinkAdapter mutant_search = new(
			"mutant_search",
			(edict_t self) =>
			{
		...
		private static EntThinkAdapter mutant_swing = new(
			"mutant_swing",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] mutant_frames_stand = new mframe_t[]
		{
		...
		private static readonly EntThinkAdapter mutant_stand = new(
			"mutant_stand",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter mutant_idle_loop = new(
			"mutant_idle_loop",
			(edict_t self) =>
			{
				if (Lib.random() < 0.75)
		...
		private static readonly mframe_t[] mutant_frames_idle = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),

			// scratch loop start
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, M_Mutant.mutant_idle_loop),
		...
		private static readonly mmove_t mutant_move_idle = new(
			M_Mutant.FRAME_stand152,
			M_Mutant.FRAME_stand164,
			M_Mutant.mutant_frames_idle,
			M_Mutant.mutant_stand
		);

		private static readonly EntThinkAdapter mutant_idle = new(
			"mutant_idle",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] mutant_frames_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 3, null), new(GameAI.ai_walk, 1, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 10, null),
			new(GameAI.ai_walk, 13, null), new(GameAI.ai_walk, 10, null), new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 5, null),
			new(GameAI.ai_walk, 6, null), new(GameAI.ai_walk, 16, null), new(GameAI.ai_walk, 15, null), new(GameAI.ai_walk, 6, null)
		};
		...
		private static readonly EntThinkAdapter mutant_walk_loop = new(
			"mutant_walk_loop",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] mutant_frames_start_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, -2, null), new(GameAI.ai_walk, 1, null)
		};

		private static readonly mmove_t mutant_move_start_walk = new(
			M_Mutant.FRAME_walk01,
			M_Mutant.FRAME_walk04,
			M_Mutant.mutant_frames_start_walk,
			M_Mutant.mutant_walk_loop
		);

		private static readonly EntThinkAdapter mutant_walk = new(
			"mutant_walk",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] mutant_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 40, null), new(GameAI.ai_run, 40, M_Mutant.mutant_step), new(GameAI.ai_run, 24, null),
			new(GameAI.ai_run, 5, M_Mutant.mutant_step), new(GameAI.ai_run, 17, null), new(GameAI.ai_run, 10, null)
		};
		...
		private static readonly EntThinkAdapter mutant_run = new(
			"mutant_run",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter mutant_hit_left = new(
			"mutant_hit_left",
			(edict_t self) =>
			{
				float[] aim = {0, 0, 0};
		...
		private static readonly EntThinkAdapter mutant_hit_right = new(
			"mutant_hit_right",
			(edict_t self) =>
			{
				float[] aim = {0, 0, 0};
		...
		private static readonly EntThinkAdapter mutant_check_refire = new(
			"mutant_check_refire",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] mutant_frames_attack = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Mutant.mutant_hit_left),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Mutant.mutant_hit_right),
			new(GameAI.ai_charge, 0, M_Mutant.mutant_check_refire)
		};

		private static readonly mmove_t mutant_move_attack = new(
			M_Mutant.FRAME_attack09,
			M_Mutant.FRAME_attack15,
			M_Mutant.mutant_frames_attack,
			M_Mutant.mutant_run
		);

		private static readonly EntThinkAdapter mutant_melee = new(
			"mutant_melee",
			(edict_t self) =>
			{
		...
		private static readonly EntTouchAdapter mutant_jump_touch = new(
			"mutant_jump_touch",
		...
		private static readonly EntThinkAdapter mutant_jump_takeoff = new(
			"mutant_jump_takeoff",
			(edict_t self) =>
			{
				float[] forward = {0, 0, 0};
		...
		private static readonly EntThinkAdapter mutant_check_landing = new(
		...
		private static readonly mframe_t[] mutant_frames_jump = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 17, null), new(GameAI.ai_charge, 15, M_Mutant.mutant_jump_takeoff),
			new(GameAI.ai_charge, 15, null), new(GameAI.ai_charge, 15, M_Mutant.mutant_check_landing), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 3, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t mutant_move_jump = new(
			M_Mutant.FRAME_attack01,
			M_Mutant.FRAME_attack08,
			M_Mutant.mutant_frames_jump,
			M_Mutant.mutant_run
		);

		private static readonly EntThinkAdapter mutant_jump = new(
			"mutant_jump",
			(edict_t self) =>
			{
		...
		//	CHECKATTACK
		//
		private static readonly EntThinkAdapter mutant_check_melee = new(
			"mutant_check_melee",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter mutant_check_jump = new(
			"mutant_check_jump",
			(edict_t self) =>
			{
				float[] v = {0, 0, 0};
		...
		private static readonly EntThinkAdapter mutant_checkattack = new(
			"mutant_checkattack",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] mutant_frames_pain1 = new mframe_t[]
		{
			new(GameAI.ai_move, 4, null), new(GameAI.ai_move, -3, null), new(GameAI.ai_move, -8, null), new(GameAI.ai_move, 2, null),
			new(GameAI.ai_move, 5, null)
		};

		private static readonly mmove_t mutant_move_pain1 = new(
			M_Mutant.FRAME_pain101,
			M_Mutant.FRAME_pain105,
			M_Mutant.mutant_frames_pain1,
			M_Mutant.mutant_run
		);

		private static readonly mframe_t[] mutant_frames_pain2 = new mframe_t[]
		{
			new(GameAI.ai_move, -24, null), new(GameAI.ai_move, 11, null), new(GameAI.ai_move, 5, null), new(GameAI.ai_move, -2, null),
			new(GameAI.ai_move, 6, null), new(GameAI.ai_move, 4, null)
		};

		private static readonly mmove_t mutant_move_pain2 = new(
			M_Mutant.FRAME_pain201,
			M_Mutant.FRAME_pain206,
			M_Mutant.mutant_frames_pain2,
			M_Mutant.mutant_run
		);

		private static readonly mframe_t[] mutant_frames_pain3 = new mframe_t[]
		{
			new(GameAI.ai_move, -22, null), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 2, null),
			new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 6, null), new(GameAI.ai_move, 3, null),
			new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 1, null)
		};

		private static readonly mmove_t mutant_move_pain3 = new(
			M_Mutant.FRAME_pain301,
			M_Mutant.FRAME_pain311,
			M_Mutant.mutant_frames_pain3,
			M_Mutant.mutant_run
		);

		private static readonly EntPainAdapter mutant_pain = new(
			"mutant_pain",
		...
		//	DEATH
		//
		private static readonly EntThinkAdapter mutant_dead = new(
			"mutant_dead",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] mutant_frames_death1 = new mframe_t[]
		{
		...
		private static readonly mmove_t mutant_move_death1 = new(
			M_Mutant.FRAME_death101,
			M_Mutant.FRAME_death109,
			M_Mutant.mutant_frames_death1,
			M_Mutant.mutant_dead
		);

		private static readonly mframe_t[] mutant_frames_death2 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mmove_t mutant_move_death2 = new(
			M_Mutant.FRAME_death201,
			M_Mutant.FRAME_death210,
			M_Mutant.mutant_frames_death2,
			M_Mutant.mutant_dead
		);

		private static readonly EntDieAdapter mutant_die = new(
			"mutant_die",
		 ...
		 * Trigger_Spawn Sight
		 */
		public static EntThinkAdapter SP_monster_mutant = new(
			"SP_monster_mutant",
			(edict_t self) =>
			{
