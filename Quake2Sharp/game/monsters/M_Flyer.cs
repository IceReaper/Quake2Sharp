...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Flyer
	{
		...
		public static EntInteractAdapter flyer_sight = new(
			"flyer_sight",
		...
		private static readonly EntThinkAdapter flyer_idle = new(
			"flyer_idle",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter flyer_pop_blades = new(
			"flyer_pop_blades",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] flyer_frames_stand = new mframe_t[]
		{
		...
		private static readonly mframe_t[] flyer_frames_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null),
			new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null),
			new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null),
			new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null),
			new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 5, null),
		...
		private static readonly mframe_t[] flyer_frames_run = new mframe_t[]
		{
		...
		private static readonly EntThinkAdapter flyer_run = new(
			"flyer_run",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter flyer_walk = new(
			"flyer_walk",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter flyer_stand = new(
			"flyer_stand",
			(edict_t self) =>
			{
				self.monsterinfo.currentmove = M_Flyer.flyer_move_stand;
		...
		private static readonly EntThinkAdapter flyer_nextmove = new(
			"flyer_nextmove",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] flyer_frames_start = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, M_Flyer.flyer_nextmove)
		};
		...
		private static readonly mframe_t[] flyer_frames_stop = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, M_Flyer.flyer_nextmove)
		};
		...
		private static EntThinkAdapter flyer_stop = new(
			"flyer_stop",
			(edict_t self) =>
			{
		...
		private static EntThinkAdapter flyer_start = new(
			"flyer_start",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] flyer_frames_rollright = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mframe_t[] flyer_frames_rollleft = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null)
		...
		private static readonly mframe_t[] flyer_frames_pain3 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};
		...
		private static readonly mframe_t[] flyer_frames_pain2 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};
		...
		private static readonly mframe_t[] flyer_frames_pain1 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null)
		...
		private static readonly mframe_t[] flyer_frames_defense = new mframe_t[]
		{
		...
		private static readonly mframe_t[] flyer_frames_bankright = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};
		...
		private static readonly mframe_t[] flyer_frames_bankleft = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};
		...
		private static readonly EntThinkAdapter flyer_fireleft = new(
			"flyer_fireleft",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter flyer_fireright = new(
			"flyer_fireright",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] flyer_frames_attack2 = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, -10, M_Flyer.flyer_fireleft),
		...
		private static readonly mmove_t flyer_move_attack2 = new(
			M_Flyer.FRAME_attak201,
			M_Flyer.FRAME_attak217,
			M_Flyer.flyer_frames_attack2,
			M_Flyer.flyer_run
		);

		private static readonly EntThinkAdapter flyer_slash_left = new(
			"flyer_slash_left",
			(edict_t self) =>
			{
				float[] aim = {0, 0, 0};
		...
		private static readonly EntThinkAdapter flyer_slash_right = new(
			"flyer_slash_right",
			(edict_t self) =>
			{
				float[] aim = {0, 0, 0};
		...
		private static readonly EntThinkAdapter flyer_loop_melee = new(
			"flyer_loop_melee",
			(edict_t self) =>
			{
				/*
		...
		private static readonly mframe_t[] flyer_frames_start_melee = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, M_Flyer.flyer_pop_blades), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t flyer_move_start_melee = new(
			M_Flyer.FRAME_attak101,
			M_Flyer.FRAME_attak106,
			M_Flyer.flyer_frames_start_melee,
			M_Flyer.flyer_loop_melee
		);

		private static readonly mframe_t[] flyer_frames_end_melee = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t flyer_move_end_melee = new(
			M_Flyer.FRAME_attak119,
			M_Flyer.FRAME_attak121,
			M_Flyer.flyer_frames_end_melee,
			M_Flyer.flyer_run
		);

		private static readonly mframe_t[] flyer_frames_loop_melee = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), // Loop Start
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Flyer.flyer_slash_left),
			...
			// Right Wing Strike
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null) // Loop Ends
		};

		private static readonly EntThinkAdapter flyer_check_melee = new(
			"flyer_check_melee",
			(edict_t self) =>
			{
		...
		private static readonly mmove_t flyer_move_loop_melee = new(
			M_Flyer.FRAME_attak107,
			M_Flyer.FRAME_attak118,
			M_Flyer.flyer_frames_loop_melee,
			M_Flyer.flyer_check_melee
		);

		private static readonly EntThinkAdapter flyer_attack = new(
			"flyer_attack",
			(edict_t self) =>
			{
				/*
		...
		private static EntThinkAdapter flyer_setstart = new(
			"flyer_setstart",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter flyer_melee = new(
			"flyer_melee",
			(edict_t self) =>
			{
		...
		private static readonly EntPainAdapter flyer_pain = new(
			"flyer_pain",
		...
		private static readonly EntDieAdapter flyer_die = new(
			"flyer_die",
