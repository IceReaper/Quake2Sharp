...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Infantry
	{
		...
		private static readonly mframe_t[] infantry_frames_stand = new mframe_t[]
		{
		...
		public static EntThinkAdapter infantry_stand = new(
			"infantry_stand",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] infantry_frames_fidget = new mframe_t[]
		{
			new(GameAI.ai_stand, 1, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 1, null), new(GameAI.ai_stand, 3, null),
			new(GameAI.ai_stand, 6, null), new(GameAI.ai_stand, 3, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 1, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 1, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, -1, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 1, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, -2, null), new(GameAI.ai_stand, 1, null),
			new(GameAI.ai_stand, 1, null), new(GameAI.ai_stand, 1, null), new(GameAI.ai_stand, -1, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, -1, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, -1, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 1, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, -1, null), new(GameAI.ai_stand, -1, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, -3, null), new(GameAI.ai_stand, -2, null), new(GameAI.ai_stand, -3, null), new(GameAI.ai_stand, -3, null),
			new(GameAI.ai_stand, -2, null)
		};

		private static readonly mmove_t infantry_move_fidget = new(
			M_Infantry.FRAME_stand01,
			M_Infantry.FRAME_stand49,
			M_Infantry.infantry_frames_fidget,
			M_Infantry.infantry_stand
		);

		private static readonly EntThinkAdapter infantry_fidget = new(
			"infantry_fidget",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] infantry_frames_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 5, null),
			new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 6, null), new(GameAI.ai_walk, 4, null),
			new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 5, null)
		};
		...
		private static readonly EntThinkAdapter infantry_walk = new(
			"infantry_walk",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] infantry_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 20, null), new(GameAI.ai_run, 5, null), new(GameAI.ai_run, 7, null),
			new(GameAI.ai_run, 30, null), new(GameAI.ai_run, 35, null), new(GameAI.ai_run, 2, null), new(GameAI.ai_run, 6, null)
		};
		...
		private static readonly EntThinkAdapter infantry_run = new(
			"infantry_run",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] infantry_frames_pain1 = new mframe_t[]
		{
			new(GameAI.ai_move, -3, null), new(GameAI.ai_move, -2, null), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -2, null),
			new(GameAI.ai_move, -1, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, 1, null),
			new(GameAI.ai_move, 6, null), new(GameAI.ai_move, 2, null)
		};

		private static readonly mmove_t infantry_move_pain1 = new(
			M_Infantry.FRAME_pain101,
			M_Infantry.FRAME_pain110,
			M_Infantry.infantry_frames_pain1,
			M_Infantry.infantry_run
		);

		private static readonly mframe_t[] infantry_frames_pain2 = new mframe_t[]
		{
			new(GameAI.ai_move, -3, null), new(GameAI.ai_move, -3, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -1, null),
			new(GameAI.ai_move, -2, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 2, null),
			new(GameAI.ai_move, 5, null), new(GameAI.ai_move, 2, null)
		};

		private static readonly mmove_t infantry_move_pain2 = new(
			M_Infantry.FRAME_pain201,
			M_Infantry.FRAME_pain210,
			M_Infantry.infantry_frames_pain2,
			M_Infantry.infantry_run
		);

		private static readonly EntPainAdapter infantry_pain = new(
			"infantry_pain",
		...
		{
			new[] {0.0f, 5.0f, 0.0f}, new[] {10.0f, 15.0f, 0.0f}, new[] {20.0f, 25.0f, 0.0f}, new[] {25.0f, 35.0f, 0.0f}, new[] {30.0f, 40.0f, 0.0f},
			new[] {30.0f, 45.0f, 0.0f}, new[] {25.0f, 50.0f, 0.0f}, new[] {20.0f, 40.0f, 0.0f}, new[] {15.0f, 35.0f, 0.0f}, new[] {40.0f, 35.0f, 0.0f},
			new[] {70.0f, 35.0f, 0.0f}, new[] {90.0f, 35.0f, 0.0f}
		};

		private static readonly EntThinkAdapter InfantryMachineGun = new(
			"InfantryMachineGun",
			(edict_t self) =>
			{
		...
		private static readonly EntInteractAdapter infantry_sight = new(
			"infantry_sight",
		...
		///
		private static readonly EntThinkAdapter infantry_dead = new(
			"infantry_dead",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] infantry_frames_death1 = new mframe_t[]
		{
			new(GameAI.ai_move, -4, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -1, null),
			new(GameAI.ai_move, -4, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, -1, null), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 1, null),
			new(GameAI.ai_move, -2, null), new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 9, null),
			new(GameAI.ai_move, 9, null), new(GameAI.ai_move, 5, null), new(GameAI.ai_move, -3, null), new(GameAI.ai_move, -3, null)
		};

		private static readonly mmove_t infantry_move_death1 = new(
			M_Infantry.FRAME_death101,
			M_Infantry.FRAME_death120,
			M_Infantry.infantry_frames_death1,
			M_Infantry.infantry_dead
		);

		//	Off with his head
		private static readonly mframe_t[] infantry_frames_death2 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 5, null), new(GameAI.ai_move, -1, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 4, null),
			new(GameAI.ai_move, 3, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -2, M_Infantry.InfantryMachineGun),
			new(GameAI.ai_move, -2, M_Infantry.InfantryMachineGun), new(GameAI.ai_move, -3, M_Infantry.InfantryMachineGun),
			new(GameAI.ai_move, -1, M_Infantry.InfantryMachineGun), new(GameAI.ai_move, -2, M_Infantry.InfantryMachineGun),
			new(GameAI.ai_move, 0, M_Infantry.InfantryMachineGun), new(GameAI.ai_move, 2, M_Infantry.InfantryMachineGun),
			new(GameAI.ai_move, 2, M_Infantry.InfantryMachineGun), new(GameAI.ai_move, 3, M_Infantry.InfantryMachineGun),
			new(GameAI.ai_move, -10, M_Infantry.InfantryMachineGun), new(GameAI.ai_move, -7, M_Infantry.InfantryMachineGun),
			new(GameAI.ai_move, -8, M_Infantry.InfantryMachineGun), new(GameAI.ai_move, -6, null), new(GameAI.ai_move, 4, null),
			new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t infantry_move_death2 = new(
			M_Infantry.FRAME_death201,
			M_Infantry.FRAME_death225,
			M_Infantry.infantry_frames_death2,
			M_Infantry.infantry_dead
		);

		private static readonly mframe_t[] infantry_frames_death3 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -6, null),
			new(GameAI.ai_move, -11, null), new(GameAI.ai_move, -3, null), new(GameAI.ai_move, -11, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t infantry_move_death3 = new(
			M_Infantry.FRAME_death301,
			M_Infantry.FRAME_death309,
			M_Infantry.infantry_frames_death3,
			M_Infantry.infantry_dead
		);

		public static EntDieAdapter infantry_die = new(
			"infantry_die",
		...
		private static readonly EntThinkAdapter infantry_duck_down = new(
			"infantry_duck_down",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter infantry_duck_hold = new(
			"infantry_duck_hold",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter infantry_duck_up = new(
			"infantry_duck_up",
			(edict_t self) =>
			{
				self.monsterinfo.aiflags &= ~Defines.AI_DUCKED;
		...
		private static readonly mframe_t[] infantry_frames_duck = new mframe_t[]
		{
			new(GameAI.ai_move, -2, M_Infantry.infantry_duck_down), new(GameAI.ai_move, -5, M_Infantry.infantry_duck_hold), new(GameAI.ai_move, 3, null),
			new(GameAI.ai_move, 4, M_Infantry.infantry_duck_up), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t infantry_move_duck = new(
			M_Infantry.FRAME_duck01,
			M_Infantry.FRAME_duck05,
			M_Infantry.infantry_frames_duck,
			M_Infantry.infantry_run
		);

		private static readonly EntDodgeAdapter infantry_dodge = new(
			"infantry_dodge",
		...
		private static readonly EntThinkAdapter infantry_cock_gun = new(
			"infantry_cock_gun",
			(edict_t self) =>
			{
				int n;
		...
		private static readonly EntThinkAdapter infantry_fire = new(
			"infantry_fire",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] infantry_frames_attack1 = new mframe_t[]
		{
			new(GameAI.ai_charge, 4, null), new(GameAI.ai_charge, -1, null), new(GameAI.ai_charge, -1, null),
			new(GameAI.ai_charge, 0, M_Infantry.infantry_cock_gun), new(GameAI.ai_charge, -1, null), new(GameAI.ai_charge, 1, null),
			new(GameAI.ai_charge, 1, null), new(GameAI.ai_charge, 2, null), new(GameAI.ai_charge, -2, null), new(GameAI.ai_charge, -3, null),
			new(GameAI.ai_charge, 1, M_Infantry.infantry_fire), new(GameAI.ai_charge, 5, null), new(GameAI.ai_charge, -1, null),
			new(GameAI.ai_charge, -2, null), new(GameAI.ai_charge, -3, null)
		};

		private static readonly mmove_t infantry_move_attack1 = new(
			M_Infantry.FRAME_attak101,
			M_Infantry.FRAME_attak115,
			M_Infantry.infantry_frames_attack1,
			M_Infantry.infantry_run
		);

		private static readonly EntThinkAdapter infantry_swing = new(
			"infantry_swing",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter infantry_smack = new(
			"infantry_smack",
			(edict_t self) =>
			{
				float[] aim = {0, 0, 0};
		...
		private static readonly mframe_t[] infantry_frames_attack2 = new mframe_t[]
		{
			new(GameAI.ai_charge, 3, null), new(GameAI.ai_charge, 6, null), new(GameAI.ai_charge, 0, M_Infantry.infantry_swing),
			new(GameAI.ai_charge, 8, null), new(GameAI.ai_charge, 5, null), new(GameAI.ai_charge, 8, M_Infantry.infantry_smack),
			new(GameAI.ai_charge, 6, null), new(GameAI.ai_charge, 3, null),
		};

		private static readonly mmove_t infantry_move_attack2 = new(
			M_Infantry.FRAME_attak201,
			M_Infantry.FRAME_attak208,
			M_Infantry.infantry_frames_attack2,
			M_Infantry.infantry_run
		);

		private static readonly EntThinkAdapter infantry_attack = new(
			"infantry_attack",
			(edict_t self) =>
			{
