...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Boss32
	{
		...
		private static readonly EntThinkAdapter makron_taunt = new(
			"makron_taunt",
			(edict_t self) =>
			{
				float r;
		...
		//	   stand
		//
		private static readonly EntThinkAdapter makron_stand = new(
			"makron_stand",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter makron_hit = new(
			"makron_hit",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter makron_popup = new(
			"makron_popup",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter makron_step_left = new(
			"makron_step_left",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter makron_step_right = new(
			"makron_step_right",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter makron_brainsplorch = new(
			"makron_brainsplorch",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter makron_prerailgun = new(
			"makron_prerailgun",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] makron_frames_stand = new mframe_t[]
		{
			...
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null) // 60
		};
		...
		private static readonly mframe_t[] makron_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 3, M_Boss32.makron_step_left), new(GameAI.ai_run, 12, null), new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 8, null),
			new(GameAI.ai_run, 8, M_Boss32.makron_step_right), new(GameAI.ai_run, 6, null), new(GameAI.ai_run, 12, null), new(GameAI.ai_run, 9, null),
			new(GameAI.ai_run, 6, null), new(GameAI.ai_run, 12, null)
		};
		...
		private static mframe_t[] makron_frames_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 3, M_Boss32.makron_step_left), new(GameAI.ai_walk, 12, null), new(GameAI.ai_walk, 8, null), new(GameAI.ai_walk, 8, null),
			new(GameAI.ai_walk, 8, M_Boss32.makron_step_right), new(GameAI.ai_walk, 6, null), new(GameAI.ai_walk, 12, null), new(GameAI.ai_walk, 9, null),
			new(GameAI.ai_walk, 6, null), new(GameAI.ai_walk, 12, null)
		};
		...
		//	   death
		//
		private static readonly EntThinkAdapter makron_dead = new(
			"makron_dead",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter makron_walk = new(
			"makron_walk",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter makron_run = new(
			"makron_run",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] makron_frames_pain6 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),

			// 10
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, M_Boss32.makron_popup), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),

			// 20
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, M_Boss32.makron_taunt),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t makron_move_pain6 = new(
			M_Boss32.FRAME_pain601,
			M_Boss32.FRAME_pain627,
			M_Boss32.makron_frames_pain6,
			M_Boss32.makron_run
		);

		private static readonly mframe_t[] makron_frames_pain5 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t makron_move_pain5 = new(
			M_Boss32.FRAME_pain501,
			M_Boss32.FRAME_pain504,
			M_Boss32.makron_frames_pain5,
			M_Boss32.makron_run
		);

		private static readonly mframe_t[] makron_frames_pain4 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t makron_move_pain4 = new(
			M_Boss32.FRAME_pain401,
			M_Boss32.FRAME_pain404,
			M_Boss32.makron_frames_pain4,
			M_Boss32.makron_run
		);

		private static readonly mframe_t[] makron_frames_death2 = new mframe_t[]
		{
			new(GameAI.ai_move, -15, null), new(GameAI.ai_move, 3, null), new(GameAI.ai_move, -12, null), new(GameAI.ai_move, 0, M_Boss32.makron_step_left),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),

			// 10
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 11, null), new(GameAI.ai_move, 12, null), new(GameAI.ai_move, 11, M_Boss32.makron_step_right),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			...
			// 30
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 5, null),
			new(GameAI.ai_move, 7, null), new(GameAI.ai_move, 6, M_Boss32.makron_step_left), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, -1, null), new(GameAI.ai_move, 2, null),
			...
			// 50
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -6, null),
			new(GameAI.ai_move, -4, null), new(GameAI.ai_move, -6, M_Boss32.makron_step_right), new(GameAI.ai_move, -4, null),
			new(GameAI.ai_move, -4, M_Boss32.makron_step_left), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),

			// 60
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -2, null), new(GameAI.ai_move, -5, null),
			new(GameAI.ai_move, -3, M_Boss32.makron_step_right), new(GameAI.ai_move, -8, null), new(GameAI.ai_move, -3, M_Boss32.makron_step_left),
			new(GameAI.ai_move, -7, null), new(GameAI.ai_move, -4, null), new(GameAI.ai_move, -4, M_Boss32.makron_step_right),

			// 70
			new(GameAI.ai_move, -6, null), new(GameAI.ai_move, -7, null), new(GameAI.ai_move, 0, M_Boss32.makron_step_left), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),

			// 80
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -2, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 0, null),

			// 90
			new(GameAI.ai_move, 27, M_Boss32.makron_hit), new(GameAI.ai_move, 26, null), new(GameAI.ai_move, 0, M_Boss32.makron_brainsplorch),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null) // 95
		};

		private static readonly mmove_t makron_move_death2 = new(
			M_Boss32.FRAME_death201,
			M_Boss32.FRAME_death295,
			M_Boss32.makron_frames_death2,
			M_Boss32.makron_dead
		);

		private static readonly mframe_t[] makron_frames_death3 = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mframe_t[] makron_frames_sight = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
		...
		private static readonly mmove_t makron_move_sight = new(
			M_Boss32.FRAME_active01,
			M_Boss32.FRAME_active13,
			M_Boss32.makron_frames_sight,
			M_Boss32.makron_run
		);

		private static readonly EntThinkAdapter makronBFG = new(
			"makronBFG",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter MakronSaveloc = new(
			"MakronSaveloc",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter MakronRailgun = new(
			"MakronRailgun",
			(edict_t self) =>
			{
				float[] start = {0, 0, 0};
		...
		private static readonly EntThinkAdapter MakronHyperblaster = new(
			"MakronHyperblaster",
			(edict_t self) =>
			{
				float[] dir = {0, 0, 0};
		...
		private static readonly EntPainAdapter makron_pain = new(
			"makron_pain",
		...
		private static readonly EntInteractAdapter makron_sight = new(
			"makron_sight",
		...
		private static readonly EntThinkAdapter makron_attack = new(
			"makron_attack",
			(edict_t self) =>
			{
				float[] vec = {0, 0, 0};
		...
		private static readonly EntThinkAdapter makron_torso_think = new(
			"makron_torso_think",
			(edict_t self) =>
			{
				if (++self.s.frame < 365)
		...
		private static readonly EntThinkAdapter makron_torso = new(
			"makron_torso",
			(edict_t ent) =>
			{
		...
		private static readonly EntDieAdapter makron_die = new(
			"makron_die",
		...
		private static readonly EntThinkAdapter Makron_CheckAttack = new(
			"Makron_CheckAttack",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] makron_frames_attack3 = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, M_Boss32.makronBFG),

			// FIXME: BFG Attack here
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t makron_move_attack3 = new(
			M_Boss32.FRAME_attak301,
			M_Boss32.FRAME_attak308,
			M_Boss32.makron_frames_attack3,
			M_Boss32.makron_run
		);

		private static readonly mframe_t[] makron_frames_attack4 = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			...
			new(GameAI.ai_move, 0, M_Boss32.MakronHyperblaster), // fire
			new(GameAI.ai_move, 0, M_Boss32.MakronHyperblaster), // fire
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t makron_move_attack4 = new(
			M_Boss32.FRAME_attak401,
			M_Boss32.FRAME_attak426,
			M_Boss32.makron_frames_attack4,
			M_Boss32.makron_run
		);

		private static readonly mframe_t[] makron_frames_attack5 = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, M_Boss32.makron_prerailgun), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Boss32.MakronSaveloc), new(GameAI.ai_move, 0, M_Boss32.MakronRailgun),
		...
		private static readonly mmove_t makron_move_attack5 = new(
			M_Boss32.FRAME_attak501,
			M_Boss32.FRAME_attak516,
			M_Boss32.makron_frames_attack5,
			M_Boss32.makron_run
		);
		 ...
		 * =================
		 */
		private static readonly EntThinkAdapter MakronSpawn = new(
			"MakronSpawn",
			(edict_t self) =>
			{
				float[] vec = {0, 0, 0};
		...
		public static EntThinkAdapter MakronToss = new(
			"MakronToss",
			(edict_t self) =>
			{
				edict_t ent;
