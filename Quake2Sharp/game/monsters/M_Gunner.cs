...
namespace Quake2Sharp.game.monsters
{
	...
	public class M_Gunner
	{
		...
		private static readonly EntThinkAdapter gunner_idlesound = new(
			"gunner_idlesound",
			(edict_t self) =>
			{
		...
		private static readonly EntInteractAdapter gunner_sight = new(
			"gunner_sight",
		...
		private static readonly EntThinkAdapter gunner_search = new(
			"gunner_search",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] gunner_frames_fidget = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, M_Gunner.gunner_idlesound),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
		...
		private static readonly EntThinkAdapter gunner_stand = new(
			"gunner_stand",
			(edict_t self) =>
			{
		...
		private static readonly mmove_t gunner_move_fidget = new(
			M_Gunner.FRAME_stand31,
			M_Gunner.FRAME_stand70,
			M_Gunner.gunner_frames_fidget,
			M_Gunner.gunner_stand
		);

		private static readonly EntThinkAdapter gunner_fidget = new(
			"gunner_fidget",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] gunner_frames_stand = new mframe_t[]
		{
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, M_Gunner.gunner_fidget), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, M_Gunner.gunner_fidget),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, null),
			new(GameAI.ai_stand, 0, null), new(GameAI.ai_stand, 0, M_Gunner.gunner_fidget)
		};
		...
		private static readonly mframe_t[] gunner_frames_walk = new mframe_t[]
		{
			new(GameAI.ai_walk, 0, null), new(GameAI.ai_walk, 3, null), new(GameAI.ai_walk, 4, null), new(GameAI.ai_walk, 5, null),
			new(GameAI.ai_walk, 7, null), new(GameAI.ai_walk, 2, null), new(GameAI.ai_walk, 6, null), new(GameAI.ai_walk, 4, null),
			new(GameAI.ai_walk, 2, null), new(GameAI.ai_walk, 7, null), new(GameAI.ai_walk, 5, null), new(GameAI.ai_walk, 7, null),
		...
		private static readonly EntThinkAdapter gunner_walk = new(
			"gunner_walk",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] gunner_frames_run = new mframe_t[]
		{
			new(GameAI.ai_run, 26, null), new(GameAI.ai_run, 9, null), new(GameAI.ai_run, 9, null), new(GameAI.ai_run, 9, null),
			new(GameAI.ai_run, 15, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 13, null), new(GameAI.ai_run, 6, null)
		};
		...
		private static readonly EntThinkAdapter gunner_run = new(
			"gunner_run",
			(edict_t self) =>
			{
				if ((self.monsterinfo.aiflags & Defines.AI_STAND_GROUND) != 0)
		...
		private static readonly mframe_t[] gunner_frames_runandshoot = new mframe_t[]
		{
			new(GameAI.ai_run, 32, null), new(GameAI.ai_run, 15, null), new(GameAI.ai_run, 10, null), new(GameAI.ai_run, 18, null),
			new(GameAI.ai_run, 8, null), new(GameAI.ai_run, 20, null)
		};
		...
		private static EntThinkAdapter gunner_runandshoot = new(
			"gunner_runandshoot",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] gunner_frames_pain3 = new mframe_t[]
		{
			new(GameAI.ai_move, -3, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 1, null)
		};

		private static readonly mmove_t gunner_move_pain3 = new(
			M_Gunner.FRAME_pain301,
			M_Gunner.FRAME_pain305,
			M_Gunner.gunner_frames_pain3,
			M_Gunner.gunner_run
		);

		private static readonly mframe_t[] gunner_frames_pain2 = new mframe_t[]
		{
			new(GameAI.ai_move, -2, null), new(GameAI.ai_move, 11, null), new(GameAI.ai_move, 6, null), new(GameAI.ai_move, 2, null),
			new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -7, null), new(GameAI.ai_move, -2, null), new(GameAI.ai_move, -7, null)
		};

		private static readonly mmove_t gunner_move_pain2 = new(
			M_Gunner.FRAME_pain201,
			M_Gunner.FRAME_pain208,
			M_Gunner.gunner_frames_pain2,
			M_Gunner.gunner_run
		);

		private static readonly mframe_t[] gunner_frames_pain1 = new mframe_t[]
		{
			new(GameAI.ai_move, 2, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -5, null), new(GameAI.ai_move, 3, null),
			new(GameAI.ai_move, -1, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 2, null),
			new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -2, null), new(GameAI.ai_move, -2, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t gunner_move_pain1 = new(
			M_Gunner.FRAME_pain101,
			M_Gunner.FRAME_pain118,
			M_Gunner.gunner_frames_pain1,
			M_Gunner.gunner_run
		);

		private static readonly EntPainAdapter gunner_pain = new(
			"gunner_pain",
		...
		private static readonly EntThinkAdapter gunner_dead = new(
			"gunner_dead",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] gunner_frames_death = new mframe_t[]
		{
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -7, null),
			new(GameAI.ai_move, -3, null), new(GameAI.ai_move, -5, null), new(GameAI.ai_move, 8, null), new(GameAI.ai_move, 6, null),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null), new(GameAI.ai_move, 0, null)
		};

		private static readonly mmove_t gunner_move_death = new(
			M_Gunner.FRAME_death01,
			M_Gunner.FRAME_death11,
			M_Gunner.gunner_frames_death,
			M_Gunner.gunner_dead
		);

		private static readonly EntDieAdapter gunner_die = new(
			"gunner_die",
		...
		private static readonly EntThinkAdapter gunner_duck_down = new(
			"gunner_duck_down",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter gunner_duck_hold = new(
			"gunner_duck_hold",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter gunner_duck_up = new(
			"gunner_duck_up",
			(edict_t self) =>
			{
				self.monsterinfo.aiflags &= ~Defines.AI_DUCKED;
		...
		private static readonly mframe_t[] gunner_frames_duck = new mframe_t[]
		{
			new(GameAI.ai_move, 1, M_Gunner.gunner_duck_down), new(GameAI.ai_move, 1, null), new(GameAI.ai_move, 1, M_Gunner.gunner_duck_hold),
			new(GameAI.ai_move, 0, null), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, -1, null), new(GameAI.ai_move, 0, M_Gunner.gunner_duck_up),
			new(GameAI.ai_move, -1, null)
		};
		...
		private static readonly EntDodgeAdapter gunner_dodge = new(
			"gunner_dodge",
		...
		private static readonly EntThinkAdapter gunner_opengun = new(
			"gunner_opengun",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter GunnerFire = new(
			"GunnerFire",
			(edict_t self) =>
			{
				float[] start = {0, 0, 0};
		...
		private static readonly EntThinkAdapter GunnerGrenade = new(
			"GunnerGrenade",
			(edict_t self) =>
			{
				float[] start = {0, 0, 0};
		...
		private static readonly EntThinkAdapter gunner_attack = new(
			"gunner_attack",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter gunner_fire_chain = new(
			"gunner_fire_chain",
			(edict_t self) =>
			{
		...
		private static readonly mframe_t[] gunner_frames_attack_chain = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, M_Gunner.gunner_opengun), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t gunner_move_attack_chain = new(
			M_Gunner.FRAME_attak209,
			M_Gunner.FRAME_attak215,
			M_Gunner.gunner_frames_attack_chain,
			M_Gunner.gunner_fire_chain
		);

		private static readonly mframe_t[] gunner_frames_fire_chain = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, M_Gunner.GunnerFire), new(GameAI.ai_charge, 0, M_Gunner.GunnerFire), new(GameAI.ai_charge, 0, M_Gunner.GunnerFire),
			new(GameAI.ai_charge, 0, M_Gunner.GunnerFire), new(GameAI.ai_charge, 0, M_Gunner.GunnerFire), new(GameAI.ai_charge, 0, M_Gunner.GunnerFire),
			new(GameAI.ai_charge, 0, M_Gunner.GunnerFire), new(GameAI.ai_charge, 0, M_Gunner.GunnerFire)
		};

		private static readonly EntThinkAdapter gunner_refire_chain = new(
			"gunner_refire_chain",
			(edict_t self) =>
			{
		...
		private static readonly mmove_t gunner_move_fire_chain = new(
			M_Gunner.FRAME_attak216,
			M_Gunner.FRAME_attak223,
			M_Gunner.gunner_frames_fire_chain,
			M_Gunner.gunner_refire_chain
		);

		private static readonly mframe_t[] gunner_frames_endfire_chain = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null)
		};

		private static readonly mmove_t gunner_move_endfire_chain = new(
			M_Gunner.FRAME_attak224,
			M_Gunner.FRAME_attak230,
			M_Gunner.gunner_frames_endfire_chain,
			M_Gunner.gunner_run
		);

		private static readonly mframe_t[] gunner_frames_attack_grenade = new mframe_t[]
		{
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Gunner.GunnerGrenade), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Gunner.GunnerGrenade), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Gunner.GunnerGrenade), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, M_Gunner.GunnerGrenade), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
			new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null), new(GameAI.ai_charge, 0, null),
		...
		private static readonly mmove_t gunner_move_attack_grenade = new(
			M_Gunner.FRAME_attak101,
			M_Gunner.FRAME_attak121,
			M_Gunner.gunner_frames_attack_grenade,
			M_Gunner.gunner_run
		);
