...
namespace Quake2Sharp.game
{
	...
	public class GameSave
	{
		...
		{
			typeof(PlayerWeapon), typeof(AIAdapter), typeof(Cmd), typeof(EdictIterator), typeof(EndianHandler), typeof(EntBlockedAdapter),
			typeof(EntDieAdapter), typeof(EntDodgeAdapter), typeof(EntInteractAdapter), typeof(EntPainAdapter), typeof(EntThinkAdapter),
			typeof(EntTouchAdapter), typeof(EntUseAdapter), typeof(GameAI), typeof(GameBase), typeof(GameChase), typeof(GameCombat), typeof(GameFunc),
			typeof(GameMisc), typeof(GameSVCmds), typeof(GameSave), typeof(GameSpawn), typeof(GameTarget), typeof(GameTrigger), typeof(GameTurret),
			typeof(GameUtil), typeof(GameWeapon), typeof(Info), typeof(ItemDropAdapter), typeof(ItemUseAdapter), typeof(Monster), typeof(PlayerClient),
			typeof(PlayerHud), typeof(PlayerTrail), typeof(PlayerView), typeof(SuperAdapter), typeof(monsters.M_Actor), typeof(monsters.M_Berserk),
			typeof(monsters.M_Boss2), typeof(monsters.M_Boss3), typeof(monsters.M_Boss31), typeof(monsters.M_Boss32), typeof(monsters.M_Brain),
			typeof(monsters.M_Chick), typeof(monsters.M_Flash), typeof(monsters.M_Flipper), typeof(monsters.M_Float), typeof(monsters.M_Flyer),
			typeof(monsters.M_Gladiator), typeof(monsters.M_Gunner), typeof(monsters.M_Hover), typeof(monsters.M_Infantry), typeof(monsters.M_Insane),
			typeof(monsters.M_Medic), typeof(monsters.M_Mutant), typeof(monsters.M_Parasite), typeof(monsters.M_Player), typeof(monsters.M_Soldier),
			typeof(monsters.M_Supertank), typeof(monsters.M_Tank), typeof(GameItems),
     ...
     */
		public static void InitGame()
		{
			...
			for (var n = 0; n < GameSave.preloadclasslist.Length; n++)
			{
				try
				{
					System.Runtime.CompilerServices.RuntimeHelpers.RunClassConstructor(GameSave.preloadclasslist[n].TypeHandle);
				}
				catch (Exception)
				{
					Com.DPrintf("error loading class: " + GameSave.preloadclasslist[n]);
				}
			}
     ...
     */
		public static void WriteGame(string filename, bool autosave)
		{
			try
			{
				...
				f = new BinaryWriter(File.OpenWrite(filename));
		...
		public static void ReadGame(string filename)
		{
			...
			try
			{
				f = new BinaryReader(File.OpenRead(filename));
				GameSave.CreateEdicts();
