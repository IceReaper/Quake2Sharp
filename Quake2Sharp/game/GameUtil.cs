...
namespace Quake2Sharp.game
{
     ...
     */
		...
		public static EntThinkAdapter Think_Delay = new(
			"Think_Delay",
			(edict_t ent) =>
			{
		...
		public static EntThinkAdapter G_FreeEdictA = new(
			"G_FreeEdictA",
			(edict_t ent) =>
			{
				GameUtil.G_FreeEdict(ent);
		...
		public static EntThinkAdapter MegaHealth_think = new(
			"MegaHealth_think",
			(edict_t self) =>
			{
		...
		public static EntThinkAdapter M_CheckAttack = new(
			"M_CheckAttack",
			(edict_t self) =>
			{
				float[] spot1 = {0, 0, 0};
		...
		public static EntUseAdapter monster_use = new(
			"monster_use",
