...
namespace Quake2Sharp.game
{
	...
	{
		private static readonly EntTouchAdapter blaster_touch = new(
			"blaster_touch",
		...
		private static readonly EntThinkAdapter Grenade_Explode = new(
			"Grenade_Explode",
			(edict_t ent) =>
			{
				float[] origin = {0, 0, 0};
		...
		private static readonly EntTouchAdapter Grenade_Touch = new(
			"Grenade_Touch",
		 ...
		 * =================
		 */
		private static readonly EntTouchAdapter rocket_touch = new(
			"rocket_touch",
			(edict_t ent, edict_t other, cplane_t plane, csurface_t surf) =>
			{
				float[] origin = {0, 0, 0};
		 ...
		 * =================
		 */
		private static readonly EntThinkAdapter bfg_explode = new(
			"bfg_explode",
			(edict_t self) =>
			{
				edict_t ent;
		...
		private static readonly EntTouchAdapter bfg_touch = new(
			"bfg_touch",
			(edict_t self, edict_t other, cplane_t plane, csurface_t surf) =>
			{
				if (other == self.owner)
		...
		private static readonly EntThinkAdapter bfg_think = new(
			"bfg_think",
			(edict_t self) =>
			{
				edict_t ent;
