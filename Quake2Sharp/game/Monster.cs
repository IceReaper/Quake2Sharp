...
namespace Quake2Sharp.game
{
	...
	public class Monster
	{
		...
		public static EntThinkAdapter monster_think = new(
			"monster_think",
			(edict_t self) =>
			{
				M.M_MoveFrame(self);
		...
		public static EntThinkAdapter monster_triggered_spawn = new(
			"monster_trigger_spawn",
			(edict_t self) =>
			{
				self.s.origin[2] += 1;
		...
		// us
		public static EntUseAdapter monster_triggered_spawn_use = new(
			"monster_trigger_spawn_use",
		...
		public static EntThinkAdapter monster_triggered_start = new(
