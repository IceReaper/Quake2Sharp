...
namespace Quake2Sharp.game
{
     ...
     */
		...
		public static EntThinkAdapter walkmonster_start_go = new(
		...
		public static EntThinkAdapter walkmonster_start = new(
			"walkmonster_start",
			(edict_t self) =>
			{
		...
		public static EntThinkAdapter flymonster_start_go = new(
			"flymonster_start_go",
			(edict_t self) =>
			{
				if (!M.M_walkmove(self, 0, 0))
		...
		public static EntThinkAdapter flymonster_start = new(
			"flymonster_start",
			(edict_t self) =>
			{
		...
		public static EntThinkAdapter swimmonster_start_go = new(
		...
		public static EntThinkAdapter swimmonster_start = new(
			"swimmonster_start",
			(edict_t self) =>
			{
     ...
     */
		public static AIAdapter ai_turn = new(
			"ai_turn",
			(edict_t self, float dist) =>
			{
				if (dist != 0)
     ...
     */
		public static AIAdapter ai_move = new(
			"ai_move",
			(edict_t self, float dist) =>
			{
				M.M_walkmove(self, self.s.angles[Defines.YAW], dist);
     ...
     */
		public static AIAdapter ai_walk = new(
			"ai_walk",
			(edict_t self, float dist) =>
			{
     ...
     */
		public static AIAdapter ai_stand = new(
			"ai_stand",
			(edict_t self, float dist) =>
			{
				float[] v = {0, 0, 0};
     ...
     * replace ai_face.
     */
		public static AIAdapter ai_charge = new(
			"ai_charge",
			(edict_t self, float dist) =>
			{
				float[] v = {0, 0, 0};
     ...
     */
		public static AIAdapter ai_run = new(
			"ai_run",
			(edict_t self, float dist) =>
			{
				float[] v = {0, 0, 0};
