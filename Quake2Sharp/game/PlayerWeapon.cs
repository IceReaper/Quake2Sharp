...
namespace Quake2Sharp.game
{
	...
	{
		public static EntThinkAdapter Weapon_Grenade = new(
			"Weapon_Grenade",
			(edict_t ent) =>
			{
		...
		public static EntThinkAdapter weapon_grenadelauncher_fire = new(
		...
		public static EntThinkAdapter Weapon_GrenadeLauncher = new(
		...
		public static EntThinkAdapter Weapon_RocketLauncher_Fire = new(
		...
		public static EntThinkAdapter Weapon_RocketLauncher = new(
		...
		public static EntThinkAdapter Weapon_Blaster_Fire = new(
			"Weapon_Blaster_Fire",
			(edict_t ent) =>
			{
				int damage;
		...
		public static EntThinkAdapter Weapon_Blaster = new(
			"Weapon_Blaster",
			(edict_t ent) =>
			{
		...
		public static EntThinkAdapter Weapon_HyperBlaster_Fire = new(
		...
		public static EntThinkAdapter Weapon_HyperBlaster = new(
			"Weapon_HyperBlaster",
			(edict_t ent) =>
			{
				int[] pause_frames = {0};
		...
		public static EntThinkAdapter Weapon_Machinegun = new(
			"Weapon_Machinegun",
			(edict_t ent) =>
			{
		...
		public static EntThinkAdapter Weapon_Chaingun = new(
			"Weapon_Chaingun",
			(edict_t ent) =>
			{
		...
		public static EntThinkAdapter weapon_shotgun_fire = new(
			"weapon_shotgun_fire",
			(edict_t ent) =>
			{
				float[] start = {0, 0, 0};
		...
		public static EntThinkAdapter Weapon_Shotgun = new(
			"Weapon_Shotgun",
			(edict_t ent) =>
			{
		...
		public static EntThinkAdapter weapon_supershotgun_fire = new(
		...
		public static EntThinkAdapter Weapon_SuperShotgun = new(
			"Weapon_SuperShotgun",
			(edict_t ent) =>
			{
		 ...
		 * ======================================================================
		 */
		public static EntThinkAdapter weapon_railgun_fire = new(
			"weapon_railgun_fire",
			(edict_t ent) =>
			{
				float[] start = {0, 0, 0};
		...
		public static EntThinkAdapter Weapon_Railgun = new(
			"Weapon_Railgun",
			(edict_t ent) =>
			{
		...
		public static EntThinkAdapter weapon_bfg_fire = new(
			"weapon_bfg_fire",
			(edict_t ent) =>
			{
				float[] offset = {0, 0, 0}, start = {0, 0, 0};
		...
		public static EntThinkAdapter Weapon_BFG = new(
			"Weapon_BFG",
			(edict_t ent) =>
			{
		 ...
		 * ================
		 */
		public static ItemUseAdapter Use_Weapon = new(
			"Use_Weapon",
		...
		public static ItemDropAdapter Drop_Weapon = new(
			"Drop_Weapon",
			(edict_t ent, gitem_t item) =>
			{
				int index;
		...
		public static EntThinkAdapter Machinegun_Fire = new(
			"Machinegun_Fire",
			(edict_t ent) =>
			{
				int i;
		...
		public static EntThinkAdapter Chaingun_Fire = new(
			"Chaingun_Fire",
			(edict_t ent) =>
			{
				int i;
		...
		public static EntInteractAdapter Pickup_Weapon = new(
			"Pickup_Weapon",
