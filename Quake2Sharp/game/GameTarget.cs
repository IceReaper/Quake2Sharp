...
namespace Quake2Sharp.game
{
     ...
     */
		public static EntUseAdapter Use_Target_Tent = new(
			"Use_Target_Tent",
     ...
     */
		public static EntUseAdapter Use_Target_Speaker = new(
			"Use_Target_Speaker",
			(edict_t ent, edict_t other, edict_t activator) =>
			{
				int chan;
		...
		public static EntUseAdapter Use_Target_Help = new(
			"Use_Target_Help",
			(edict_t ent, edict_t other, edict_t activator) =>
			{
				if ((ent.spawnflags & 1) != 0)
     ...
     */
		private static readonly EntUseAdapter use_target_secret = new(
			"use_target_secret",
			(edict_t ent, edict_t other, edict_t activator) =>
			{
     ...
     * These are single use targets.
     */
		private static readonly EntUseAdapter use_target_goal = new(
			"use_target_goal",
			(edict_t ent, edict_t other, edict_t activator) =>
			{
				GameBase.gi.sound(ent, Defines.CHAN_VOICE, ent.noise_index, 1, Defines.ATTN_NORM, 0);
     ...
     */
		private static readonly EntThinkAdapter target_explosion_explode = new(
		...
		private static readonly EntUseAdapter use_target_explosion = new(
     ...
     * "map" when fired
     */
		private static readonly EntUseAdapter use_target_changelevel = new(
     ...
     */
		private static readonly EntUseAdapter use_target_splash = new(
			"use_target_splash",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				GameBase.gi.WriteByte(Defines.svc_temp_entity);
     ...
     */
		private static readonly EntUseAdapter use_target_spawner = new(
			"use_target_spawner",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				edict_t ent;
     ...
     */
		public static EntUseAdapter use_target_blaster = new(
			"use_target_blaster",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				int effect;
     ...
     */
		public static EntUseAdapter trigger_crosslevel_trigger_use = new(
     ...
     * (default 1)
     */
		private static readonly EntThinkAdapter target_crosslevel_target_think = new(
     ...
     */
		public static EntThinkAdapter target_laser_think = new(
			"target_laser_think",
			(edict_t self) =>
			{
				edict_t ignore;
		...
		public static EntUseAdapter target_laser_use = new(
			"target_laser_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				self.activator = activator;
		...
		private static readonly EntThinkAdapter target_laser_start = new(
			"target_laser_start",
			(edict_t self) =>
			{
     ...
     */
		private static readonly EntThinkAdapter target_lightramp_think = new(
		...
		private static readonly EntUseAdapter target_lightramp_use = new(
     ...
     * (default:5)
     */
		private static readonly EntThinkAdapter target_earthquake_think = new(
		...
		private static readonly EntUseAdapter target_earthquake_use = new(
