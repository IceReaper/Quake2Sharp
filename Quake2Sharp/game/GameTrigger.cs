...
namespace Quake2Sharp.game
{
     ...
     */
		...
		public static EntThinkAdapter multi_wait = new(
			"multi_wait",
			(edict_t ent) =>
			{
				ent.nextthink = 0;
		...
		private static readonly EntUseAdapter Use_Multi = new(
			"Use_Multi",
		...
		private static readonly EntTouchAdapter Touch_Multi = new(
			"Touch_Multi",
     ...
     */
		private static readonly EntUseAdapter trigger_enable = new(
			"trigger_enable",
     ...
     */
		public static EntUseAdapter trigger_relay_use = new(
			"trigger_relay_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
     ...
     */
		private static readonly EntUseAdapter trigger_key_use = new(
			"trigger_key_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				int index;
     ...
     */
		private static readonly EntUseAdapter trigger_counter_use = new(
			"trigger_counter_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				if (self.count == 0)
		...
		private static readonly EntTouchAdapter trigger_push_touch = new(
			"trigger_push_touch",
			(edict_t self, edict_t other, cplane_t plane, csurface_t surf) =>
			{
     ...
     *  
     */
		private static readonly EntUseAdapter hurt_use = new(
			"hurt_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
		...
		private static readonly EntTouchAdapter hurt_touch = new(
			"hurt_touch",
			(edict_t self, edict_t other, cplane_t plane, csurface_t surf) =>
			{
				int dflags;
     ...
     */
		private static readonly EntTouchAdapter trigger_gravity_touch = new(
     ...
     * upwards
     */
		private static readonly EntTouchAdapter trigger_monsterjump_touch = new(
