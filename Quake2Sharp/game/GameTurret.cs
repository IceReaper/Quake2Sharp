...
namespace Quake2Sharp.game
{
     ...
     */
		...
		private static readonly EntBlockedAdapter turret_blocked = new(
			"turret_blocked",
		...
		private static readonly EntThinkAdapter turret_breach_think = new(
			"turret_breach_think",
			(edict_t self) =>
			{
				edict_t ent;
		...
		private static readonly EntThinkAdapter turret_breach_finish_init = new(
		 ...
		 * turret_breach.
		 */
		private static readonly EntDieAdapter turret_driver_die = new(
			"turret_driver_die",
		...
		private static readonly EntThinkAdapter turret_driver_think = new(
			"turret_driver_think",
			(edict_t self) =>
			{
				float[] target = {0, 0, 0};
		...
		public static EntThinkAdapter turret_driver_link = new(
			"turret_driver_link",
			(edict_t self) =>
			{
				float[] vec = {0, 0, 0};
