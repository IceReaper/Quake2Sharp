...
public class GameTurret
{
	...
	private static readonly EntBlockedAdapter turret_blocked = new("turret_blocked", (self, other) =>
	{
		edict_t attacker;
	...
	private static readonly EntThinkAdapter turret_breach_think = new("turret_breach_think", self =>
	{
		edict_t ent;
	...
	private static readonly EntThinkAdapter turret_breach_finish_init = new("turret_breach_finish_init", self =>
	{
		...
		self.think = GameTurret.turret_breach_think;
	 ...
	 * turret_breach.
	 */
	private static readonly EntDieAdapter turret_driver_die = new("turret_driver_die", (self, inflictor, attacker, damage, point) =>
	{
		edict_t ent;
	...
	private static readonly EntThinkAdapter turret_driver_think = new("turret_driver_think", self =>
	{
		float[] target = { 0, 0, 0 };
		float[] dir = { 0, 0, 0 };
		float reaction_time;
	...
	public static EntThinkAdapter turret_driver_link = new("turret_driver_link", self =>
	{
		float[] vec = { 0, 0, 0 };
		edict_t ent;

		self.think = GameTurret.turret_driver_think;
		self.nextthink = GameBase.level.time + Defines.FRAMETIME;
