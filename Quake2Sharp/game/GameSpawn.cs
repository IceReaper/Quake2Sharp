...
namespace Quake2Sharp.game
{
	...
	{
		private static readonly EntThinkAdapter SP_item_health = new(
			"SP_item_health",
			(edict_t ent) =>
			{
		...
		private static readonly EntThinkAdapter SP_item_health_small = new(
		...
		private static readonly EntThinkAdapter SP_item_health_large = new(
		...
		private static readonly EntThinkAdapter SP_item_health_mega = new(
			"SP_item_health_mega",
			(edict_t ent) =>
			{
		...
		private static readonly EntThinkAdapter SP_info_player_start = new(
		...
		private static readonly EntThinkAdapter SP_info_player_deathmatch = new(
		...
		private static readonly EntThinkAdapter SP_info_player_coop = new(
			"SP_info_player_coop",
			(edict_t ent) =>
			{
		...
		private static readonly EntThinkAdapter SP_info_player_intermission = new(
		...
		private static readonly EntThinkAdapter SP_func_plat = new(
			"SP_func_plat",
			(edict_t ent) =>
			{
		...
		private static readonly EntThinkAdapter SP_func_water = new(
			"SP_func_water",
			(edict_t ent) =>
			{
		...
		private static readonly EntThinkAdapter SP_func_train = new(
			"SP_func_train",
			(edict_t ent) =>
			{
		...
		private static readonly EntThinkAdapter SP_func_clock = new(
			"SP_func_clock",
			(edict_t ent) =>
			{
     ...
     * print at user logon
     */
		private static readonly EntThinkAdapter SP_worldspawn = new(
			"SP_worldspawn",
			(edict_t ent) =>
			{
     ...
     */
		public static void SpawnEntities(string mapname, string entities, string spawnpoint)
		{
			...
			while (true)
			{
				...
				Com.DPrintf("spawning ent[" + ent.index + "], classname=" + ent.classname + ", flags=" + ent.spawnflags.ToString("x") + " ");
		...
		{
			new("item_health", GameSpawn.SP_item_health), new("item_health_small", GameSpawn.SP_item_health_small),
			new("item_health_large", GameSpawn.SP_item_health_large), new("item_health_mega", GameSpawn.SP_item_health_mega),
			new("info_player_start", GameSpawn.SP_info_player_start), new("info_player_deathmatch", GameSpawn.SP_info_player_deathmatch),
			new("info_player_coop", GameSpawn.SP_info_player_coop), new("info_player_intermission", GameSpawn.SP_info_player_intermission),
			new("func_plat", GameSpawn.SP_func_plat), new("func_button", GameFunc.SP_func_button), new("func_door", GameFunc.SP_func_door),
			new("func_door_secret", GameFunc.SP_func_door_secret), new("func_door_rotating", GameFunc.SP_func_door_rotating),
			new("func_rotating", GameFunc.SP_func_rotating), new("func_train", GameSpawn.SP_func_train), new("func_water", GameSpawn.SP_func_water),
			new("func_conveyor", GameFunc.SP_func_conveyor), new("func_areaportal", GameMisc.SP_func_areaportal), new("func_clock", GameSpawn.SP_func_clock),
			new(
				"func_wall",
				new EntThinkAdapter(
					"func_wall",
			...
			new("func_killbox", GameFunc.SP_func_killbox), new(
				"trigger_always",
				new EntThinkAdapter(
					"SP_trigger_always",
					(edict_t ent) =>
			...
			new("trigger_elevator", GameFunc.SP_trigger_elevator), new(
				"trigger_gravity",
				new EntThinkAdapter(
					"SP_trigger_gravity",
					(edict_t ent) =>
			...
			new("worldspawn", GameSpawn.SP_worldspawn), new(
				"viewthing",
				new EntThinkAdapter(
					"SP_viewthing",
					(edict_t ent) =>
			...
			new("misc_teleporter_dest", GameMisc.SP_misc_teleporter_dest), new(
				"misc_blackhole",
				new EntThinkAdapter(
					"SP_misc_blackhole",
					(edict_t ent) =>
			...
			new("monster_soldier_light", M_Soldier.SP_monster_soldier_light), new("monster_soldier", M_Soldier.SP_monster_soldier),
			new("monster_soldier_ss", M_Soldier.SP_monster_soldier_ss), new("monster_tank", M_Tank.SP_monster_tank),
			new("monster_tank_commander", M_Tank.SP_monster_tank), new(
				"monster_medic",
				new EntThinkAdapter(
					"SP_monster_medic",
					(edict_t ent) =>
			...
			new("monster_parasite", M_Parasite.SP_monster_parasite), new(
				"monster_flyer",
				new EntThinkAdapter(
					"SP_monster_flyer",
					(edict_t ent) =>
			...
			new("monster_mutant", M_Mutant.SP_monster_mutant), new("monster_supertank", M_Supertank.SP_monster_supertank), new(
				"monster_boss2",
				new EntThinkAdapter(
					"SP_monster_boss2",
					(edict_t ent) =>
