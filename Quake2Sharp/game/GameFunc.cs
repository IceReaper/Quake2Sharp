...
namespace Quake2Sharp.game
{
     ...
     */
		...
		private static readonly EntThinkAdapter Move_Done = new(
			"move_done",
			(edict_t ent) =>
			{
				Math3D.VectorClear(ent.velocity);
		...
		private static readonly EntThinkAdapter Move_Final = new(
			"move_final",
			(edict_t ent) =>
			{
		...
		private static readonly EntThinkAdapter Move_Begin = new(
			"move_begin",
			(edict_t ent) =>
			{
				float frames;
		...
		private static readonly EntThinkAdapter AngleMove_Done = new(
			"agnle_move_done",
			(edict_t ent) =>
			{
				Math3D.VectorClear(ent.avelocity);
		...
		private static readonly EntThinkAdapter AngleMove_Final = new(
			"angle_move_final",
			(edict_t ent) =>
			{
				float[] move = {0, 0, 0};
		...
		private static readonly EntThinkAdapter AngleMove_Begin = new(
			"angle_move_begin",
			(edict_t ent) =>
			{
		...
		private static readonly EntThinkAdapter Think_AccelMove = new(
			"thinc_accelmove",
			(edict_t ent) =>
			{
		...
		private static readonly EntThinkAdapter plat_hit_top = new(
			"plat_hit_top",
			(edict_t ent) =>
			{
				if (0 == (ent.flags & Defines.FL_TEAMSLAVE))
		...
		private static readonly EntThinkAdapter plat_hit_bottom = new(
			"plat_hit_bottom",
			(edict_t ent) =>
			{
				if (0 == (ent.flags & Defines.FL_TEAMSLAVE))
		...
		private static readonly EntThinkAdapter plat_go_down = new(
			"plat_go_down",
			(edict_t ent) =>
			{
				if (0 == (ent.flags & Defines.FL_TEAMSLAVE))
		...
		private static readonly EntBlockedAdapter plat_blocked = new(
			"plat_blocked",
		...
		private static readonly EntUseAdapter Use_Plat = new(
			"use_plat",
		...
		private static readonly EntTouchAdapter Touch_Plat_Center = new(
			"touch_plat_center",
     ...
     */
		private static readonly EntBlockedAdapter rotating_blocked = new(
			"rotating_blocked",
			(edict_t self, edict_t other) =>
			{
				GameCombat.T_Damage(other, self, self, Globals.vec3_origin, other.s.origin, Globals.vec3_origin, self.dmg, 1, 0, Defines.MOD_CRUSH);
		...
		private static readonly EntTouchAdapter rotating_touch = new(
			"rotating_touch",
		...
		private static readonly EntUseAdapter rotating_use = new(
			"rotating_use",
		...
		public static EntThinkAdapter SP_func_rotating = new(
			"sp_func_rotating",
			(edict_t ent) =>
			{
				ent.solid = Defines.SOLID_BSP;
		...
		private static readonly EntThinkAdapter button_done = new(
			"button_done",
			(edict_t self) =>
			{
				self.moveinfo.state = GameFunc.STATE_BOTTOM;
		...
		private static readonly EntThinkAdapter button_return = new(
			"button_return",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter button_wait = new(
			"button_wait",
			(edict_t self) =>
			{
				self.moveinfo.state = GameFunc.STATE_TOP;
		...
		private static readonly EntThinkAdapter button_fire = new(
			"button_fire",
			(edict_t self) =>
			{
		...
		private static readonly EntUseAdapter button_use = new(
			"button_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
		...
		private static readonly EntTouchAdapter button_touch = new(
			"button_touch",
			(edict_t self, edict_t other, cplane_t plane, csurface_t surf) =>
			{
		...
		private static readonly EntDieAdapter button_killed = new(
			"button_killed",
		...
		public static EntThinkAdapter SP_func_button = new(
			"sp_func_button",
			(edict_t ent) =>
			{
				float[] abs_movedir = {0, 0, 0};
		...
		private static readonly EntThinkAdapter door_hit_top = new(
			"door_hit_top",
			(edict_t self) =>
			{
				if (0 == (self.flags & Defines.FL_TEAMSLAVE))
		...
		private static readonly EntThinkAdapter door_hit_bottom = new(
			"door_hit_bottom",
			(edict_t self) =>
			{
				if (0 == (self.flags & Defines.FL_TEAMSLAVE))
		...
		private static readonly EntThinkAdapter door_go_down = new(
			"door_go_down",
			(edict_t self) =>
			{
				if (0 == (self.flags & Defines.FL_TEAMSLAVE))
		...
		private static readonly EntUseAdapter door_use = new(
			"door_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				edict_t ent;
		...
		private static readonly EntTouchAdapter Touch_DoorTrigger = new(
			"touch_door_trigger",
			(edict_t self, edict_t other, cplane_t plane, csurface_t surf) =>
			{
				if (other.health <= 0)
		...
		private static readonly EntThinkAdapter Think_CalcMoveSpeed = new(
			"think_calc_movespeed",
			(edict_t self) =>
			{
				edict_t ent;
				float min;
		...
		private static readonly EntThinkAdapter Think_SpawnDoorTrigger = new(
		...
		private static readonly EntBlockedAdapter door_blocked = new(
			"door_blocked",
			(edict_t self, edict_t other) =>
			{
				edict_t ent;
		...
		private static readonly EntDieAdapter door_killed = new(
			"door_killed",
			(edict_t self, edict_t inflictor, edict_t attacker, int damage, float[] point) =>
			{
				edict_t ent;
		...
		private static readonly EntTouchAdapter door_touch = new(
			"door_touch",
			(edict_t self, edict_t other, cplane_t plane, csurface_t surf) =>
			{
				if (null == other.client)
		...
		public static EntThinkAdapter SP_func_door = new(
			"sp_func_door",
			(edict_t ent) =>
			{
				float[] abs_movedir = {0, 0, 0};
		...
		public static EntThinkAdapter SP_func_door_rotating = new(
		...
		private static readonly EntBlockedAdapter train_blocked = new(
			"train_blocked",
			(edict_t self, edict_t other) =>
			{
				if (0 == (other.svflags & Defines.SVF_MONSTER) && (null == other.client))
		...
		private static readonly EntThinkAdapter train_wait = new(
			"train_wait",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter train_next = new(
			"train_next",
			(edict_t self) =>
			{
				edict_t ent = null;
		...
		public static EntThinkAdapter func_train_find = new(
			"func_train_find",
			(edict_t self) =>
			{
				edict_t ent;
		...
		public static EntUseAdapter train_use = new(
			"train_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				self.activator = activator;
		 ...
		 */
		private static readonly EntUseAdapter trigger_elevator_use = new(
		...
		private static readonly EntThinkAdapter trigger_elevator_init = new(
		...
		public static EntThinkAdapter SP_trigger_elevator = new(
			"sp_trigger_elevator",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter func_timer_think = new(
			"func_timer_think",
			(edict_t self) =>
			{
				GameUtil.G_UseTargets(self, self.activator);
		...
		private static readonly EntUseAdapter func_timer_use = new(
			"func_timer_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				self.activator = activator;
		...
		private static readonly EntUseAdapter func_conveyor_use = new(
			"func_conveyor_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				if ((self.spawnflags & 1) != 0)
		...
		public static EntThinkAdapter SP_func_conveyor = new(
			"sp_func_conveyor",
			(edict_t self) =>
			{
				if (0 == self.speed)
		...
		private static readonly EntUseAdapter door_secret_use = new(
			"door_secret_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
		...
		private static readonly EntThinkAdapter door_secret_move1 = new(
			"door_secret_move1",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter door_secret_move2 = new(
			"door_secret_move2",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter door_secret_move3 = new(
			"door_secret_move3",
			(edict_t self) =>
			{
				if (self.wait == -1)
		...
		private static readonly EntThinkAdapter door_secret_move4 = new(
			"door_secret_move4",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter door_secret_move5 = new(
			"door_secret_move5",
			(edict_t self) =>
			{
				self.nextthink = GameBase.level.time + 1.0f;
		...
		private static readonly EntThinkAdapter door_secret_move6 = new(
			"door_secret_move6",
			(edict_t self) =>
			{
		...
		private static readonly EntThinkAdapter door_secret_done = new(
			"door_secret_move7",
			(edict_t self) =>
			{
		...
		private static readonly EntBlockedAdapter door_secret_blocked = new(
			"door_secret_blocked",
			(edict_t self, edict_t other) =>
			{
				if (0 == (other.svflags & Defines.SVF_MONSTER) && (null == other.client))
		...
		private static readonly EntDieAdapter door_secret_die = new(
			"door_secret_die",
			(edict_t self, edict_t inflictor, edict_t attacker, int damage, float[] point) =>
			{
				self.takedamage = Defines.DAMAGE_NO;
		...
		public static EntThinkAdapter SP_func_door_secret = new(
			"sp_func_door_secret",
			(edict_t ent) =>
			{
     ...
     */
		private static readonly EntUseAdapter use_killbox = new(
			"use_killbox",
			(edict_t self, edict_t other, edict_t activator) =>
			{
		...
		public static EntThinkAdapter SP_func_killbox = new(
			"sp_func_killbox",
			(edict_t ent) =>
			{
				GameBase.gi.setmodel(ent, ent.model);
