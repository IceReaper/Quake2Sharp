...
namespace Quake2Sharp.game
{
	...
	public class GameItemList
	{
		public static gitem_t[] itemlist =
		{
			 ...
			 */ new(
				"item_power_screen",
				GameItems.Pickup_PowerArmor,
				GameItems.Use_PowerArmor,
				GameItems.Drop_PowerArmor,
				null,
				"misc/ar3_pkup.wav",
			 ...
			 */ new(
				...
				PlayerWeapon.Use_Weapon,
				PlayerWeapon.Drop_Weapon,
				PlayerWeapon.Weapon_SuperShotgun,
				"misc/w_pkup.wav",
			 ...
			 */ new(
				"item_quad",
				GameItems.Pickup_Powerup,
				GameItems.Use_Quad,
				GameItems.Drop_General,
				null,
				"items/pkup.wav",
			 ...
			 */ new(
				...
				60,
				null,
				Defines.IT_STAY_COOP | Defines.IT_POWERUP,
				0,
				null,
				0,
				/* precache */
