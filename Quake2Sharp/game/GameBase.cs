...
namespace Quake2Sharp.game
{
     ...
     */
		...
		public static Func<edict_t, string, bool> findByTarget = (edict_t e, string s) =>
		{
		...
		public static Func<edict_t, string, bool> findByClass = (edict_t e, string s) =>
		{
			return e.classname.Equals(s, StringComparison.OrdinalIgnoreCase);
		};
     ...
     */
		public static void GetGameApi(game_import_t imp)
		{
			...
			GameBase.gi.pointcontents = (float[] o) =>
			{
