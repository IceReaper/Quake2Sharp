...
namespace Quake2Sharp.game
{
     ...
     * player_die. 
     */
		public static EntDieAdapter player_die = new(
			"player_die",
		...
		private static readonly EntThinkAdapter SP_FixCoopSpots = new(
			"SP_FixCoopSpots",
			(edict_t self) =>
			{
				edict_t spot;
		...
		private static readonly EntThinkAdapter SP_CreateCoopSpots = new(
			"SP_CreateCoopSpots",
			(edict_t self) =>
			{
				edict_t spot;
		...
		private static readonly EntPainAdapter player_pain = new(
			"player_pain",
		...
		private static readonly EntDieAdapter body_die = new(
			"body_die",
			(edict_t self, edict_t inflictor, edict_t attacker, int damage, float[] point) =>
			{
				int n;
		...
		public static Func<float[], float[], float[], float[], trace_t> PM_trace = (float[] start, float[] mins, float[] maxs, float[] end) =>
		{
