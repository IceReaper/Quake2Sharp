...
namespace Quake2Sharp.game
{
     ...
     */
		...
		public static EntUseAdapter Use_Areaportal = new(
			"use_areaportal",
			(edict_t ent, edict_t other, edict_t activator) =>
			{
     ...
     * middle of a door.
     */
		public static EntThinkAdapter SP_func_areaportal = new(
			"sp_func_areaportal",
			(edict_t ent) =>
			{
     ...
     */
		public static EntTouchAdapter path_corner_touch = new(
			"path_corner_touch",
		 ...
		 */
		public static EntTouchAdapter point_combat_touch = new(
			"point_combat_touch",
			(edict_t self, edict_t other, cplane_t plane, csurface_t surf) =>
			{
				edict_t activator;
		 ...
		 * level. Don't use
		 */
		public static EntThinkAdapter TH_viewthing = new(
			"th_viewthing",
			(edict_t ent) =>
			{
		...
		public static EntUseAdapter light_use = new(
			"light_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				if ((self.spawnflags & GameMisc.START_OFF) != 0)
				{
					GameBase.gi.configstring(Defines.CS_LIGHTS + self.style, "m");
		...
		private static readonly EntUseAdapter func_wall_use = new(
			"func_wall_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
		 ...
		 */
		private static readonly EntTouchAdapter func_object_touch = new(
			"func_object_touch",
			(edict_t self, edict_t other, cplane_t plane, csurface_t surf) =>
			{
		...
		private static readonly EntThinkAdapter func_object_release = new(
			"func_object_release",
			(edict_t self) =>
			{
				self.movetype = Defines.MOVETYPE_TOSS;
		...
		private static readonly EntUseAdapter func_object_use = new(
			"func_object_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				self.solid = Defines.SOLID_BSP;
		 ...
		 */
		public static EntDieAdapter func_explosive_explode = new(
		...
		public static EntUseAdapter func_explosive_use = new(
			"func_explosive_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
		...
		public static EntUseAdapter func_explosive_spawn = new(
		...
		public static EntTouchAdapter barrel_touch = new(
			"barrel_touch",
			(edict_t self, edict_t other, cplane_t plane, csurface_t surf) =>
			{
				float ratio;
		...
		public static EntThinkAdapter barrel_explode = new(
			"barrel_explode",
			(edict_t self) =>
			{
				float[] org = {0, 0, 0};
		...
		public static EntDieAdapter barrel_delay = new(
			"barrel_delay",
			(edict_t self, edict_t inflictor, edict_t attacker, int damage, float[] point) =>
			{
				self.takedamage = Defines.DAMAGE_NO;
		...
		private static readonly EntUseAdapter misc_blackhole_use = new(
			"misc_blavkhole_use",
			(edict_t ent, edict_t other, edict_t activator) =>
			{
				/*
		...
		private static readonly EntThinkAdapter misc_blackhole_think = new(
		...
		private static readonly EntThinkAdapter misc_eastertank_think = new(
		...
		private static readonly EntThinkAdapter misc_easterchick_think = new(
		 ...
		 */
		private static readonly EntThinkAdapter misc_easterchick2_think = new(
		...
		public static EntThinkAdapter commander_body_think = new(
		...
		public static EntUseAdapter commander_body_use = new(
			"commander_body_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
		...
		public static EntThinkAdapter commander_body_drop = new(
			"commander_body_group",
			(edict_t self) =>
			{
				self.movetype = Defines.MOVETYPE_TOSS;
				self.s.origin[2] += 2;
		 ...
		 */
		private static readonly EntThinkAdapter misc_banner_think = new(
			"misc_banner_think",
			(edict_t ent) =>
			{
		 ...
		 */
		private static readonly EntDieAdapter misc_deadsoldier_die = new(
		...
		private static readonly EntUseAdapter misc_viper_use = new(
			"misc_viper_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				self.svflags &= ~Defines.SVF_NOCLIENT;
		 ...
		 */
		private static readonly EntTouchAdapter misc_viper_bomb_touch = new(
		...
		private static readonly EntThinkAdapter misc_viper_bomb_prethink = new(
		...
		private static readonly EntUseAdapter misc_viper_bomb_use = new(
			"misc_viper_bomb_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				edict_t viper = null;
		...
		private static readonly EntUseAdapter misc_strogg_ship_use = new(
		 ...
		 */
		private static readonly EntThinkAdapter misc_satellite_dish_think = new(
		...
		private static readonly EntUseAdapter misc_satellite_dish_use = new(
		...
		private static readonly EntUseAdapter target_string_use = new(
			"target_string_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				edict_t e;
		...
		public static EntThinkAdapter func_clock_think = new(
			"func_clock_think",
			(edict_t self) =>
			{
				if (null == self.enemy)
		...
		public static EntUseAdapter func_clock_use = new(
			"func_clock_use",
			(edict_t self, edict_t other, edict_t activator) =>
			{
				if (0 == (self.spawnflags & 8))
		...
		private static readonly EntTouchAdapter teleporter_touch = new(
			"teleporter_touch",
			(edict_t self, edict_t other, cplane_t plane, csurface_t surf) =>
			{
				edict_t dest;
		...
		public static EntThinkAdapter SP_misc_teleporter_dest = new(
		...
		public static EntThinkAdapter gib_think = new(
			"gib_think",
			(edict_t self) =>
			{
				self.s.frame++;
		...
		public static EntTouchAdapter gib_touch = new(
			"gib_touch",
			(edict_t self, edict_t other, cplane_t plane, csurface_t surf) =>
			{
		...
		public static EntDieAdapter gib_die = new(
			"gib_die",
			(edict_t self, edict_t inflictor, edict_t attacker, int damage, float[] point) =>
			{
				GameUtil.G_FreeEdict(self);
     ...
     * Debris
     */
		public static EntDieAdapter debris_die = new(
			"debris_die",
			(edict_t self, edict_t inflictor, edict_t attacker, int damage, float[] point) =>
			{
				GameUtil.G_FreeEdict(self);
