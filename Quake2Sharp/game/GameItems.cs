...
namespace Quake2Sharp.game
{
	...
	public class GameItems
	{
		...
		private static readonly EntThinkAdapter DoRespawn = new(
			"do_respawn",
			(edict_t ent) =>
			{
				if (ent.team != null)
		...
		public static EntInteractAdapter Pickup_Pack = new(
			"pickup_pack",
			(edict_t ent, edict_t other) =>
			{
				gitem_t item;
				int index;
		...
		public static readonly EntInteractAdapter Pickup_Health = new(
			"pickup_health",
			(edict_t ent, edict_t other) =>
			{
		...
		public static EntTouchAdapter Touch_Item = new(
			"touch_item",
		...
		private static readonly EntTouchAdapter drop_temp_touch = new(
			"drop_temp_touch",
			(edict_t ent, edict_t other, cplane_t plane, csurface_t surf) =>
			{
				if (other == ent.owner)
		...
		private static readonly EntThinkAdapter drop_make_touchable = new(
			"drop_make_touchable",
			(edict_t ent) =>
			{
		...
		public static ItemUseAdapter Use_Quad = new(
			"use_quad",
		...
		public static ItemUseAdapter Use_Invulnerability = new(
			"use_invulnerability",
			(edict_t ent, gitem_t item) =>
			{
				ent.client.pers.inventory[GameItems.ITEM_INDEX(item)]--;
		...
		public static ItemUseAdapter Use_Breather = new(
			"use_breather",
			(edict_t ent, gitem_t item) =>
			{
				ent.client.pers.inventory[GameItems.ITEM_INDEX(item)]--;
		...
		public static ItemUseAdapter Use_Envirosuit = new(
			"use_envirosuit",
			(edict_t ent, gitem_t item) =>
			{
				ent.client.pers.inventory[GameItems.ITEM_INDEX(item)]--;
		...
		public static ItemUseAdapter Use_Silencer = new(
			"use_silencer",
			(edict_t ent, gitem_t item) =>
			{
				ent.client.pers.inventory[GameItems.ITEM_INDEX(item)]--;
		...
		public static EntInteractAdapter Pickup_Key = new(
			"pickup_key",
			(edict_t ent, edict_t other) =>
			{
		...
		public static EntInteractAdapter Pickup_Ammo = new(
			"pickup_ammo",
			(edict_t ent, edict_t other) =>
			{
				int oldcount;
		...
		public static EntInteractAdapter Pickup_Armor = new(
			"pickup_armor",
			(edict_t ent, edict_t other) =>
			{
				int old_armor_index;
		...
		public static EntInteractAdapter Pickup_PowerArmor = new(
			"pickup_powerarmor",
			(edict_t ent, edict_t other) =>
			{
				int quantity;
		...
		public static EntInteractAdapter Pickup_Powerup = new(
			"pickup_powerup",
			(edict_t ent, edict_t other) =>
			{
				int quantity;
		...
		public static EntInteractAdapter Pickup_Adrenaline = new(
			"pickup_adrenaline",
			(edict_t ent, edict_t other) =>
			{
				if (GameBase.deathmatch.value == 0)
		...
		public static EntInteractAdapter Pickup_AncientHead = new(
			"pickup_ancienthead",
			(edict_t ent, edict_t other) =>
			{
				other.max_health += 2;
		...
		public static EntInteractAdapter Pickup_Bandolier = new(
			"pickup_bandolier",
			(edict_t ent, edict_t other) =>
			{
				gitem_t item;
		...
		public static ItemDropAdapter Drop_Ammo = new(
			"drop_ammo",
			(edict_t ent, gitem_t item) =>
			{
				edict_t dropped;
		...
		public static ItemDropAdapter Drop_General = new(
			"drop_general",
			(edict_t ent, gitem_t item) =>
			{
		...
		public static ItemDropAdapter Drop_PowerArmor = new(
			"drop_powerarmor",
			(edict_t ent, gitem_t item) =>
			{
		...
		public static EntThinkAdapter droptofloor = new(
			"drop_to_floor",
			(edict_t ent) =>
			{
				trace_t tr;
		...
		public static ItemUseAdapter Use_PowerArmor = new(
			"use_powerarmor",
			(edict_t ent, gitem_t item) =>
			{
				int index;
		...
		public static EntUseAdapter Use_Item = new(
			"use_item",
