...
public class SV
{
	...
	public static bool SV_RunThink(edict_t ent)
	{
		...
		if (ent.think == null)
			clientserver.Com_Error(Defines.ERR_FATAL, "NULL ent.think");
     ...
     */
	public static readonly int MAX_CLIP_PLANES = 5;
	...
	public static void SV_NewChaseDir(edict_t actor, edict_t enemy, float dist)
	{
		...
		if (enemy == null)
		{
			clientserver.Com_DPrintf("SV_NewChaseDir without enemy!\n");
