...
public class QConsole
{
	...
	public static Action Dump_f = () =>
	{
		...
		{
			clientserver.Com_Printf("usage: condump <filename>\n");
		...
		// Cmd_Argv(1));
		name = filesystem.FS_Gamedir() + "/" + cmdparser.Cmd_Argv(1) + ".txt";
		clientserver.Com_Printf("Dumped console text to " + name + ".\n");
	...
	public static void Init()
	{
		...
		clientserver.Com_Printf("Console initialized.\n");

		//
		// register our commands
		//
		Globals.con_notifytime = cvar.Cvar_Get("con_notifytime", "3", 0);
		cmdparser.Cmd_AddCommand("toggleconsole", QConsole.ToggleConsole_f);
		cmdparser.Cmd_AddCommand("togglechat", QConsole.ToggleChat_f);
		cmdparser.Cmd_AddCommand("messagemode", QConsole.MessageMode_f);
		cmdparser.Cmd_AddCommand("messagemode2", QConsole.MessageMode2_f);
		cmdparser.Cmd_AddCommand("clear", QConsole.Clear_f);
		cmdparser.Cmd_AddCommand("condump", QConsole.Dump_f);
	...
	public static void DrawConsole(float frac)
	{
		...
		var version = $"v{Globals.YQ2VERSION:#0.00,4}";
