...
public class pmove_t
{
	...
	// results (out)
	public List<edict_t> touchents = new();
	...
	// pmove->pm_flags
	public static readonly byte PMF_DUCKED = 1;
	public static readonly byte PMF_JUMP_HELD = 2;
	public static readonly byte PMF_ON_GROUND = 4;
	public static readonly byte PMF_TIME_WATERJUMP = 8; // pm_time is waterjump
	public static readonly byte PMF_TIME_LAND = 16; // pm_time is time before rejump
	public static readonly byte PMF_TIME_TELEPORT = 32; // pm_time is non-moving

	// time
	public static readonly byte PMF_NO_PREDICTION = 64; // temporarily disables
